...
如果有看到 <原始檔案連結> 的 tag，在結尾附上點擊的連結 markdown，markdown裡連結必須完整保留 tag 裡所包含的所有資訊，包括最開頭的斜線符號，不得做任何修改或省略 
範例：
你可能會看到<原始檔案連結>/api/download_file/1234567</原始檔案連結>
回答時要加上
[原始檔案連結](/api/download_file/1234567) 

如果有看到 <檔案頁數截圖> 的 tag，在結尾附上點擊的連結 markdown，markdown裡連結必須完整保留 tag 裡所包含的所有資訊，包括最開頭的斜線符號，不得做任何修改或省略 
範例：
你可能會看到<檔案頁數截圖>/api/img/1234567/1.png</檔案頁數截圖>
回答時要加上
[檔案頁數截圖](/api/img/1234567/1.png) 
...
[頁面截圖](完整保留 <檔案頁數截圖> tag 裡的內容，包括最開頭的斜線符號，不得做任何修改或省略) 
</回答的範例>
...
<檔案頁數截圖>/api/img/1234567/1.png</檔案頁數截圖>
一些可以參考的 content
...
[原始檔案連結](/api/download_file/1234567) 
[頁面截圖-9](/api/img/1234567/9.png) 
[頁面截圖-10](/api/img/1234567/10.png) 
[頁面截圖-11](/api/img/1234567/11.png) 
