...
from btq.core.BlockHeader import BlockHeader
from btq.crypto.misc import merkle_tx_hash
...
class Block(object):
    ...
    def get_block_number_mapping(state: State, block_number: int):
        try:
            ...
            block_number_mapping = btq_pb2.BlockNumberMapping()
