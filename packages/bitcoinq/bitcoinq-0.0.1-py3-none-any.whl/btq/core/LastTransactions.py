...
from btq.generated import btqstateinfo_pb2
...
class LastTransactions:
    def __init__(self, pbdata=None):
        self._data = pbdata
        if not pbdata:
            self._data = btqstateinfo_pb2.LastTransactions()
    ...
    def add(self, tx: Transaction, block_number: int, timestamp: int):
        tm = btqstateinfo_pb2.TransactionMetadata(transaction=tx.pbdata,
    ...
    def deserialize(data):
        pbdata = btqstateinfo_pb2.LastTransactions()
