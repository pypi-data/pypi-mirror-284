...
from btq.core.Message import Message
from btq.core.MessageRequest import MessageRequest
from btq.core.txs.CoinBase import CoinBase
from btq.generated import btqlegacy_pb2
from btq.generated.btqlegacy_pb2 import LegacyMessage
...
class MessageReceipt(object):
    ...
    services_arg = {
        ######################
        btqlegacy_pb2.LegacyMessage.VE: 'veData',
        btqlegacy_pb2.LegacyMessage.PL: 'plData',
        btqlegacy_pb2.LegacyMessage.PONG: 'pongData',

        ######################
        btqlegacy_pb2.LegacyMessage.MR: 'mrData',
        btqlegacy_pb2.LegacyMessage.SFM: 'mrData',

        btqlegacy_pb2.LegacyMessage.BK: 'block',
        btqlegacy_pb2.LegacyMessage.FB: 'fbData',
        btqlegacy_pb2.LegacyMessage.PB: 'pbData',

        ############################
        btqlegacy_pb2.LegacyMessage.TX: 'txData',
        btqlegacy_pb2.LegacyMessage.MT: 'mtData',
        btqlegacy_pb2.LegacyMessage.TK: 'tkData',
        btqlegacy_pb2.LegacyMessage.TT: 'ttData',
        btqlegacy_pb2.LegacyMessage.LT: 'ltData',
        btqlegacy_pb2.LegacyMessage.SL: 'slData',

        btqlegacy_pb2.LegacyMessage.EPH: 'ephData',

        btqlegacy_pb2.LegacyMessage.SYNC: 'syncData',

        btqlegacy_pb2.LegacyMessage.MC: 'mcData',
        btqlegacy_pb2.LegacyMessage.MS: 'msData',
        btqlegacy_pb2.LegacyMessage.MV: 'mvData',
    }
    ...
    def get(self, msg_type, msg_hash: bytes) -> Optional[btqlegacy_pb2.LegacyMessage]:
        if not self.contains(msg_hash, msg_type):
            return None

        msg = self._hash_msg[msg_hash].msg
        data = btqlegacy_pb2.LegacyMessage(**{'func_name': msg_type,
