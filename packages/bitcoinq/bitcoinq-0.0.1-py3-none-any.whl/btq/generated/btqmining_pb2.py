...
_GETBLOCKMININGCOMPATIBLEREQ = _descriptor.Descriptor(
  ...
  full_name='btq.GetBlockMiningCompatibleReq',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='height', full_name='btq.GetBlockMiningCompatibleReq.height', index=0,
...
_GETLASTBLOCKHEADERREQ = _descriptor.Descriptor(
  ...
  full_name='btq.GetLastBlockHeaderReq',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='height', full_name='btq.GetLastBlockHeaderReq.height', index=0,
      number=1, type=4, cpp_type=4, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_GETBLOCKMININGCOMPATIBLERESP = _descriptor.Descriptor(
  ...
  full_name='btq.GetBlockMiningCompatibleResp',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='blockheader', full_name='btq.GetBlockMiningCompatibleResp.blockheader', index=0,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='blockmetadata', full_name='btq.GetBlockMiningCompatibleResp.blockmetadata', index=1,
...
_GETLASTBLOCKHEADERRESP = _descriptor.Descriptor(
  ...
  full_name='btq.GetLastBlockHeaderResp',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='difficulty', full_name='btq.GetLastBlockHeaderResp.difficulty', index=0,
      number=1, type=4, cpp_type=4, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='height', full_name='btq.GetLastBlockHeaderResp.height', index=1,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='timestamp', full_name='btq.GetLastBlockHeaderResp.timestamp', index=2,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='reward', full_name='btq.GetLastBlockHeaderResp.reward', index=3,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='hash', full_name='btq.GetLastBlockHeaderResp.hash', index=4,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='depth', full_name='btq.GetLastBlockHeaderResp.depth', index=5,
...
_GETBLOCKTOMINEREQ = _descriptor.Descriptor(
  ...
  full_name='btq.GetBlockToMineReq',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='wallet_address', full_name='btq.GetBlockToMineReq.wallet_address', index=0,
...
_GETBLOCKTOMINERESP = _descriptor.Descriptor(
  ...
  full_name='btq.GetBlockToMineResp',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='blocktemplate_blob', full_name='btq.GetBlockToMineResp.blocktemplate_blob', index=0,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='difficulty', full_name='btq.GetBlockToMineResp.difficulty', index=1,
      number=2, type=4, cpp_type=4, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='height', full_name='btq.GetBlockToMineResp.height', index=2,
      number=3, type=4, cpp_type=4, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='reserved_offset', full_name='btq.GetBlockToMineResp.reserved_offset', index=3,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='seed_hash', full_name='btq.GetBlockToMineResp.seed_hash', index=4,
      number=5, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_SUBMITMINEDBLOCKREQ = _descriptor.Descriptor(
  ...
  full_name='btq.SubmitMinedBlockReq',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='blob', full_name='btq.SubmitMinedBlockReq.blob', index=0,
      number=1, type=12, cpp_type=9, label=1,
      has_default_value=False, default_value=_b(""),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_SUBMITMINEDBLOCKRESP = _descriptor.Descriptor(
  ...
  full_name='btq.SubmitMinedBlockResp',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='error', full_name='btq.SubmitMinedBlockResp.error', index=0,
...
_GETBLOCKMININGCOMPATIBLERESP.fields_by_name['blockheader'].message_type = btq__pb2._BLOCKHEADER
_GETBLOCKMININGCOMPATIBLERESP.fields_by_name['blockmetadata'].message_type = btq__pb2._BLOCKMETADATA
...
GetBlockMiningCompatibleReq = _reflection.GeneratedProtocolMessageType('GetBlockMiningCompatibleReq', (_message.Message,), dict(
  ...
  __module__ = 'btqmining_pb2'
  # @@protoc_insertion_point(class_scope:btq.GetBlockMiningCompatibleReq)
  ))
...
GetLastBlockHeaderReq = _reflection.GeneratedProtocolMessageType('GetLastBlockHeaderReq', (_message.Message,), dict(
  ...
  __module__ = 'btqmining_pb2'
  # @@protoc_insertion_point(class_scope:btq.GetLastBlockHeaderReq)
  ))
...
GetBlockMiningCompatibleResp = _reflection.GeneratedProtocolMessageType('GetBlockMiningCompatibleResp', (_message.Message,), dict(
  ...
  __module__ = 'btqmining_pb2'
  # @@protoc_insertion_point(class_scope:btq.GetBlockMiningCompatibleResp)
  ))
...
GetLastBlockHeaderResp = _reflection.GeneratedProtocolMessageType('GetLastBlockHeaderResp', (_message.Message,), dict(
  ...
  __module__ = 'btqmining_pb2'
  # @@protoc_insertion_point(class_scope:btq.GetLastBlockHeaderResp)
  ))
...
GetBlockToMineReq = _reflection.GeneratedProtocolMessageType('GetBlockToMineReq', (_message.Message,), dict(
  ...
  __module__ = 'btqmining_pb2'
  # @@protoc_insertion_point(class_scope:btq.GetBlockToMineReq)
  ))
...
GetBlockToMineResp = _reflection.GeneratedProtocolMessageType('GetBlockToMineResp', (_message.Message,), dict(
  ...
  __module__ = 'btqmining_pb2'
  # @@protoc_insertion_point(class_scope:btq.GetBlockToMineResp)
  ))
...
SubmitMinedBlockReq = _reflection.GeneratedProtocolMessageType('SubmitMinedBlockReq', (_message.Message,), dict(
  ...
  __module__ = 'btqmining_pb2'
  # @@protoc_insertion_point(class_scope:btq.SubmitMinedBlockReq)
  ))
...
SubmitMinedBlockResp = _reflection.GeneratedProtocolMessageType('SubmitMinedBlockResp', (_message.Message,), dict(
  ...
  __module__ = 'btqmining_pb2'
  # @@protoc_insertion_point(class_scope:btq.SubmitMinedBlockResp)
  ))
...
_MININGAPI = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='btq.MiningAPI.GetBlockMiningCompatible',
    index=0,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='btq.MiningAPI.GetLastBlockHeader',
    index=1,
    containing_service=None,
  ...
  _descriptor.MethodDescriptor(
    name='GetBlockToMine',
    full_name='btq.MiningAPI.GetBlockToMine',
    index=2,
    containing_service=None,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='btq.MiningAPI.SubmitMinedBlock',
    index=3,
    containing_service=None,
