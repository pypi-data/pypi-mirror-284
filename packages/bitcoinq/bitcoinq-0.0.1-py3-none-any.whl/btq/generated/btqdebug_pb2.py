...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  package='btq',
  syntax='proto3',
  serialized_pb=_b('\n\x0ebtqdebug.proto\x12\x03btq\x1a\tbtq.proto\"\x11\n\x0fGetFullStateReq\"i\n\x10GetFullStateResp\x12)\n\x0e\x63oinbase_state\x18\x01 \x01(\x0b\x32\x11.btq.AddressState\x12*\n\x0f\x61\x64\x64resses_state\x18\x02 \x03(\x0b\x32\x11.btq.AddressState2G\n\x08\x44\x65\x62ugAPI\x12;\n\x0cGetFullState\x12\x14.btq.GetFullStateReq\x1a\x15.btq.GetFullStateRespb\x06proto3')
  ,
...
_GETFULLSTATERESP = _descriptor.Descriptor(
  ...
  full_name='btq.GetFullStateResp',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='coinbase_state', full_name='btq.GetFullStateResp.coinbase_state', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='addresses_state', full_name='btq.GetFullStateResp.addresses_state', index=1,
...
_GETFULLSTATERESP.fields_by_name['coinbase_state'].message_type = btq__pb2._ADDRESSSTATE
_GETFULLSTATERESP.fields_by_name['addresses_state'].message_type = btq__pb2._ADDRESSSTATE
...
GetFullStateReq = _reflection.GeneratedProtocolMessageType('GetFullStateReq', (_message.Message,), dict(
  ...
  __module__ = 'btqdebug_pb2'
  # @@protoc_insertion_point(class_scope:btq.GetFullStateReq)
  ))
...
GetFullStateResp = _reflection.GeneratedProtocolMessageType('GetFullStateResp', (_message.Message,), dict(
  ...
  __module__ = 'btqdebug_pb2'
  # @@protoc_insertion_point(class_scope:btq.GetFullStateResp)
  ))
...
_DEBUGAPI = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='GetFullState',
    full_name='btq.DebugAPI.GetFullState',
    index=0,
