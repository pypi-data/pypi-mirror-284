...
from btq.core.Singleton import Singleton
from btq.core.miners.qryptonight7.CNv1PoWValidator import CNv1PoWValidator
from btq.core.miners.qrandomx.QRXPoWValidator import QRXPoWValidator
