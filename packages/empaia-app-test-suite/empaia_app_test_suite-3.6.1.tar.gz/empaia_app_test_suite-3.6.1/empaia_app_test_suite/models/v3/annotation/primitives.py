...
from pydantic import UUID4, Field, StrictInt, ValidationError, conlist, field_validator, model_validator
...
StringPrimitiveValue = Annotated[str, Field(min_length=1, max_length=200, strip_whitespace=True)]
