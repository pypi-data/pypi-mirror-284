...
class SignatureProof(BaseModel):
    ...
    embedded_signature_infos: Optional[List[SignatureInfo]] = Field(default=None, alias="embeddedSignatureInfos")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.pages_properties:
            for _key in self.pages_properties:
                if self.pages_properties[_key]:
                    _field_dict[_key] = self.pages_properties[_key].to_dict()
        ...
        if self.signature_placement_annotations:
            for _item in self.signature_placement_annotations:
                if _item:
        ...
        if self.signature_tags:
            for _key in self.signature_tags:
                if self.signature_tags[_key]:
                    _field_dict[_key] = self.signature_tags[_key].to_dict()
        ...
        _field_dict = {}
        if self.seal_tags:
            for _key in self.seal_tags:
                if self.seal_tags[_key]:
                    _field_dict[_key] = self.seal_tags[_key].to_dict()
        ...
        if self.detached_signatures:
            for _item in self.detached_signatures:
                if _item:
                    _items.append(_item.to_dict())
        ...
        if self.embedded_signature_infos:
            for _item in self.embedded_signature_infos:
                if _item:
                    _items.append(_item.to_dict())
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "embeddedSignatureInfos": [SignatureInfo.from_dict(_item) for _item in obj["embeddedSignatureInfos"]] if obj.get("embeddedSignatureInfos") is not None else None,
