...
class Player:
    ...
    def __init__(self, browser: webdriver, player_id: int):
    ...
    def pull_game_stats(self):
        url_to_open = self.player_game_log_base_url + str(self.id)
    ...
    def pull_ratings(self):    
        url_to_open = self.player_ratings_base_url + str(self.id)
    ...
    def player_details(self) -> dict:
        ...
        return {'player_name': self.name, 'team_name': self.team_name, 'position': self.position,
                ...
                'high_school': self.high_school, 'city': self.town,
                'recruited_by': self.recruited_by,
                'recruit_ranking': self.ranking, 'athleticism': self.athleticism,
                ...
                'url': self.url, 'id': self.id, 'game_log': self.games_log_list}
