    ...
    **Example usage**:
    ...
    def inputs(self, environment_type: EnvironmentType) -> VMConfig:
        ...
        if environment_type == EnvironmentType.PRODUCTION:
            ...
            expose_ports = [5432]  # We only expose firewall port for non-production environments
            machine_type = "f1-micro"
    ...
    def django_settings(self):
        ...
        # We use the external IP if the firewall is configured to expose ports, otherwise we use the internal IP
        if connection_info.ports:
            host = connection_info.external_ip
        else:
            host = connection_info.internal_ip
    ...
    **Example usage:**
    ...
    def inputs(self, environment_type: EnvironmentType) -> VMConfig:
        ...
        if environment_type == EnvironmentType.PRODUCTION:
            ...
            expose_ports = [6379]  # We only expose firewall port for non-production environments
            machine_type = "f1-micro"
