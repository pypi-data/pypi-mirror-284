...
class NoDayLineStrategy:
    ...
    # 策略触发事件每次触发时都会执行该函数
    def handle_data(self, record_item, open_price):
        ...
        for order in self.a_list:
            ...
            if direction == 'buy' and record_item['high'] >= order.get('tp'):
            ...
            elif direction == 'sell' and record_item['high'] >= order.get('sl'):
            ...
            elif direction == 'sell' and record_item['low'] <= order.get('tp'):
            ...
            elif direction == 'buy' and record_item['low'] <= order.get('sl'):
        ...
        self.call_back_dic.get("plot_numeric_yellow")('开盘价', open_price)
        self.call_back_dic.get("plot_numeric_red")('最优值高点', open_price + self.params['min'])
        self.call_back_dic.get("plot_numeric_red")('最优值低点', open_price - self.params['min'])
