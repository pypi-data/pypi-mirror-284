...
if __name__== "__main__":
    ...
    agent1 = LinearCollusionLearner(NUM_POSSIBLE_ACTIONS, NUM_POSSIBLE_STATES, [0.888888,0.888888])
    agent2 = LinearCollusionLearner(NUM_POSSIBLE_ACTIONS, NUM_POSSIBLE_STATES,  [0.888888,0.888888])
    agents = [agent1, agent2]
    env = LinearCollusionEnv(agents, NUM_POSSIBLE_ACTIONS, NUM_POSSIBLE_STATES,  [0.888888,0.888888])
    env.run()
