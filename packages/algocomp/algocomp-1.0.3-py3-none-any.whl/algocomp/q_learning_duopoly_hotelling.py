...
if __name__ == "__main__":
    ...
    agent1 = HotellingCollusionLearner(NUM_POSSIBLE_ACTIONS, NUM_POSSIBLE_STATES,[1,1])
    agent2 = HotellingCollusionLearner(NUM_POSSIBLE_ACTIONS, NUM_POSSIBLE_STATES,[1,1])
    agents = [agent1, agent2]
    env = HotellingCollusionEnv(agents, NUM_POSSIBLE_ACTIONS, NUM_POSSIBLE_STATES,[1,1])
    env.run()
