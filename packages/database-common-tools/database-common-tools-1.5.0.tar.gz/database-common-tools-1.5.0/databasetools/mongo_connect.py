...
def mongo_find_query_v3_batch_size(collection, query, sort_field=None, sort_order=1, projection=None, limit=None, filter_query=None, batch_size=100, cursor_timeout=False):
    """
    在 MongoDB 中进行查询，并可选地应用排序和字段投影。
