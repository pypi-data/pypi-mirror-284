...
class GalileoFlowSDK:
    ...
    def __init__(self, comport_name):
        ...
        self.__registers = {'FLOW' : 6, 'STATE' : 9, 'CLOGGING' : 8, 'SNC' : 12,  'LIQUID': 14}
    ...
    def __connect(self):
        ...
        self.serial_com = serial.Serial(port = self.__comport_name,baudrate = 115200, timeout = 1)
