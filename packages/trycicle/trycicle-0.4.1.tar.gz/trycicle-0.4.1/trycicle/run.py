...
def run_job(job: Job, args: Arguments, source_dir: pathlib.Path) -> int:
    ...
    volumes = {
        str(source_dir): {"bind": "/src", "mode": "rw"},
        str(build_dir): {"bind": "/build", "mode": "ro"},
    }
    ...
    cache_paths = [
        args.cache_path / get_cache_path(cache, variables, args.original_dir)
