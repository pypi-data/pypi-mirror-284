...
def get_commit_variables(source_dir: str) -> dict[str, str]:
...
def get_project_variables(source_dir: str) -> dict[str, str]:
...
def get_predefined_variables(source_dir: str) -> Variables:
