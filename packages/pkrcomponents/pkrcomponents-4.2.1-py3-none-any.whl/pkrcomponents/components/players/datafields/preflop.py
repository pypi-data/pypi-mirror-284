...
FLAG_PREFLOP_OPEN_OPPORTUNITY = field(
        default=False, validator=instance_of(bool),
        metadata={
            'description': 'Whether the player had the opportunity to open preflop', 'type': 'bool'})
FLAG_PREFLOP_OPEN = field(
    default=False, validator=instance_of(bool),
    metadata={
        'description': 'Whether the player opened preflop', 'type': 'bool'})
FLAG_PREFLOP_FIRST_RAISE = field(
    default=False, validator=instance_of(bool),
    metadata={
        'description': 'Whether the player made the first raise preflop', 'type': 'bool'})
...
FLAG_PREFLOP_LIMP = field(
    default=False, validator=instance_of(bool),
    metadata={
        'description': 'Whether the player limped preflop', 'type': 'bool'})
FLAG_PREFLOP_COLD_CALLED = field(
    default=False, validator=instance_of(bool),
    metadata={
        'description': 'Whether the player cold called preflop', 'type': 'bool'})
