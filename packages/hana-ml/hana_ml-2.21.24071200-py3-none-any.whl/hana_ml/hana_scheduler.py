...
class HANAScheduler(object):
    ...
    def set_schedule(self, job_name, cron=None, procedure_name=None, job_start_time=None, job_end_time=None, status='active', procedure_params=None, force=False, disable_timezone_check=False):
        r"""
