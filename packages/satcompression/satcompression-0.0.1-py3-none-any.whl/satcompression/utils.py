...
def check_node(
    ...
    if level == 0:
        ...
        p1 = check_node(graph.bottom_left_node, level - 1)*1.
        p2 = check_node(graph.bottom_right_node, level - 1)*1.
        p3 = check_node(graph.top_left_node, level - 1)*1.
        p4 = check_node(graph.top_right_node, level - 1)*1.
        return p1 + p2 + p3 + p4
