...
class TestGetTagsString(unittest.TestCase):
    ...
    def test_get_tags_string_user_profile(
        ...
        result = _get_tags_string(mock_tag_retriever_instance, "domain-123", "user-profile-123", "")
...
class TestExecKernel(unittest.TestCase):
    ...
    @patch("sagemaker_kernel_wrapper.sm_gis_wrapper.RuntimeEnvironment")
    @patch("sagemaker_kernel_wrapper.sm_gis_wrapper.ResourceTagRetriever")
    ...
    def test_exec_kernel(
        ...
        mock_tag_retriever_instance = mock_tag_retriever.return_value
        mock_runtime_environment_instance = mock_runtime_environment.return_value
        mock_runtime_environment_instance.get_execution_role_arn.return_value = "execution-role-arn"
        ...
        mock_get_tags_string.assert_called_once_with(
            mock_tag_retriever_instance, "domain-123", "user-profile-123", ""
        )
    ...
    def test_exec_kernel_for_simulated_job_case(
        ...
        mock_os.environ.__setitem__.assert_called_once_with("glue_role_arn", "execution-role-arn")
    ...
    def test_exec_kernel_for_no_execution_role_arn(
        ...
        mock_tag_retriever_instance = mock_tag_retriever.return_value
        mock_runtime_environment_instance = mock_runtime_environment.return_value
        mock_runtime_environment_instance.get_execution_role_arn.return_value = None
