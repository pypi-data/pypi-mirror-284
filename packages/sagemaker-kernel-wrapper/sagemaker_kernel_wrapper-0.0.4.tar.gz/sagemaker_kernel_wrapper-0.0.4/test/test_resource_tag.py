...
class TestResourceTagRetriever(unittest.TestCase):
    ...
    def test_get_user_profile_tags(self):
        user_profile_arn = "arn:aws:sagemaker:us-west-2:123456789012:domain/domain-123/user-profile/user-profile-123"
        self.mock_client.describe_user_profile.return_value = {"UserProfileArn": user_profile_arn}
        self.mock_client.list_tags.return_value = {
            "Tags": [
        ...
        # Call the method under test
        tags = self.tag_retriever.get_user_profile_tags("domain-123", "user-profile-123")
