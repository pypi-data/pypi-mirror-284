...
#: Determines whether the :middleware:`PasswordChangeMiddleware`
...
#: Determines whether to validate passwords using the
#: :validator:`CracklibValidator`.
PASSWORD_USE_CRACKLIB = getattr(settings, "PASSWORD_USE_CRACKLIB", False)

#: Determines whether to use the password history.
