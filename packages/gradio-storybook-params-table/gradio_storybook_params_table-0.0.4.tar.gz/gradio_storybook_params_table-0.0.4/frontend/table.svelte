                ...
                <TableBodyRow>
                    <TableBodyCell>
                        <div style="width: 100px" class="ellipsis-single-line">
                            <span style="white-space: pre-wrap;">{param.name}</span>
                            <Tooltip type="light">{param.name}</Tooltip>
                        </div>
                    </TableBodyCell>
                    <TableBodyCell>
                        <div style="width: 180px;overflow-wrap: break-word;">
                            <div style="white-space: pre-wrap;">{param.description}</div>
                        </div>
                    </TableBodyCell>
                    <TableBodyCell>
                        <div style="width: {(tableWidth - 280) / 2}px">
                            <span style="white-space: pre-wrap;">{param.defaultValue}</span>
                        </div>
                    </TableBodyCell>
                    <TableBodyCell>
                        <div
                        ...
                        >
                            {#if param.type === "string" || param.type === "dict" || param.type === "list"}
                                <Textarea
                                    ...
                                    on:change={update}
                                    style="background-color: rgb(17 24 39);width: 100%;"
                                />
                            {/if}
