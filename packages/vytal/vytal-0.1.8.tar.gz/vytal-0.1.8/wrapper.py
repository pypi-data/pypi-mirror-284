...
class Client:
    def __init__(self, base_url, calib_info=None):
    ...
    async def predict_from_websocket(self):    
        function_endpoint = self.base_url + "video/handle_livestream"
        print(function_endpoint)
        print("entered async definition in wrapper")
        try:
            async with websockets.connect(function_endpoint) as websocket:
                ...
                try:
                    while True:
                        ...
                        # Display the frame with a placeholder for results
