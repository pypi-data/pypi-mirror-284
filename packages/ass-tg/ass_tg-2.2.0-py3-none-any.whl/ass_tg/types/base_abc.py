from abc import ABC
from typing import Any, Generic, Optional, Tuple, TypeVar, Dict, List
...
class ArgFabric(Generic[ArgValueType]):
    ...
    # Whatever argument can parse from the empty string. Disables some checks. For example OptionalArg can always be
    # empty
    ...
    @property
    def examples(self) -> Optional[Dict[str | StyleStr, Optional[LazyProxy]]]:
        """
    ...
    def pre_parse(
        ...
        """
        return self.parse(text, offset, entities)
