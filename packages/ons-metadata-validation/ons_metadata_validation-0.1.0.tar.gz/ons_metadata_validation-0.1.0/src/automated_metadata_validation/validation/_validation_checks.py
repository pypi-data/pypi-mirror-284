...
# TODO: will we accept anything other than UTF-8?
...
def is_poc_pipe_prod(item: str) -> bool:
...
def must_be_zero_dot_followed_by_four_digits(item: float) -> bool:
    """0.1234 -> True
    1.23 -> False
    """
    str_item = str(item)
    return _regex_match(r"^0.\d\d\d\d$", str_item)
