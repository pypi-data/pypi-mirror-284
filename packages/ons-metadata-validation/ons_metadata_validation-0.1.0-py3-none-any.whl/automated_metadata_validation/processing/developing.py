...
from automated_metadata_validation.io import input_functions as inp
from automated_metadata_validation.io.cell_template import (
    MetadataValues,
)
...
def search_md_values(
    ...
    raise NotImplementedError(f"No entry that matches key: {key}")
