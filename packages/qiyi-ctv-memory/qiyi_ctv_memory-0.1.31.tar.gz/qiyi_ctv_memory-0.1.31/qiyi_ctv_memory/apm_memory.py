...
def main():
    ...
    if categories == 'native':
        native_memory_path = pkg_resources.resource_filename('qiyi_ctv_memory', 'native/native_memory.py')
        command = ['python', native_memory_path] + unknown_args
        try:
            ...
            print("Error during subprocess execution: {}").format(e)
    else :
        adb = Adb()
