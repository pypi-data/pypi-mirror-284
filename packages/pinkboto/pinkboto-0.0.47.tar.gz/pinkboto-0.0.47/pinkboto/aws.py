...
class aws(object):
    def __init__(self, profile=None, region="us-east-1", cache=120, config=None, session=None):
        """
        Create connection.
        :param profile: AWS profile
        :param region: AWS region
        :param cache: Cache usage
        :param session: custom session to use, otherwise create new one
        """
        self.profile = profile or environ.get("AWS_PROFILE", None)
        self.region = region
