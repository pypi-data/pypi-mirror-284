...
def secant_method(funcion, a, b, epsilon, delta_x, max_iteraciones=10000):
    """
    Método de la secante para encontrar un intervalo que contiene un mínimo local de una función dada.
    ...
    while abs(x1 - x2) > epsilon and iteraciones < max_iteraciones:
        # Cálculo del nuevo punto utilizando el método de la secante
