...
class SolarArray(BaseModel):
    """
    The solar array configuration. Together with the Battery, it is required to simulate the power system and the attitude.
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, description="The type of solar array")
    efficiency: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The solar array efficiency [0, 1]. It is required to simulate the power system and the attitude.")
