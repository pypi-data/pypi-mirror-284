...
class Binomial(Distribution):
    ...
    def __init__(self, prob, size):
        ...
        #       You can use the calculate_mean() and calculate_stdev() methods defined below along 
        #       with the __init__ function from the Distribution class
        self.p = prob
        self.n = size
        Distribution.__init__(self, self.calculate_mean(self = self), self.calculate_stdev(self = self))
    ...
    # TODO: write a method plot_bar() that outputs a bar chart of the data set according to 
    ...
    # write a method to output the sum of two binomial distributions. Assume both distributions 
