...
def std_module_name(name):
    """
    std_module_name('YMC/MASK//  mask ') # 'YMC_MASK_mask'
    """
...
def make_module_valid_node_class_map(NodeClassList:list,infoname:bool=False):
    ...
    for cls in NodeClassList:
        ...
        if hasattr(cls,"NODE_DESC"):
            ...
            if  NODE_DISPLAY_NAME_MAPPINGS.get(menu_name,None) != None:
...
def entry_prepare_import(name:str,file:str,infoimport=None,):
    ...
    debug_print(f'[info] import utils from parent file')

    debug_print(f'[info] define __all__ with utils.make_all_import')
...
def entry_do_after_import(name:str,file:str,infoimport=None,):
    ...
    debug_print(f'[info] get all module name of this module in sys')
    ...
    debug_print(f'[info] get all classes of this module in this module')
    all_classes=[]
    # for x in __all__:
    ...
    debug_print(f'[info] make valid node class map of this module')
    NODE_CLASS_MAPPINGS,NODE_DISPLAY_NAME_MAPPINGS,NODE_MENU_NAMES  = make_module_valid_node_class_map(all_classes,False)
...
def entry(name,file,infoimport=None,):
    ...
    debug_print(f'[info] import __all__ with from . import * ')
