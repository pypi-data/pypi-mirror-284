...
class DeploymentTokenRequest(BaseModel):
    ...
    revoked: Optional[StrictBool] = Field(default=False, description="Whether the deployment token is revoked")
    user: Optional[StrictStr] = Field(default=None, description="The user name or ID.")
