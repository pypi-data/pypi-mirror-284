...
def _uniffi_check_api_checksums(lib):
    ...
    if lib.uniffi_breez_sdk_liquid_bindings_checksum_method_bindingliquidsdk_list_fiat_currencies() != 38203:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_breez_sdk_liquid_bindings_checksum_method_bindingliquidsdk_list_payments() != 38113:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_breez_sdk_liquid_bindings_checksum_method_bindingliquidsdk_prepare_pay_onchain() != 1876:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_breez_sdk_liquid_bindings_checksum_method_bindingliquidsdk_prepare_receive_onchain() != 48074:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_breez_sdk_liquid_bindings_checksum_method_bindingliquidsdk_prepare_send_payment() != 1183:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_breez_sdk_liquid_bindings_checksum_method_bindingliquidsdk_receive_onchain() != 53597:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_breez_sdk_liquid_bindings_checksum_method_bindingliquidsdk_receive_payment() != 48554:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_breez_sdk_liquid_bindings_checksum_method_bindingliquidsdk_restore() != 63590:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_breez_sdk_liquid_bindings_checksum_method_bindingliquidsdk_send_payment() != 61467:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
...
_UniffiLib.uniffi_breez_sdk_liquid_bindings_fn_method_bindingliquidsdk_prepare_receive_onchain.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_breez_sdk_liquid_bindings_fn_method_bindingliquidsdk_prepare_receive_onchain.restype = _UniffiRustBuffer
...
_UniffiLib.uniffi_breez_sdk_liquid_bindings_fn_method_bindingliquidsdk_receive_onchain.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_breez_sdk_liquid_bindings_fn_method_bindingliquidsdk_receive_onchain.restype = _UniffiRustBuffer
...
_UniffiLib.uniffi_breez_sdk_liquid_bindings_checksum_method_bindingliquidsdk_prepare_receive_onchain.argtypes = (
)
_UniffiLib.uniffi_breez_sdk_liquid_bindings_checksum_method_bindingliquidsdk_prepare_receive_onchain.restype = ctypes.c_uint16
...
_UniffiLib.uniffi_breez_sdk_liquid_bindings_checksum_method_bindingliquidsdk_receive_onchain.argtypes = (
)
_UniffiLib.uniffi_breez_sdk_liquid_bindings_checksum_method_bindingliquidsdk_receive_onchain.restype = ctypes.c_uint16
...
class BindingLiquidSdk:
    ...
    def prepare_receive_onchain(self, req: "PrepareReceiveOnchainRequest") -> "PrepareReceiveOnchainResponse":
        ...
        return _UniffiConverterTypePrepareReceiveOnchainResponse.lift(
            _rust_call_with_error(_UniffiConverterTypePaymentError,_UniffiLib.uniffi_breez_sdk_liquid_bindings_fn_method_bindingliquidsdk_prepare_receive_onchain,self._uniffi_clone_pointer(),
    ...
    def receive_onchain(self, req: "PrepareReceiveOnchainResponse") -> "ReceiveOnchainResponse":
        ...
        return _UniffiConverterTypeReceiveOnchainResponse.lift(
            _rust_call_with_error(_UniffiConverterTypePaymentError,_UniffiLib.uniffi_breez_sdk_liquid_bindings_fn_method_bindingliquidsdk_receive_onchain,self._uniffi_clone_pointer(),
...
class Config:
    ...
    @typing.no_type_check
    def __init__(self, *, liquid_electrum_url: "str", bitcoin_electrum_url: "str", working_dir: "str", network: "LiquidNetwork", payment_timeout_sec: "int", zero_conf_min_fee_rate_msat: "int", zero_conf_max_amount_sat: "typing.Optional[int]"):
    ...
    def __str__(self):
        return "Config(liquid_electrum_url={}, bitcoin_electrum_url={}, working_dir={}, network={}, payment_timeout_sec={}, zero_conf_min_fee_rate_msat={}, zero_conf_max_amount_sat={})".format(self.liquid_electrum_url, self.bitcoin_electrum_url, self.working_dir, self.network, self.payment_timeout_sec, self.zero_conf_min_fee_rate_msat, self.zero_conf_max_amount_sat)
