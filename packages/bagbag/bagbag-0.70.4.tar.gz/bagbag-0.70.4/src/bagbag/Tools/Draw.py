...
def XY(x_values:list, y_values:list, sortByX:bool=True, title:str="This is a title", xlabel:str="X", ylabel:str="Y", connect_points:bool=True, width:int=8, height:int=6) -> bytes:
    """
