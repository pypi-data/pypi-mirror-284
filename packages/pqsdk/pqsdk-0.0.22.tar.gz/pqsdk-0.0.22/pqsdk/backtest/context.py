...
from pqsdk.api import get_factor, get_attribute_history, get_previous_trading_date, get_last_ticks, get_plate_data, get_plate_members_lst
...
class StrategyContext(AbstractStrategyContext):
    ...
    def get_plate_data(self, trade_date: str = None) -> pd.DataFrame:
        """
        获取板块列表
        :param trade_date: TODO 指定交易日的板块列表
        :return:
        """
        return get_plate_data(trade_date=trade_date)
