...
from all stellar processes within/across each element-tracer stellar age bin for each element.
...
class ElementTracerClass(dict):
    ...
    assignelemental abundances to star particles and gas cells in post-processing.
    '''
...
def initialize_elementtracers(
    ...
    for part in parts:
        ...
        yield_dict = Yield.get_element_yields(part[spec_name].ElementTracer['age.bins'])
        ...
        for spec_name in species_names:
            ...
            part[spec_name].ElementTracer.assign_element_yield_massfractions(yield_dict)
