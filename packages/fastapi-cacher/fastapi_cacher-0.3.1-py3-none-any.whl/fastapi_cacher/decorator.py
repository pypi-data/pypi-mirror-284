...
from fastapi_cacher import FastAPICache
from fastapi_cacher.coder import Coder
from fastapi_cacher.types import KeyBuilder
...
def cache(
        ...
        namespace: str = "",
        injected_dependency_namespace: str = "__fastapi_cacher",
