...
>
	...
	<table border='1' class="fep-result-table">
		...
		<tbody style={`max-height: ${max_height}px`} class="fep-result-table-body">
			{#each tableData as data}
				<tr>
...
<style>
	...
	.fep-result-table thead {
		display: block;
	}

	.fep-result-table tbody {
		display: block;
