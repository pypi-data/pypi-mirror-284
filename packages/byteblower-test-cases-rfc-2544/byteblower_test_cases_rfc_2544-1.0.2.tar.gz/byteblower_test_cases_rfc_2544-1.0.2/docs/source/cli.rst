...
The installation of the RFC 2544 throughput test case and its
...
Take a look at :doc:`config` for all detailed information about
...
#. Go to the directory where you installed byteblower-test-cases-rfc-2544
