...
def _access_node_key(key: str, new_key: str, datatree: DataTree[Any]) -> Any:
...
def _get_node(node: str, path_to_node: str, path_with_new_node: str, datatree: DataTree[Any]) -> Any:
