...
The Low Latency test case and its dependencies will now be installed
from `PyPI`_.

.. _PyPI: https://pypi.org/project/byteblower-test-cases-low-latency/
...
The Low Latency test case can also be imported and used in Python as follows:
