...
class Pluggables(object):

    """Implementation of the 'Pluggables' model.
    ...
    Attributes:
        ...
        healthy_units (List[str]): name of healthy components
        unhealthy (int): unhealthy count
        unhealthy_units (List[str]): name of unhealthy components
    ...
    def __init__(self,
        ...
        """Constructor for the Pluggables class"""
