...
def test_index0_worker(data):
    try:
        ...
        data_all =  ['data1', 'data2', 'data3', 'data4', 'data5', 'data6', 'data7', 'data8', 'data9', 'data10']
...
def test_index0_simulate_parallel_writes(dirindex, data_list):
...
def test_index0():
    """ 
         python fetch_async.py test_index0
          log:
            Process 11356, index_lock.put: ['data1']
            Process 6524, index_lock.put: ['data2']
            file lock waiting 1s
            Process 14648, index_lock.put: ['data3']
            file lock waiting 1s
            Process 15440, index_lock.put: ['data5']
            file lock waiting 1s
            Process 2216, index_lock.put: ['data7']
            Process 15920, index_lock.put: ['data9']
            Process 15020, index_lock.put: ['data10']
            Process 11876, index_lock.put: ['data6']
            Process 9368, index_lock.put: ['data4']
            Process 8668, index_lock.put: ['data8']
            Process 11356, get_block: None
            Process 11356, get: ['data1', 'data2', 'data3', 'data5', 'data7', 'data9', 'data10', 'data6', 'data4', 'data8']
            Process 6524, get_block: None
            Process 6524, get: ['data1', 'data2', 'data3', 'data5', 'data7', 'data9', 'data10', 'data6', 'data4', 'data8']
            Process 15440, get_block: None
            Process 15440, get: ['data1', 'data2', 'data3', 'data5', 'data7', 'data9', 'data10', 'data6', 'data4', 'data8']
            Process 15020, get_block: None
            Process 15020, get: ['data1', 'data2', 'data3', 'data5', 'data7', 'data9', 'data10', 'data6', 'data4', 'data8']
            Process 2216, get_block: None
            Process 2216, get: ['data1', 'data2', 'data3', 'data5', 'data7', 'data9', 'data10', 'data6', 'data4', 'data8']
            Process 14648, get_block: None
            Process 14648, get: ['data1', 'data2', 'data3', 'data5', 'data7', 'data9', 'data10', 'data6', 'data4', 'data8']
            Process 11876, get_block: None
            Process 11876, get: ['data1', 'data2', 'data3', 'data5', 'data7', 'data9', 'data10', 'data6', 'data4', 'data8']
            Process 15920, get_block: None
            Process 15920, get: ['data1', 'data2', 'data3', 'data5', 'data7', 'data9', 'data10', 'data6', 'data4', 'data8']
            Process 9368, get_block: None
            Process 9368, get: ['data1', 'data2', 'data3', 'data5', 'data7', 'data9', 'data10', 'data6', 'data4', 'data8']
            Process 8668, get_block: None
            Process 8668, get: ['data1', 'data2', 'data3', 'data5', 'data7', 'data9', 'data10', 'data6', 'data4', 'data8']
    ...
    test_index0_simulate_parallel_writes(dirindex, data_list)
...
def test_pipeline_multiprocessing_5_process():
    """
        ...
        Circular reference detectedCircular reference detected
        doneCircular reference detected
