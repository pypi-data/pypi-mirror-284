...
class ActivateAWorkflowRequestBody:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class ActivateAWorkflowResponseBody:
    r"""200"""
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class ActivateAWorkflowResponse:
    http_meta: components_httpmetadata.HTTPMetadata = dataclasses.field(metadata={'dataclasses_json': { 'exclude': lambda f: True }})
    object: Optional[ActivateAWorkflowResponseBody] = dataclasses.field(default=None)
    r"""200"""
