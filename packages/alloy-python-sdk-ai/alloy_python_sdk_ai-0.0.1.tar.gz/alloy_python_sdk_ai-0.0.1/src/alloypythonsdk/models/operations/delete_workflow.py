...
class DeleteWorkflowRequest:
    ...
    r"""The Id of the workflow to delete"""
...
@dataclasses.dataclass
class DeleteWorkflowResponseBody:
    r"""200"""
    deleted: Optional[bool] = dataclasses.field(default=True, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('deleted'), 'exclude': lambda f: f is None }})
...
class DeleteWorkflowResponse:
    ...
    object: Optional[DeleteWorkflowResponseBody] = dataclasses.field(default=None)
    r"""200"""
