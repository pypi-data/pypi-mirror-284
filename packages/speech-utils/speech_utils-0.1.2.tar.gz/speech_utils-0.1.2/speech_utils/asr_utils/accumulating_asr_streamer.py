...
class AccumulatingASRStreamInferencer(EnterExitService, ABC, Generic[TTimeSpanText_co]):
    """
    ...
    name: CasedNameSlug
    cumulative_message: StreamingASRMessage[TTimeSpanText_co] | None = None
    ...
    ) -> Iterator[StreamingASRMessage[TTimeSpanText_co]]:
...
def _accumulate_message(
    msg: StreamingASRMessage[TTimeSpanText_co],
    cum_msg: StreamingASRMessage[TTimeSpanText_co] | None,
    max_dur: Seconds,
) -> StreamingASRMessage[TTimeSpanText_co]:
    cum_msg = (
