...
@dataclass
class NeNoSegments(
    Sequence[TTimeSpan_co],  # no NeSequence here, this confuses pycharm
    DataValidationCoopMixinBase,
):
    """
    ...
    segments: NeSequence[TTimeSpan_co]
    ...
    @overload
    def __getitem__(self, index: int) -> TTimeSpan_co: ...

    @overload
    def __getitem__(self, index: slice) -> Sequence[TTimeSpan_co]: ...
    ...
    def add_offset(
        ...
        # non_overl_segments: Iterable[TTimeSpan_co] # was just for pycharm
        offsetted_segments = [
            type(seg)(
                **seg.to_dict()
    ...
    def create_without_validation(
        cls,
        segments: Sequence[TTimeSpan_co],
    ...
    def parse(
        cls,
        segments: OrderedOverlappingSpans[TTimeSpan_co],
...
def fix_segments_to_non_overlapping(
    ...
    raw_segments: OrderedOverlappingSpans[TTimeSpan_co],  # make it a Sequence
    verbose: bool = False,
    the_very_end: float | None = None,
    max_tolerable_overlap: PositiveFloat | None = None,
) -> TNeNoSegments:
    ...
    def non_overlapping_g() -> Iterator[TTimeSpan_co]:
        new_end = 0.0
