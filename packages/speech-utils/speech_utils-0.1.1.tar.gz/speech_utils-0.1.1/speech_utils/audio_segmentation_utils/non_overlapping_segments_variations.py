...
TTimeSpanText_co = TypeVar("TTimeSpanText_co", bound=TimeSpanText, covariant=True)


@dataclass
class TextNeNoSeg(NeNoSegments[TTimeSpanText_co]):
    segments: NeSequence[TTimeSpanText_co]
