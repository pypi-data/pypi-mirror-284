...
class StreamMicrogridDispatchesResponse(google.protobuf.message.Message):
    ...
    DISPATCH_DETAIL_FIELD_NUMBER: builtins.int
    EVENT_FIELD_NUMBER: builtins.int
    event: global___StreamMicrogridDispatchesResponse.Event.ValueType
    """Which event this response was triggered by"""
    @property
    def dispatch_detail(self) -> global___DispatchDetail:
        """Dispatch record returned."""

    def __init__(
        self,
        *,
        dispatch_detail: global___DispatchDetail | None = ...,
        event: global___StreamMicrogridDispatchesResponse.Event.ValueType = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["dispatch_detail", b"dispatch_detail"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["dispatch_detail", b"dispatch_detail", "event", b"event"]) -> None: ...
...
@typing.final
class DispatchDetail(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["create_time", b"create_time", "dispatch", b"dispatch", "end_time", b"end_time", "modification_time", b"modification_time"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["create_time", b"create_time", "dispatch", b"dispatch", "dispatch_id", b"dispatch_id", "end_time", b"end_time", "modification_time", b"modification_time"]) -> None: ...

global___DispatchDetail = DispatchDetail
...
class ListMicrogridDispatchesResponse(google.protobuf.message.Message):
    ...
    PAGINATION_PARAMS_FIELD_NUMBER: builtins.int
    @property
    def dispatches(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___DispatchDetail]:
        """The dispatches"""
    ...
    def __init__(
        self,
        *,
        dispatches: collections.abc.Iterable[global___DispatchDetail] | None = ...,
        pagination_params: frequenz.api.common.v1.pagination.pagination_params_pb2.PaginationParams | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["pagination_params", b"pagination_params"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["dispatches", b"dispatches", "pagination_params", b"pagination_params"]) -> None: ...
...
class CreateMicrogridDispatchResponse(google.protobuf.message.Message):
    ...
    DISPATCH_FIELD_NUMBER: builtins.int
    @property
    def dispatch(self) -> global___DispatchDetail:
        """The created dispatch"""

    def __init__(
        self,
        *,
        dispatch: global___DispatchDetail | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["dispatch", b"dispatch"]) -> builtins.bool: ...
