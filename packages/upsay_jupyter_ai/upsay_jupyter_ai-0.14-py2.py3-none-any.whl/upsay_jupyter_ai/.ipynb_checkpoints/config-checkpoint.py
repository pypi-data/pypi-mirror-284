...
class UPSayAI:
    def __init__(self, model_name="aristote/llama", model_api_key=None, model_temperature=0.7, model_max_tokens=1024, rag_model="dpr", rag_min_relevance=0.5, rag_max_results=5, recommendation_min_relevance=0.7, quiz_difficulte="moyen", quiz_min_relevance=0.2, quiz_max_results=100, num_questions_quiz=5, course_corpus_file="corpus_ISD.csv"):
        ...
        self.quiz_difficulte = quiz_difficulte
    ...
    def check_values(self):
        ...
        assert self.quiz_difficulte in ["facile", "moyen", "difficile"], "Invalid quiz_difficulte. Current supported values are 'facile', 'moyen', or 'difficile'"
    ...
    def config_llm(self):
        ...
        self.quiz_subject = ""
        self.cours_content = ""
        if(self.quiz_difficulte == "facile"):
            self.quiz_level = "licence L1"
        elif(self.quiz_difficulte == "moyen"):
            self.quiz_level = "licence L3"
        elif(self.quiz_difficulte == "difficile"):
            self.quiz_level = "master M1"
        self.persona_prompt_quiz = f"Vous êtes un générateur de quiz style QCM de niveau de difficulté {self.quiz_difficulte} pour des étudiants de {self.quiz_level} qui souhaitent tester leurs connaissances dans le cadre de leurs études et de leur préparation aux examens. Cours à utiliser pour générer le quiz : {self.cours_content}"
    ...
    def ai_quiz(self, line=""):
        ...
        if(self.cours_content == None):
            ...
            if(self.quiz_subject != ""):
                instructions_prompt = f"Générez 5 questions en français style QCM de niveau de difficulté {self.quiz_difficulte} (niveau {self.quiz_level} à l'université) sur le cours de {self.quiz_subject} donné, où chaque question n'a qu'une seule réponse correcte et trois réponses incorrectes. Basez vos questions principalement sur les contenus liés à {self.quiz_subject} couverts par le cours susceptibles d'être abordés lors d'examens futurs. N'hésitez pas à poser des questions sur {self.quiz_subject} concernant des détails qui n'apparaissent pas explicitement dans le cours mais que l'étudiant devrait connaître, à condition qu'elles soient pertinentes et au même niveau de difficulté." + """ Organisez les questions générées dans une liste de dictionnaires python, où chaque dictionnaire représente une question formatée comme suit : [{"énoncé": "Question à l'élève (1) ?", "bonne_réponse": "Ceci est la réponse correcte à la question 1.", "mauvaises_réponses":["Ceci est la première réponse incorrecte à la question 1.", "Ceci est la deuxième réponse incorrecte à la question 1.", "Ceci est la troisième réponse incorrecte à la question 1."]}, {"énoncé": "Question à l'élève (2) ?", "bonne_réponse": "Ceci est la réponse correcte à la question 2.", "mauvaises_réponses":["Ceci est la première réponse incorrecte à la question 2.", "Ceci est la deuxième réponse incorrecte à la question 2.", "Ceci est la troisième réponse incorrecte à la question 2."]}, ...]. N'oubliez pas de bien séparer les éléments des dictionnaires et de la liste par des virgules conformément aux standards python.""" + f"Ne retournez rien d'autre que la liste des dictionnaires python dans le bon format avec les questions QCM en français sur le sujet {self.quiz_subject}."
            else:
                instructions_prompt = f"Générez 5 questions en français style QCM de niveau de difficulté {self.quiz_difficulte} (niveau {self.quiz_level} à l'université) sur le cours donné, où chaque question n'a qu'une seule réponse correcte et trois réponses incorrectes." + """Basez vos questions principalement sur les contenus liés à l'Introduction à la Science des Données (statistiques, probabilités, mathématiques, programmation python, apprentissage statistique, etc) couverts par le cours susceptibles d'être abordés lors d'examens futurs. N'hésitez pas à poser des questions sur le même sujet concernant des détails qui n'apparaissent pas explicitement dans le cours mais que l'étudiant devrait connaître, à condition qu'elles soient pertinentes et au même niveau de difficulté. Organisez les questions générées dans une liste de dictionnaires python, où chaque dictionnaire représente une question formatée comme suit : [{"énoncé": "Question à l'élève (1) ?", "bonne_réponse": "Ceci est la réponse correcte à la question 1.", "mauvaises_réponses":["Ceci est la première réponse incorrecte à la question 1.", "Ceci est la deuxième réponse incorrecte à la question 1.", "Ceci est la troisième réponse incorrecte à la question 1."]}, {"énoncé": "Question à l'élève (2) ?", "bonne_réponse": "Ceci est la réponse correcte à la question 2.", "mauvaises_réponses":["Ceci est la première réponse incorrecte à la question 2.", "Ceci est la deuxième réponse incorrecte à la question 2.", "Ceci est la troisième réponse incorrecte à la question 2."]}, ...]. N'oubliez pas de bien séparer les éléments des dictionnaires et de la liste par des virgules conformément aux standards python. Ne retournez rien d'autre que la liste des dictionnaires python dans le bon format avec les questions QCM en français sur le cours donné."""
    ...
    def ai_help(self, line):
        display(HTML("<h3>Guide d'Utilisation</h3>"))
