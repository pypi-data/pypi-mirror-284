...
resourcePath = path('mastermind_tk.resources', 'icon-font.ong')
icon = PhotoImage(file=str(resourcePath))
...
def main():
    global btns, crossPanel, reloadPanel, reloader, panelHigh, history, history_label, history_results, \
        history_text, quitter, panelNumbers, checker, resourcePath
