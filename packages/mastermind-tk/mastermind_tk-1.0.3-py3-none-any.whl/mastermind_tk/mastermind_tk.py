...
icon = PhotoImage(file="resources/icon-font.png")
...
def main():
    global btns, crossPanel, reloadPanel, reloader, panelHigh, \
    history, history_label, history_results, history_text, quitter, panelNumbers, checker
    ...
    IMAGE = getcwd().replace("\\", "/") + "/resources/icon-font.png"
