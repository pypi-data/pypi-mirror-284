...
if __name__ == "__main__":
    ...
    wf_base = pb.WaveformBase(station_id="00", figure_title="waveform for " + EVENT_NAME, start_time_epoch=0)
    ...
    fig2 = pt.plot_wf_mesh_2_vert(wf_base, wf_panel_a, mesh_base, mesh_panel, mesh_panel)
