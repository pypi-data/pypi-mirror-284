...
def my_pipe(file_name: str = '', database_path: str = ''):
    ...
    for (_m_t, ), _subset in groups:
        ...
        measure_info = MeasurementInformation(experiment='NRT', condition='test_condition', date='today')
        ...
        if _m_t == "SOE":
            ...
            measure_info = MeasurementInformation(experiment='SOE', condition='test_condition', date='today')
...
if __name__ == "__main__":
    ...
    for _file in files:
        fig = my_pipe(file_name=_file, database_path=database_path)
        fig.show()
