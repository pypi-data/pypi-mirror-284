...
def run_setup():
    ...
    setup(name="nrt_analyzer",
          ...
          long_description="""
          Tools to pipeline bulk analyses of NRT recordings from Cochlear. 
          The overall goal is to produce easy processing pipelines to perform batch data analyses in a systematic 
