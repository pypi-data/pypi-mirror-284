...
Note: cmdline endswith [{Fore.light_red}#clr{Fore.light_green}] clears current line for a retry{Style.reset}
...
{Back.grey_35}:{Fore.light_green}{Back.grey_15} ''')
            ...
            if cmd.endswith("#clr"):
                print(f"{Fore.light_magenta}Sometimes we need to {Fore.sky_blue_2}re-think our '{Fore.light_red}{cmd.replace('#clr','')}{Fore.sky_blue_2}'!{Style.reset}")
                continue
