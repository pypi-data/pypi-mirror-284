"""Repeat the following paper for `SSAES`:
    ...
    https://github.com/Evolutionary-Intelligence/pypop/blob/main/docs/repeatability/ssaes/_repeat_ssaes.png
...
if __name__ == '__main__':
    ...
    options = {'max_function_evaluations': 60000,
               ...
               'saving_fitness': 1,
               'is_restart': False}
    ssaes = SSAES(problem, options)
    fitness = ssaes.optimize()['fitness']
