def test_optimize():
    ...
    ccmaes2009 = CCMAES2009(problem, options)  # to initialize the black-box optimizer class
    results = ccmaes2009.optimize()  # to run its optimization/evolution process
