"""This code only tests whether the corresponding optimizer could run or not.
  ...
  For the correctness validation of programming, refer to the following link:
    https://github.com/Evolutionary-Intelligence/pypop/blob/main/pypop7/optimizers/es/_repeat_ccmaes2016.py
"""
import unittest
...
from pypop7.optimizers.es.ccmaes2016 import CCMAES2016 as Solver


class TestCCMAES2016(unittest.TestCase):
