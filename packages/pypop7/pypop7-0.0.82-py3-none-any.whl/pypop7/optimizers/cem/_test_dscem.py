"""This code only tests whether the corresponding optimizer could run or not.
  ...
  For the correctness validation of programming, refer to the following link:
    https://github.com/Evolutionary-Intelligence/pypop/blob/main/pypop7/optimizers/cem/_repeat_dscem.py
"""
import unittest
import time
...
from pypop7.optimizers.cem.dscem import DSCEM as Solver


class TestDSCEM(unittest.TestCase):
