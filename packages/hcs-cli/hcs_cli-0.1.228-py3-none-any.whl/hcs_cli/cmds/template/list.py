...
def _format_template_table(data):
    fields_mapping = {
        ...
        "reportedStatus.provisionedVMs": "Provisioned",
        "reportedStatus.consumedVMs": "Consumed",
        "reportedStatus.provisioningVMs": "Provisioning",
        "reportedStatus.deletingVMs": "Deleting",
        "reportedStatus.errorVMs": "Error",
        "reportedStatus.maintenanceVMs": "Maintenance",
    }
