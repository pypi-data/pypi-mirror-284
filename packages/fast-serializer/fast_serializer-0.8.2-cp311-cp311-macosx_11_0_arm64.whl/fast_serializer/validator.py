...
class ListValidator(Validator):
    ...
    min_length: optional[cython.int]
    max_length: optional[cython.int]

    def __init__(self, item_validator: Validator, min_length: optional[cython.int] = None,
                 max_length: optional[cython.int] = None,
                 **kwargs):
        super().__init__(**kwargs)
    ...
    def validate(self, value) -> list:
        ...
        collection_length: cython.long = len(collection)
        # 验证长度
