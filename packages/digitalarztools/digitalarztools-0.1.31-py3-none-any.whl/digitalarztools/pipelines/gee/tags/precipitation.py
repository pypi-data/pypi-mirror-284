...
class Precipitation:
    ...
    @staticmethod
    def get_accumulated_precipitation(region: GEERegion, no_of_days=16, end_date=None, mask_threshold=-1):
        """
        @param region:
        @param end_date:
        @return:
        """
        date_range = GEEImageCollection.get_date_range(no_of_days * 3, end_date)
