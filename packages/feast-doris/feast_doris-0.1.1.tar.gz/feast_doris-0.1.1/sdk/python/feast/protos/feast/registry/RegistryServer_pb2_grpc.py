...
class RegistryServerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ListFeatureViews = channel.unary_unary(
                ...
                _registered_method=True)
        self.GetRequestFeatureView = channel.unary_unary(
                '/feast.registry.RegistryServer/GetRequestFeatureView',
                request_serializer=feast_dot_registry_dot_RegistryServer__pb2.GetRequestFeatureViewRequest.SerializeToString,
                response_deserializer=feast_dot_core_dot_RequestFeatureView__pb2.RequestFeatureView.FromString,
                _registered_method=True)
        self.ListRequestFeatureViews = channel.unary_unary(
                '/feast.registry.RegistryServer/ListRequestFeatureViews',
                request_serializer=feast_dot_registry_dot_RegistryServer__pb2.ListRequestFeatureViewsRequest.SerializeToString,
                response_deserializer=feast_dot_registry_dot_RegistryServer__pb2.ListRequestFeatureViewsResponse.FromString,
                _registered_method=True)
...
class RegistryServerServicer(object):
    ...
    def GetRequestFeatureView(self, request, context):
...
def add_RegistryServerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetRequestFeatureView': grpc.unary_unary_rpc_method_handler(
                    servicer.GetRequestFeatureView,
                    request_deserializer=feast_dot_registry_dot_RegistryServer__pb2.GetRequestFeatureViewRequest.FromString,
                    response_serializer=feast_dot_core_dot_RequestFeatureView__pb2.RequestFeatureView.SerializeToString,
            ),
            'ListRequestFeatureViews': grpc.unary_unary_rpc_method_handler(
                    servicer.ListRequestFeatureViews,
                    request_deserializer=feast_dot_registry_dot_RegistryServer__pb2.ListRequestFeatureViewsRequest.FromString,
                    response_serializer=feast_dot_registry_dot_RegistryServer__pb2.ListRequestFeatureViewsResponse.SerializeToString,
            ),
...
class RegistryServer(object):
    ...
    @staticmethod
    def GetRequestFeatureView(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/feast.registry.RegistryServer/GetRequestFeatureView',
            feast_dot_registry_dot_RegistryServer__pb2.GetRequestFeatureViewRequest.SerializeToString,
            feast_dot_core_dot_RequestFeatureView__pb2.RequestFeatureView.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    @staticmethod
    def ListRequestFeatureViews(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/feast.registry.RegistryServer/ListRequestFeatureViews',
            feast_dot_registry_dot_RegistryServer__pb2.ListRequestFeatureViewsRequest.SerializeToString,
            feast_dot_registry_dot_RegistryServer__pb2.ListRequestFeatureViewsResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
