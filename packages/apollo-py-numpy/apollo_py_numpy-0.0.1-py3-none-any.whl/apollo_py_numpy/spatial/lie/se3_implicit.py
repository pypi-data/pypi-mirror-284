...
from apollo_py_numpy.spatial.isometries import IsometryMatrix3
from apollo_py_numpy.spatial.lie.so3 import LieGroupSO3, LieAlgSO3
from apollo_py_numpy.spatial.matrices import M3
from apollo_py_numpy.spatial.rotation_matrices import Rotation3
from apollo_py_numpy.spatial.vectors import V3, V6
...
class LieGroupISE3(IsometryMatrix3):
    ...
    def ln(self) -> 'LieAlgISE3':
        a_mat = LieGroupSO3.new_unchecked(self.rotation).ln()
        u = a_mat.vee()
        ...
        return LieAlgISE3(a_mat.view(M3), b)
...
class LieAlgISE3:
    ...
    def exp(self) -> 'LieGroupISE3':
        ...
        return LieGroupISE3(r_mat, t)

    def vee(self) -> 'V6':
        u = LieAlgSO3(self.matrix).vee()
        v = self.vector
