...
class Motion(Coordinate):
    ...
    def make_relative_to(self, other: "Motion") -> "Motion":
        ...
        """
        return self.__class__(**{key: getattr(self, key) - getattr(other, key) for key in self.dict()})
    ...
    def make_absolute(self, reference: "Motion") -> "Motion":
        ...
        """
        return self.__class__(**{key: getattr(self, key) + getattr(reference, key) for key in self.dict()})
