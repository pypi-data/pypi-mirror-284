...
class ASRBase:
    ...
    def __init__(self, lan, modelsize=None, cache_dir=None, model_dir=None, logfile=sys.stderr, **kwargs):
        ...
        self.transcribe_kargs = dict(kwargs)
        if lan == "auto":
    ...
    def load_model(self, modelsize, cache_dir) -> NoReturn:
        raise NotImplementedError("must be implemented in the child class")

    def transcribe(self, audio, init_prompt="") -> NoReturn:
        raise NotImplementedError("must be implemented in the child class")

    def use_vad(self) -> NoReturn:
        raise NotImplementedError("must be implemented in the child class")
...
class HypothesisBuffer:
        ...
        if len(self.new) >= 1:
            ...
            if abs(a - self.last_commited_time) < 1:
                if self.commited_in_buffer:
                    ...
                    nn = len(self.new)
                    for i in range(1, min(cn, nn, 5) + 1):  # 5 is the maximum
    ...
    def pop_commited(self, time) -> None:
...
class OnlineASRProcessor:
    ...
    def insert_audio_chunk(self, audio) -> None:
    ...
    def chunk_completed_segment(self, res) -> None:
        if self.commited == []:
            return
...
def add_shared_args(parser) -> None:
...
def set_logging(args, logger, other="_server") -> None:
...
if __name__ == "__main__":
    ...
    def output_transcript(o, now=None) -> None:
