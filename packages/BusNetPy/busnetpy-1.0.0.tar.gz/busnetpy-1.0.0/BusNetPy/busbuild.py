...
def line_build(df_point,df_line):
...
def build_route(line,point):
    df_point = build_index(line,point)
    gdf = line_build(df_point,line)
    gdf = ycl_gdf(gdf)
    return gdf
