...
class CheckoutSessionLineItemExternal(UncheckedBaseModel):
    id: str
    ...
    amount_subtotal_atom: int
    amount_total_atom: int
    checkout_session_id: typing.Optional[str] = None
    description: typing.Optional[str] = None
    currency: CurrencyEnum
    price_id: str
    billing_interval: typing.Optional[CalendarIntervalEnum] = None
    quantity: int
