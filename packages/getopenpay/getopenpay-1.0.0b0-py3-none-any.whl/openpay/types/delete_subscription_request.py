...
class DeleteSubscriptionRequest(UncheckedBaseModel):
    cancellation_details: typing.Optional[SubscriptionCancellationDetails] = pydantic_v1.Field(default=None)
    """
    Details about why this subscription was canceled
    """

    prorate: typing.Optional[bool] = pydantic_v1.Field(default=None)
    """
