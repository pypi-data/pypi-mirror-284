...
class PaymentMethodExternal(UncheckedBaseModel):
    ...
    """
    Type of the credit card (e.g. Visa)
    """
    ...
    billing_address: typing.Optional[CompleteAddress] = pydantic_v1.Field(default=None)
    """
