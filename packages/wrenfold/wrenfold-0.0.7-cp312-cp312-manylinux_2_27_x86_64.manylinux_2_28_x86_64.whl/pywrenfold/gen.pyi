...
class FunctionDescription:
    ...
    def output_expressions(self) -> Dict[OutputKey, List[pywrenfold.sym.Expr]]: ...
    @overload
...
@overload
def cse_function_description(desc: FunctionDescription, params: OptimizationParams | None = ...) -> Tuple[Dict[OutputKey, List[pywrenfold.sym.Expr]], List[Tuple[pywrenfold.sym.Expr, pywrenfold.sym.Expr]]]: ...
@overload
def cse_function_description(desc) -> Any: ...
@overload
def transpile(desc: List[FunctionDescription], params: OptimizationParams | None = ...) -> List[pywrenfold.ast.FunctionDefinition]: ...
@overload
def transpile(desc: FunctionDescription, params: OptimizationParams | None = ...) -> pywrenfold.ast.FunctionDefinition: ...
