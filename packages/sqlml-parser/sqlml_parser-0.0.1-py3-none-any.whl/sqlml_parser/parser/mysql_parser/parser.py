...
from sqlml_parser.parser.tree.window import (
    FrameBound,
    FrameClause,
    FrameExpr,
    WindowFrame,
...
from sqlml_parser.parser.tree.with_stmt import CommonTableExpr, With, WithHasQuery
from sqlml_parser.parser.tree.index_type import IndexType
from sqlml_parser.parser.tree.expression import (
    AggregateFunc,
...
from sqlml_parser.parser.tree.literal import (
    BooleanLiteral,
    DateLiteral,
    DoubleLiteral,
    LongLiteral,
...
from sqlml_parser.parser.tree.node import Node
from sqlml_parser.parser.tree.qualified_name import QualifiedName
from sqlml_parser.parser.tree.query_specification import QuerySpecification
from sqlml_parser.parser.tree.relation import AliasedRelation, Join
from sqlml_parser.parser.tree.select import Select
from sqlml_parser.parser.tree.select_item import Partition, SingleColumn
from sqlml_parser.parser.tree.set_operation import Except, Intersect, Union
from sqlml_parser.parser.tree.sort_item import ByItem, PartitionByClause, SortItem
from sqlml_parser.parser.tree.statement import Delete, Insert, Query, Update
from sqlml_parser.parser.tree.table import Table
from sqlml_parser.parser.tree.values import Values
from sqlml_parser.parser.tree.field_type import UNSPECIFIEDLENGTH, FieldType, SQLType

from ply import yacc
from sqlml_parser.parser.mysql_parser.lexer import tokens, lexer
...
def p_json_table_column(p):
    ...
    | column PATH string_lit
    | column PATH string_lit on_empty_or_error_opt
    | column EXISTS PATH string_lit
