...
from lastmile_eval.rag.debugger.common.utils import WEBSITE_BASE_URL
...
class LastMileTracer(ManageParamsImpl, LastMileTracerAPI):
    ...
    def log_feedback(
        ...
        """
        lastmile_endpoint = (
            f"{WEBSITE_BASE_URL}/api/evaluation_feedback/create"
        )
    ...
    def set_project(self) -> None:
        ...
        list_project_endpoint = f"{WEBSITE_BASE_URL}/api/evaluation_projects/list?{urlencode({'name': self.project_name})}"
            ...
            case Ok(list_resp):
                ...
                if not project_exists:
                    ...
                    create_project_endpoint = (
                        f"{WEBSITE_BASE_URL}/api/evaluation_projects/create"
                    )
