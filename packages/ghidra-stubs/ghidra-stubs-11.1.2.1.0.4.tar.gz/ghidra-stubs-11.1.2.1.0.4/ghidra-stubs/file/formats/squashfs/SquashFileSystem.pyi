...
class SquashFileSystem(ghidra.formats.gfilesystem.AbstractFileSystem):
    ...
    def extractFileToStream(self, __a0: java.io.OutputStream, __a1: ghidra.formats.gfilesystem.GFile, __a2: ghidra.util.task.TaskMonitor) -> None: ...
