...
class FunctionComparisonService(object):
    ...
    @overload
    def compareFunctions(self, sourceFunctions: java.util.Set, destinationFunctions: java.util.Set) -> ghidra.app.plugin.core.functioncompare.FunctionComparisonProvider:
        """
