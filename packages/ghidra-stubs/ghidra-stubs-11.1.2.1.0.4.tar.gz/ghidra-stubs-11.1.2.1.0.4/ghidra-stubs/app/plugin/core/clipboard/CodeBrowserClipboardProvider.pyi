...
class CodeBrowserClipboardProvider(ghidra.app.util.ByteCopier, ghidra.app.services.ClipboardContentProviderService):
    ADDRESS_TEXT_TYPE: ghidra.app.util.ClipboardType
    ADDRESS_TEXT_WITH_OFFSET_TYPE: ghidra.app.util.ClipboardType
    BYTE_SOURCE_OFFSET_TYPE: ghidra.app.util.ClipboardType
    CODE_TEXT_TYPE: ghidra.app.util.ClipboardType
    COMMENTS_TYPE: ghidra.app.util.ClipboardType
    GHIDRA_LOCAL_URL_TYPE: ghidra.app.util.ClipboardType
    GHIDRA_SHARED_URL_TYPE: ghidra.app.util.ClipboardType
    LABELS_COMMENTS_TYPE: ghidra.app.util.ClipboardType
    LABELS_TYPE: ghidra.app.util.ClipboardType
