...
class CreateEnumEquateCommand(ghidra.framework.cmd.BackgroundCommand):
    ...
    def __init__(self, __a0: ghidra.program.model.address.AddressSetView, __a1: ghidra.program.model.data.Enum, __a2: bool): ...
    ...
    @overload
    def applyTo(self, __a0: ghidra.program.model.listing.Program, __a1: ghidra.util.task.TaskMonitor) -> bool: ...
