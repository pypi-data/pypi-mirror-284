...
class ProgramStartingLocationPlugin(ghidra.app.plugin.ProgramPlugin):
    ...
    class NonActiveProgramState(java.lang.Enum):
        FIRST_ANALYSIS_COMPLETED: ghidra.app.plugin.core.navigation.ProgramStartingLocationPlugin.NonActiveProgramState
        NEWLY_OPENED: ghidra.app.plugin.core.navigation.ProgramStartingLocationPlugin.NonActiveProgramState
        RESTORED: ghidra.app.plugin.core.navigation.ProgramStartingLocationPlugin.NonActiveProgramState
