...
class TraceRmiLauncherServicePlugin(ghidra.framework.plugintool.Plugin, ghidra.app.services.TraceRmiLauncherService, ghidra.framework.options.OptionsChangeListener):
    ...
    @staticmethod
    def extractFirstFsrl(__a0: ghidra.program.model.listing.Program) -> unicode: ...
    ...
    @staticmethod
    def getProgramPath(__a0: ghidra.program.model.listing.Program, __a1: bool) -> unicode: ...
    ...
    @staticmethod
    def tryProgramPath(__a0: unicode) -> java.io.File: ...
