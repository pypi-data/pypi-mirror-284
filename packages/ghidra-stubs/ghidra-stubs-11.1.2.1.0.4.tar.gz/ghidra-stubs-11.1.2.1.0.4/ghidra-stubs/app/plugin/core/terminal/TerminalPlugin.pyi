...
class TerminalPlugin(ghidra.framework.plugintool.Plugin, ghidra.app.services.TerminalService):
    ...
    @overload
    def createNullTerminal(self, __a0: ghidra.framework.plugintool.Plugin, __a1: java.nio.charset.Charset, __a2: ghidra.app.plugin.core.terminal.vt.VtOutput) -> ghidra.app.services.Terminal: ...

    def createProvider(self, __a0: ghidra.framework.plugintool.Plugin, __a1: java.nio.charset.Charset, __a2: ghidra.app.plugin.core.terminal.vt.VtOutput) -> ghidra.app.plugin.core.terminal.TerminalProvider: ...
    ...
    @overload
    def createWithStreams(self, __a0: ghidra.framework.plugintool.Plugin, __a1: java.nio.charset.Charset, __a2: java.io.InputStream, __a3: java.io.OutputStream) -> ghidra.app.services.Terminal: ...
