...
class TraceRmiTarget(ghidra.app.plugin.core.debug.service.target.AbstractTarget):
    ...
    class Missing(java.lang.Enum):
        MISSING: ghidra.app.plugin.core.debug.service.tracermi.TraceRmiTarget.Missing
        ...
        @overload
        @staticmethod
        def valueOf(__a0: unicode) -> ghidra.app.plugin.core.debug.service.tracermi.TraceRmiTarget.Missing: ...
        ...
        @staticmethod
        def values() -> List[ghidra.app.plugin.core.debug.service.tracermi.TraceRmiTarget.Missing]: ...
