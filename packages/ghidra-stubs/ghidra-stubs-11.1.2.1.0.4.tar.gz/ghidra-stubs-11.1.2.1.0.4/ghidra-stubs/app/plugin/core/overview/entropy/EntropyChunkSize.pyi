...
class EntropyChunkSize(java.lang.Enum):
    LARGE: ghidra.app.plugin.core.overview.entropy.EntropyChunkSize
    MEDIUM: ghidra.app.plugin.core.overview.entropy.EntropyChunkSize
    SMALL: ghidra.app.plugin.core.overview.entropy.EntropyChunkSize
