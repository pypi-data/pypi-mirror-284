...
class DebuggerMethodInvocationDialog(docking.DialogComponentProvider, java.beans.PropertyChangeListener):
    ...
    class PathIsDirEditor(ghidra.app.plugin.core.debug.gui.objects.components.DebuggerMethodInvocationDialog.PathEditor):
    ...
    class FileChooserPanel(javax.swing.JPanel):
        ...
        def setValue(self, __a0: java.io.File) -> None: ...
        ...
        @value.setter
        def value(self, value: java.io.File) -> None: ...
    ...
    class PathIsFileEditor(ghidra.app.plugin.core.debug.gui.objects.components.DebuggerMethodInvocationDialog.PathEditor):
