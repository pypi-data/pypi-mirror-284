...
class SwiftNode(object):





    class NodeProperties(java.lang.Record):




        def __init__(self, __a0: ghidra.app.util.demangler.swift.SwiftDemangledNodeKind, __a1: unicode, __a2: unicode, __a3: int, __a4: unicode, __a5: unicode): ...
        ...
        def kind(self) -> ghidra.app.util.demangler.swift.SwiftDemangledNodeKind: ...

        def mangled(self) -> unicode: ...
    ...
    @property
    def parent(self) -> ghidra.app.util.demangler.swift.nodes.SwiftNode: ...

    @parent.setter
    def parent(self, value: ghidra.app.util.demangler.swift.nodes.SwiftNode) -> None: ...

    @property
    def text(self) -> unicode: ...

    @property
    def unknown(self) -> ghidra.app.util.demangler.DemangledUnknown: ...