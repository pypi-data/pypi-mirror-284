...
class AbstractRegisterDimensionalityDARMsSymbol(ghidra.app.util.bin.format.pdb2.pdbreader.symbol.AbstractDefinedSingleAddressRangeMsSymbol):
    ...
    class MemorySpace(java.lang.Enum):
        DATA: ghidra.app.util.bin.format.pdb2.pdbreader.symbol.AbstractRegisterDimensionalityDARMsSymbol.MemorySpace
        INVALID: ghidra.app.util.bin.format.pdb2.pdbreader.symbol.AbstractRegisterDimensionalityDARMsSymbol.MemorySpace
        READWRITERESOURCE: ghidra.app.util.bin.format.pdb2.pdbreader.symbol.AbstractRegisterDimensionalityDARMsSymbol.MemorySpace
        RESOURCE: ghidra.app.util.bin.format.pdb2.pdbreader.symbol.AbstractRegisterDimensionalityDARMsSymbol.MemorySpace
        SAMPLER: ghidra.app.util.bin.format.pdb2.pdbreader.symbol.AbstractRegisterDimensionalityDARMsSymbol.MemorySpace
        label: unicode
        value: int
