...
class FramePointerOmissionRecord(object):
    ...
    class FrameType(java.lang.Enum):
        FPO: ghidra.app.util.bin.format.pdb2.pdbreader.FramePointerOmissionRecord.FrameType
        NON_FPO: ghidra.app.util.bin.format.pdb2.pdbreader.FramePointerOmissionRecord.FrameType
        TRAP: ghidra.app.util.bin.format.pdb2.pdbreader.FramePointerOmissionRecord.FrameType
        TSS: ghidra.app.util.bin.format.pdb2.pdbreader.FramePointerOmissionRecord.FrameType
        label: unicode
