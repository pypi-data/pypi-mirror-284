...
class JdiBreakpointType(java.lang.Enum):
    ACCESS_WATCHPOINT: ghidra.dbg.jdi.manager.breakpoint.JdiBreakpointType
    BREAKPOINT: ghidra.dbg.jdi.manager.breakpoint.JdiBreakpointType
    BY_NAME: java.util.Map
    MODIFICATION_WATCHPOINT: ghidra.dbg.jdi.manager.breakpoint.JdiBreakpointType
    OTHER: ghidra.dbg.jdi.manager.breakpoint.JdiBreakpointType
