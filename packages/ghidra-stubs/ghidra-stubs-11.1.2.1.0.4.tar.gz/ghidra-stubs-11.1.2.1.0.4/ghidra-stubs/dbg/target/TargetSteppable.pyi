...
class TargetSteppable(ghidra.dbg.target.TargetObject, object):
    ...
    class TargetStepKind(java.lang.Enum):
        EXTENDED: ghidra.dbg.target.TargetSteppable.TargetStepKind
        FINISH: ghidra.dbg.target.TargetSteppable.TargetStepKind
        INTO: ghidra.dbg.target.TargetSteppable.TargetStepKind
        LINE: ghidra.dbg.target.TargetSteppable.TargetStepKind
        OVER: ghidra.dbg.target.TargetSteppable.TargetStepKind
        OVER_LINE: ghidra.dbg.target.TargetSteppable.TargetStepKind
        RETURN: ghidra.dbg.target.TargetSteppable.TargetStepKind
        SKIP: ghidra.dbg.target.TargetSteppable.TargetStepKind
        UNTIL: ghidra.dbg.target.TargetSteppable.TargetStepKind
