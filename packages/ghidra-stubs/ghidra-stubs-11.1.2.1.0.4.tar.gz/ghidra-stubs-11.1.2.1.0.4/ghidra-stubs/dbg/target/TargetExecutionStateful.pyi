...
class TargetExecutionStateful(ghidra.dbg.target.TargetObject, object):
    ...
    class TargetExecutionState(java.lang.Enum):
        ALIVE: ghidra.dbg.target.TargetExecutionStateful.TargetExecutionState
        INACTIVE: ghidra.dbg.target.TargetExecutionStateful.TargetExecutionState
        RUNNING: ghidra.dbg.target.TargetExecutionStateful.TargetExecutionState
        STOPPED: ghidra.dbg.target.TargetExecutionStateful.TargetExecutionState
        TERMINATED: ghidra.dbg.target.TargetExecutionStateful.TargetExecutionState
