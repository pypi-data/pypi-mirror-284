...
class VTMatchSetDB(ghidra.program.database.DatabaseObject, ghidra.feature.vt.api.main.VTMatchSet):
    ...
    @staticmethod
    def getMatchSetDB(__a0: db.DBRecord, __a1: ghidra.feature.vt.api.db.VTSessionDB, __a2: db.DBHandle, __a3: ghidra.framework.data.OpenMode, __a4: ghidra.util.task.TaskMonitor, __a5: ghidra.util.Lock) -> ghidra.feature.vt.api.db.VTMatchSetDB: ...
