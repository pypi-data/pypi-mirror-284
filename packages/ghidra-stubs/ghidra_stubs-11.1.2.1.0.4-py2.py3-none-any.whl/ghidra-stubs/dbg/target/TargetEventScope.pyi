...
class TargetEventScope(ghidra.dbg.target.TargetObject, object):
    ...
    class TargetEventType(java.lang.Enum):
        BREAKPOINT_HIT: ghidra.dbg.target.TargetEventScope.TargetEventType
        EXCEPTION: ghidra.dbg.target.TargetEventScope.TargetEventType
        PROCESS_CREATED: ghidra.dbg.target.TargetEventScope.TargetEventType
        PROCESS_EXITED: ghidra.dbg.target.TargetEventScope.TargetEventType
        RUNNING: ghidra.dbg.target.TargetEventScope.TargetEventType
        SIGNAL: ghidra.dbg.target.TargetEventScope.TargetEventType
        STEP_COMPLETED: ghidra.dbg.target.TargetEventScope.TargetEventType
        STOPPED: ghidra.dbg.target.TargetEventScope.TargetEventType
        THREAD_CREATED: ghidra.dbg.target.TargetEventScope.TargetEventType
        THREAD_EXITED: ghidra.dbg.target.TargetEventScope.TargetEventType
        impliesStop: bool
