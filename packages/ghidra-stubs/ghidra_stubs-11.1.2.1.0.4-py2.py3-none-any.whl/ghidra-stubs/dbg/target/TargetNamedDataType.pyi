...
class TargetNamedDataType(ghidra.dbg.target.TargetObject, ghidra.dbg.attributes.TargetDataType, object):
    ...
    class NamedDataTypeKind(java.lang.Enum):
        ENUM: ghidra.dbg.target.TargetNamedDataType.NamedDataTypeKind
        FUNCTION: ghidra.dbg.target.TargetNamedDataType.NamedDataTypeKind
        STRUCT: ghidra.dbg.target.TargetNamedDataType.NamedDataTypeKind
        TYPEDEF: ghidra.dbg.target.TargetNamedDataType.NamedDataTypeKind
        UNION: ghidra.dbg.target.TargetNamedDataType.NamedDataTypeKind
