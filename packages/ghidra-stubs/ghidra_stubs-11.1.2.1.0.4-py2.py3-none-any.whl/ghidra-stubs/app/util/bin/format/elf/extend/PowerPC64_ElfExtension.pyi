...
class PowerPC64_ElfExtension(ghidra.app.util.bin.format.elf.extend.ElfExtension):
    DT_PPC64_GLINK: ghidra.app.util.bin.format.elf.ElfDynamicType
    DT_PPC64_OPD: ghidra.app.util.bin.format.elf.ElfDynamicType
    DT_PPC64_OPDSZ: ghidra.app.util.bin.format.elf.ElfDynamicType
    DT_PPC64_OPT: ghidra.app.util.bin.format.elf.ElfDynamicType
