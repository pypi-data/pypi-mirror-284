...
class MsProperty(ghidra.app.util.bin.format.pdb2.pdbreader.AbstractParsableItem):
    ...
    class Hfa(java.lang.Enum):
        DOUBLE: ghidra.app.util.bin.format.pdb2.pdbreader.type.MsProperty.Hfa
        FLOAT: ghidra.app.util.bin.format.pdb2.pdbreader.type.MsProperty.Hfa
        NONE: ghidra.app.util.bin.format.pdb2.pdbreader.type.MsProperty.Hfa
        RESV: ghidra.app.util.bin.format.pdb2.pdbreader.type.MsProperty.Hfa
        label: unicode
        value: int
    ...
    class Mocom(java.lang.Enum):
        INTERFACE: ghidra.app.util.bin.format.pdb2.pdbreader.type.MsProperty.Mocom
        NONE: ghidra.app.util.bin.format.pdb2.pdbreader.type.MsProperty.Mocom
        REF: ghidra.app.util.bin.format.pdb2.pdbreader.type.MsProperty.Mocom
        VALUE: ghidra.app.util.bin.format.pdb2.pdbreader.type.MsProperty.Mocom
        label: unicode
        value: int
