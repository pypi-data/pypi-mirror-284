...
class ClassFieldMsAttributes(ghidra.app.util.bin.format.pdb2.pdbreader.AbstractParsableItem):
    ...
    class Access(java.lang.Enum):
        ...
        PRIVATE: ghidra.app.util.bin.format.pdb2.pdbreader.type.ClassFieldMsAttributes.Access
        PROTECTED: ghidra.app.util.bin.format.pdb2.pdbreader.type.ClassFieldMsAttributes.Access
        PUBLIC: ghidra.app.util.bin.format.pdb2.pdbreader.type.ClassFieldMsAttributes.Access
        label: unicode
        value: int
    ...
    class Property(java.lang.Enum):
        ...
        FRIEND: ghidra.app.util.bin.format.pdb2.pdbreader.type.ClassFieldMsAttributes.Property
        INTRO: ghidra.app.util.bin.format.pdb2.pdbreader.type.ClassFieldMsAttributes.Property
        INTRO_PURE: ghidra.app.util.bin.format.pdb2.pdbreader.type.ClassFieldMsAttributes.Property
        INVALID: ghidra.app.util.bin.format.pdb2.pdbreader.type.ClassFieldMsAttributes.Property
        PURE: ghidra.app.util.bin.format.pdb2.pdbreader.type.ClassFieldMsAttributes.Property
        RESERVED: ghidra.app.util.bin.format.pdb2.pdbreader.type.ClassFieldMsAttributes.Property
        STATIC: ghidra.app.util.bin.format.pdb2.pdbreader.type.ClassFieldMsAttributes.Property
        VIRTUAL: ghidra.app.util.bin.format.pdb2.pdbreader.type.ClassFieldMsAttributes.Property
        label: unicode
        value: int
