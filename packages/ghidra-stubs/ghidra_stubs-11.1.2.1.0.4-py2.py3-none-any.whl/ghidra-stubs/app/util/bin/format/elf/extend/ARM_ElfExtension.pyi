...
class ARM_ElfExtension(ghidra.app.util.bin.format.elf.extend.ElfExtension):
    ...
    PT_ARM_EXIDX: ghidra.app.util.bin.format.elf.ElfProgramHeaderType
    SHT_ARM_ATTRIBUTES: ghidra.app.util.bin.format.elf.ElfSectionHeaderType
    SHT_ARM_DEBUGOVERLAY: ghidra.app.util.bin.format.elf.ElfSectionHeaderType
    SHT_ARM_EXIDX: ghidra.app.util.bin.format.elf.ElfSectionHeaderType
    SHT_ARM_OVERLAYSECTION: ghidra.app.util.bin.format.elf.ElfSectionHeaderType
    SHT_ARM_PREEMPTMAP: ghidra.app.util.bin.format.elf.ElfSectionHeaderType
