...
class DiscardedByLinkMsSymbol(ghidra.app.util.bin.format.pdb2.pdbreader.symbol.AbstractMsSymbol):
    ...
    class DiscardReason(java.lang.Enum):
        ...
        NOT_REFERENCED: ghidra.app.util.bin.format.pdb2.pdbreader.symbol.DiscardedByLinkMsSymbol.DiscardReason
        NOT_SELECTED: ghidra.app.util.bin.format.pdb2.pdbreader.symbol.DiscardedByLinkMsSymbol.DiscardReason
        UNKNOWN: ghidra.app.util.bin.format.pdb2.pdbreader.symbol.DiscardedByLinkMsSymbol.DiscardReason
        label: unicode
        value: int
