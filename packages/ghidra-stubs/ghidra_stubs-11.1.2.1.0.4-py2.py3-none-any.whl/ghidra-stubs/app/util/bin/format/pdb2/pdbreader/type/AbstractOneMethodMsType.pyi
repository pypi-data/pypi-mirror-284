...
class AbstractOneMethodMsType(ghidra.app.util.bin.format.pdb2.pdbreader.type.AbstractMsType, ghidra.app.util.bin.format.pdb2.pdbreader.type.MsTypeField):
    ...
    def getOffsetInVFTableIfIntroVirtual(self) -> long: ...
    ...
    @property
    def offsetInVFTableIfIntroVirtual(self) -> long: ...

    @property
    def procedureTypeRecordNumber(self) -> ghidra.app.util.bin.format.pdb2.pdbreader.RecordNumber: ...