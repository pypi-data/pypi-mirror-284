...
class SwiftUnsupportedNode(ghidra.app.util.demangler.swift.nodes.SwiftNode):




    def __init__(self, __a0: unicode, __a1: ghidra.app.util.demangler.swift.nodes.SwiftNode.NodeProperties): ...
