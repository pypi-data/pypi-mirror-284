...
class SwiftArray(ghidra.app.util.demangler.DemangledDataType):
    ...
    def getBoundType(self) -> ghidra.app.util.demangler.DemangledDataType: ...
    ...
    def setBoundType(self, __a0: ghidra.app.util.demangler.DemangledDataType) -> None: ...
    ...
    @property
    def boundType(self) -> ghidra.app.util.demangler.DemangledDataType: ...

    @boundType.setter
    def boundType(self, value: ghidra.app.util.demangler.DemangledDataType) -> None: ...