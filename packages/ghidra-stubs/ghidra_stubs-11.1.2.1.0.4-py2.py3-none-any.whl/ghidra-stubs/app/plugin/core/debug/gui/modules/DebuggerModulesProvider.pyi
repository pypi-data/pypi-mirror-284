...
class DebuggerModulesProvider(ghidra.framework.plugintool.ComponentProviderAdapter):
    ...
    def setFilterSectionsByModules(self, __a0: bool) -> None: ...
    ...
    def setShowSectionsTable(self, __a0: bool) -> None: ...
    ...
    @property
    def filterSectionsByModules(self) -> None: ...  # No getter available.

    @filterSectionsByModules.setter
    def filterSectionsByModules(self, value: bool) -> None: ...
    ...
    @property
    def showSectionsTable(self) -> None: ...  # No getter available.

    @showSectionsTable.setter
    def showSectionsTable(self, value: bool) -> None: ...