...
class DebuggerTraceTabPanel(docking.widgets.tab.GTabPanel, ghidra.framework.plugintool.util.PluginEventListener, ghidra.framework.model.DomainObjectListener):
    ...
    def addTab(self, __a0: object) -> None: ...

    def addTabs(self, __a0: List[object]) -> None: ...
    ...
    def getActionContext(self, __a0: java.awt.event.MouseEvent) -> ghidra.app.plugin.core.debug.gui.thread.DebuggerTraceFileActionContext: ...
    ...
    def getHiddenTabs(self) -> List[object]: ...
    ...
    def getHighlightedTabValue(self) -> object: ...
    ...
    def getSelectedTabValue(self) -> object: ...
    ...
    def getTab(self, __a0: object) -> javax.swing.JPanel: ...

    def getTabCount(self) -> int: ...

    def getTabValues(self) -> List[object]: ...
    ...
    def getValueFor(self, __a0: java.awt.event.MouseEvent) -> object: ...
    ...
    def getVisibleTabs(self) -> List[object]: ...
    ...
    def highlightNextPreviousTab(self, __a0: bool) -> None: ...

    def highlightTab(self, __a0: object) -> None: ...
    ...
    def isVisibleTab(self, __a0: object) -> bool: ...
    ...
    def refreshTab(self, __a0: object) -> None: ...
    ...
    def removeTab(self, __a0: object) -> None: ...

    def removeTabs(self, __a0: java.util.Collection) -> None: ...
    ...
    def selectTab(self, __a0: object) -> None: ...
    ...
    def setCloseTabConsumer(self, __a0: java.util.function.Consumer) -> None: ...
    ...
    def setIconFunction(self, __a0: java.util.function.Function) -> None: ...

    def setIgnoreFocus(self, __a0: bool) -> None: ...
    ...
    def setNameFunction(self, __a0: java.util.function.Function) -> None: ...
    ...
    def setSelectedTabConsumer(self, __a0: java.util.function.Consumer) -> None: ...

    def setShowTabsAlways(self, __a0: bool) -> None: ...
    ...
    def setToolTipFunction(self, __a0: java.util.function.Function) -> None: ...
    ...
    def showTabList(self, __a0: bool) -> None: ...
