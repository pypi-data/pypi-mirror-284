...
class AbstractObjectsTableBasedPanel(ghidra.app.plugin.core.debug.gui.model.ObjectsTablePanel, javax.swing.event.ListSelectionListener, ghidra.app.plugin.core.debug.gui.model.AbstractQueryTablePanel.CellActivationListener, ghidra.app.plugin.core.debug.gui.model.ObjectDefaultActionsMixin):
    ...
    def getSelected(self, __a0: ghidra.debug.api.model.DebuggerObjectActionContext) -> java.util.stream.Stream: ...
    ...
    def isContextNonEmpty(self, __a0: ghidra.debug.api.model.DebuggerObjectActionContext) -> bool: ...
