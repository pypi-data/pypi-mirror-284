...
class AssociationDatabaseManager(object, ghidra.feature.vt.api.main.VTAssociationManager):
    ...
    @staticmethod
    def getAssociationManager(__a0: db.DBHandle, __a1: ghidra.feature.vt.api.db.VTSessionDB, __a2: ghidra.framework.data.OpenMode, __a3: ghidra.util.task.TaskMonitor) -> ghidra.feature.vt.api.db.AssociationDatabaseManager: ...
