...
class VTOptions(ghidra.framework.options.ToolOptions):
    ...
    def getActionTrigger(self, __a0: unicode, __a1: ghidra.framework.options.ActionTrigger) -> ghidra.framework.options.ActionTrigger: ...
    ...
    def setActionTrigger(self, __a0: unicode, __a1: ghidra.framework.options.ActionTrigger) -> None: ...
