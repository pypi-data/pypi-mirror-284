...
class Realtor(GenericCRUD, metaclass=MetaLogger, object=logger_code_init):
    ...
    def insert_to_table(self, curr_location_listings: list[dict], location: str) -> None:
        ...
        try:
            ...
            if mysql.connector.errors.IntegrityError:
                self.logger.error("Duplicate key has detected", object={"exception": exception})
            else:
    ...
    def extract_data(self, link: str) -> dict:
        ...
        try:
            property_type_element = self.driver.find_element(By.CSS_SELECTOR, value=".propertyTypes .basicInfoValue")
        ...
        try:  # TODO: use selenium.By
            land_size_element = self.driver.find_element(By.CSS_SELECTOR, value=".landSize .basicInfoValue span")
        ...
        try:
            rooms_element = self.driver.find_element(By.CSS_SELECTOR, value = ".rooms .basicInfoValue")
