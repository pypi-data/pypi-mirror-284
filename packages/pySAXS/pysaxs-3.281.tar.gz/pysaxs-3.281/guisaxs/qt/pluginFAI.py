...
classlist=['pluginSurveyorXeuss','pluginSurveyorXeussKinetic','pluginTestFAI','pluginDrawMaskStart','pluginCalibStart','pluginPyFAIIntegrate']#,'pluginFAI',]
...
class pluginSurveyorXeussKinetic(plugin.pySAXSplugin):
    menu = "Data Treatment"
    subMenu = "Image"
    subMenuText = "SAXS Image Surveyor for kinetic"
    icon = "eye.png"
    toolbar = True
    ...
    def execute(self):
        ...
        parameterfile = self.parent.pref.get("parameterfile", 'pyFAI')
        # print "XEUSS"
        self.dlg = dlgSurveyor.SurveyorDialog(self.parent, parameterfile,automaticFit=True)
        self.dlg.show()