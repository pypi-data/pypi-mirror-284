...
def process_other_case(group):
    ...
    group["sar_death_education_amt"] = 0
    group["sar_death_retirement_amt"] = group["sar_death_amt"]
    group["sar_or_amt"] = sar_or_amt
    group["sar_adb_amt"] = sar_adb_other
    group["sar_adb_education_amt"] = 0
    group["sar_adb_retirement_amt"] = group["sar_death_amt"]
...
def process_sar_death_sar_adb_fund_value_av_fund_value(merged_df):
    ...
    if not df_education.empty:
        ...
        df_education["sar_death_education_amt"] = df_education["sar_death_amt"]
        df_education["sar_death_retirement_amt"] = 0
        df_education["sar_or_amt"] = df_education["sar_death_amt"]
        df_education["sar_adb_amt"] = _sar_adb_education(df_education)
        df_education["sar_adb_education_amt"] = df_education["sar_adb_amt"]
        df_education["sar_adb_retirement_amt"] = 0
