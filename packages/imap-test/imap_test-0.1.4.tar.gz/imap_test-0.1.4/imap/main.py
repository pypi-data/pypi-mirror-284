...
def convert_map_format(input_path, output_path, reverse=False, manual_speed_limit=-1):
...
def main(args=sys.argv):
    ...
    if args.format is not None:
        ...
        if not map_file.is_file():
            ...
            return
        convert_map_format(args.input, args.output, args.reverse, args.manual_speed_limit)
