...
from cadscript.interval import Interval2D, Interval3D
...
class DimensionsTest(unittest.TestCase):
    ...
    def test_2d_with_size(self):
        dimensions = [2.0, 3.0]
        center = False
        expected_result = Interval2D(0.0, 2.0, 0.0, 3.0)
        result = helpers.get_dimensions_2d(dimensions, center)
        self.assertEqual(result, expected_result)

    def test_2d_min_max(self):
        dimensions = [(1.0, 2.0), (3.5, 4.0)]
        center = False
        expected_result = Interval2D(1.0, 2.0, 3.5, 4.0)
        result = helpers.get_dimensions_2d(dimensions, center)
        self.assertEqual(result, expected_result)
    ...
    def test_2d_mixed(self):
        ...
        center = False
        expected_result = Interval2D(0.0, 2.0, 3.5, 4.0)
        result = helpers.get_dimensions_2d(dimensions, center)
        self.assertEqual(result, expected_result)
    ...
    def test_2d_mixed_centered(self):
        dimensions = [2.0, (-3.5, 4.0)]
        center = True
        expected_result = Interval2D(-1.0, 1.0, -3.5, 4.0)
        result = helpers.get_dimensions_2d(dimensions, center)
        self.assertEqual(result, expected_result)
    ...
    def test_2d_single_value(self):
        dimensions = [5.0, 10.0]
        center = True
        expected_result = Interval2D(-2.5, 2.5, -5.0, 5.0)
        result = helpers.get_dimensions_2d(dimensions, center)
        self.assertEqual(result, expected_result)
    ...
    def test_2d_flipped_size(self):
        dimensions = [(2, -2), (-3, -4)]
        center = True
        expected_result = Interval2D(-2, 2, -4, -3)
        result = helpers.get_dimensions_2d(dimensions, center)
        self.assertEqual(result, expected_result)
    ...
    def test_3d_with_size(self):
        ...
        center = False
        expected_result = Interval3D(0.0, 2.0, 0.0, 3.0, 0.0, 4.0)
        result = helpers.get_dimensions_3d(dimensions, center)
        self.assertEqual(result, expected_result)

    def test_3d_min_max(self):
        dimensions = [(1.0, 2.0), (3.5, 4.0), (10, 20)]
        center = False
        expected_result = Interval3D(1.0, 2.0, 3.5, 4.0, 10, 20)
        result = helpers.get_dimensions_3d(dimensions, center)
        self.assertEqual(result, expected_result)
    ...
    def test_3d_centered(self):
        dimensions = [2, 4, 6]
        center = True
        expected_result = Interval3D(-1, 1, -2, 2, -3, 3)
        result = helpers.get_dimensions_3d(dimensions, center)
        self.assertEqual(result, expected_result)
