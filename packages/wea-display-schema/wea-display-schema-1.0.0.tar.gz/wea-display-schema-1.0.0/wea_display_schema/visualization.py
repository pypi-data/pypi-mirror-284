...
class Legend3DParameters(NoExtraBaseModel):
    ...
    base_plane: Plane = Field(
        None,
        description='A wea Plane object to note the starting position from '
...
class LegendParameters(NoExtraBaseModel):
    ...
    colors: List[Color] = Field(
        None,
        min_items=2,
        description='An list of color objects. Default is the wea original colorset.'
    )
...
class VisualizationData(NoExtraBaseModel):
    ...
    data_type: Union[DataType, GenericDataType] = Field(
        None,
        description='Optional DataType from the wea datatype subpackage (ie. '
...
class AnalysisGeometry(_VisualizationBase):
    ...
    geometry: List[GEOMETRY_UNION] = Field(
        ...,
        description='A list of wea-geometry objects that is aligned with the '
...
class ContextGeometry(_VisualizationBase):
    ...
    geometry: List[DISPLAY_UNION] = Field(
        ...,
        description='A list of wea-geometry or wea-display objects that gives '
