...
class KeywordProcessor(object):
    ...
    def extract_keywords(self, sentence, span_info=False, max_cost=0):  # noqa: C901
    ...
    def replace_keywords(self, sentence, max_cost=0):  # noqa: C901
        """Searches in the string for all keywords present in corpus.
        ...
        while idx < sentence_len:
            ...
            if char not in self.non_word_boundaries:
                        ...
                        while idy < sentence_len:
                            ...
                            if inner_char in current_dict_continued:
                                ...
                                current_word_continued += (
                                    next_word  # just in case of a no match at the end
                                )
                                if not current_dict_continued:
                                    break
                            else:
                ...
                next_word = (
                    next_orig_word if self.case_sensitive else str.lower(next_orig_word)
                )
                current_dict, cost, _ = next(
                    self.levensthein(
                        next_word, max_cost=curr_cost, start_node=current_dict
