...
T = TypeVar("T", bound="ListResponseEventOut")


@attr.s(auto_attribs=True)
class ListResponseEventOut:
    """
    Attributes:
        data (List['EventOut']):
        done (bool):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        list_response_event_out.additional_properties = d
        return list_response_event_out
