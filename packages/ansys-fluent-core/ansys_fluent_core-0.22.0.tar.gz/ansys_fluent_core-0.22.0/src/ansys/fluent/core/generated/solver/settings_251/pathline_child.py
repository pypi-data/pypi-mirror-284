...
class pathline_child(Group):
    ...
    child_names = \
        ['name', 'uid', 'options', 'range', 'range_options',
         'style_attribute', 'accuracy_control', 'plot', 'step', 'skip',
         'coarsen', 'onzone', 'onphysics', 'field', 'release_from_surfaces',
         'velocity_domain', 'color_map', 'draw_mesh', 'mesh_object',
         'display_state_name', 'physics', 'geometry', 'surfaces', 'axes',
         'curves']
