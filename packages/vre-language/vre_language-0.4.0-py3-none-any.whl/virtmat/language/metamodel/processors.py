...
from virtmat.language.interpreter.instant_executor import add_io_processor
...
from .workflow import parallelizable_processor
from .view import view_processor
...
def add_mod_processors(metamodel, constr_processors=True, io_processors=True,
    ...
    if wflow_processors:
        ...
        add_io_processor(metamodel)
    metamodel.register_model_processor(view_processor)
