...
class Scene:
        ...
        for event in pygame.event.get():
            match event.type:
                ...
                case pygame.MOUSEMOTION:
                    ...
                    self.on_mouse_move(mousePosition)
    ...
    def _check_keys(self) -> None:
        ...
        pressed:list[int] = [key for key, is_pressed in enumerate(keys) if is_pressed]
    ...
    def _update(self) -> None:
        self.engine._screen.fill((0, 0, 0))
    ...
    def on_first(self) -> None:
        '''
        Code below should be executed when the scene is about to be rendered
    ...
    def on_mouse_move(self, mousePosition:IntVector2) -> None:
        '''
        ...
        class MyScene(wame.Scene):
            ...
            def on_mouse_move(self, mousePosition:wame.IntVector2) -> None:
                ... # Rotate character, etc.
        ```
        '''
