...
class Button:
    ...
    def render(self) -> None:
        ...
        Note
        ----
        This method should usually only need to be used in a method listening to the `scene.on_render()` event
        ...
        pygame.draw.rect(self._scene.engine._screen, self._currentColor.convert(), self._rect)
        self._text.render()
