#!/usr/bin/env python
# -*- coding: UTF-8 -*-
# code generated 2024-07-09 05:26:32.342413 by make_code.py script of synodal
# fmt: off
...
KNOWN_REPOS = REPOS_LIST = [Repository(nickname='atelier', package_name='atelier', git_repo='https://gitlab.com/lino-framework/atelier.git', settings_module='', front_end='', extra_deps=[], public_url='https://atelier.lino-framework.org', verbose_name=None, description=None),
 ...
 Repository(nickname='mentori', package_name='lino-mentori', git_repo='https://gitlab.com/lino-framework/mentori.git', settings_module='lino_mentori.lib.mentori.settings', front_end='', extra_deps=['lino', 'xl'], public_url='', verbose_name='Lino Mentori', description=None),
 Repository(nickname='noi', package_name='lino-noi', git_repo='https://gitlab.com/lino-framework/noi.git', settings_module='lino_noi.lib.noi.settings', front_end='', extra_deps=['lino', 'xl'], public_url='', verbose_name='Lino Noi', description='Manage support tickets and working time.'),
