...
mcmctree_out_to_tree_usage = '''
================ mcmctree_out_to_tree example commands ================

TreeSAK mcmctree_out_to_tree_parser -i mcmctree.out -o renamed.tree

=======================================================================
'''


def mcmctree_out_to_tree(args):
...
if __name__ == '__main__':
    ...
    mcmctree_out_to_tree_parser = argparse.ArgumentParser()
    mcmctree_out_to_tree_parser.add_argument('-i',  required=True,  help='the .out file from mcmctree')
    mcmctree_out_to_tree_parser.add_argument('-o',  required=True,  help='output tree file')
    args = vars(mcmctree_out_to_tree_parser.parse_args())
    mcmctree_out_to_tree(args)
