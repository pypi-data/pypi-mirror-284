...
class EventObject:
    ...
    def __init__(self, **eventParameters: Dict[str, Any]) -> None:
        """
...
class UserObject:
    ...
    def __init__(self, **userParameters: Dict[str, Any]) -> None:
        """
...
class CustomObject:
    ...
    def __init__(self, **customParameters: Dict[str, Any]) -> None:
        """
