...
class CalculateInjectivityIndex(UnitModuleAbstract):
    ...
    def __init__(self, unit):
        ...
        self.link_output('calculated', 'injectivity_index')

    def step(self, loop):
        self.loop = loop
        self.loop.start_time = self.get_output_last_data_time('injectivity_index')
        ...
        if injectivity_index:
            self.write_output_data('injectivity_index', time, injectivity_index)
