...
class Route:
    ...
    def load_at(self, idx: int) -> LoadSegment: ...
    def load_between(self, start: int, end: int) -> LoadSegment: ...
    def load_before(self, end: int) -> LoadSegment: ...
    def load_after(self, start: int) -> LoadSegment: ...
