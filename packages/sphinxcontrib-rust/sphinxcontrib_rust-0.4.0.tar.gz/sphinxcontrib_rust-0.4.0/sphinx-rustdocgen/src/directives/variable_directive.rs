...
macro_rules! var_from_item {
    ($item:expr, $parent_path:expr, $vis:expr, $inherited:expr, $prefix:expr) => {{
...
impl VariableDirective {
    ...
    pub(crate) fn from_static(
        ...
        let mut directive =
            var_from_item!(item, parent_path, item.vis, inherited_visibility, "static");
        directive
            .options
    ...
    pub(crate) fn from_const(
        ...
        let mut directive =
            var_from_item!(item, parent_path, item.vis, inherited_visibility, "const");
        directive
            .options
            .push(DirectiveOption::Index(IndexEntryType::Normal));
        Directive::Variable(directive)
