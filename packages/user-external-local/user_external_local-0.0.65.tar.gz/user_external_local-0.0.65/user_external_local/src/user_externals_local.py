...
class UserExternalsLocal(GenericCRUD, metaclass = MetaLogger, object=object_init):
    def __init__(self, is_test_data: bool = False):
        ...
        self.logger = Logger.create_logger(object=object_init)
    ...
    def insert_or_update_user_external_access_token(self, *, system_id: int, username: str, access_token: str, profile_id: int,
        ...
        self.logger.info("external user inserted", object=object_info)
    ...
    def update_user_external_access_token(self, *, system_id: int, username: str, profile_id: int, access_token, expiry=None,
        ...
        self.logger.info("external user updated", object=object_info)
    ...
    def get_auth_details(self, *, system_id: int, username: str, profile_id: int) -> None:
        ...
        if auth_details_list:
            ...
            self.logger.error(log_message="user external not found", object={"auth_details_list": auth_details_list})
