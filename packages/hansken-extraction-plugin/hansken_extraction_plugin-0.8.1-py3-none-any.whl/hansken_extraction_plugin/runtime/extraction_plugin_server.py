...
class ProcessHandler:
    ...
    def writer(self, trace_id: str, data_type: str) -> BufferedWriter:
        """
        Return a BufferedWriter that can be used to stream data to a trace.
...
class ExtractionPluginServicer(ExtractionPluginServiceServicer):
    ...
    def process(self, response_iterator: Iterator[GrpcAny], context: grpc.RpcContext) -> Iterator[GrpcAny]:
        ...
        try:
            ...
            self._process(response_iterator, grpc_handler)
    ...
    def _process(self, response_iterator, grpc_handler):
