...
class NewTask(BaseTask):
    ...
    def _create_project_structure(self):
        ...
        files = {
            ...
            # TODO: 置くデータと場所がきまるまでコメントアウト
            # f"{self.project_directory}/sample.csv": self._generate_initial_csv(),
        }
    ...
    # TODO: 置くデータと場所がきまるまでコメントアウト
    # @staticmethod
    # def _generate_initial_csv():
    #     template_path = os.path.join(
    #         os.path.dirname(__file__), f"template/seed/sample.csv"
    #     )
    #     with open(template_path, "r") as file:
    #         return file.read()
...
TZ=Asia/Tokyo"""
    ...
    def _save_morph_yaml_template(self):
        morph_yaml = MorphYaml(
            ...
            resources={
                "example_python_cell": {
                    "path": OsUtils.normalize_path(
                        "src/example_python_cell.py",
                        self.project_directory,
                    ),
                    "output_paths": [
                        OsUtils.normalize_path(
