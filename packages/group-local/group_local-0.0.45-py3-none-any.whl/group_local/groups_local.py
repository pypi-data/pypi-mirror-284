...
from database_mysql_local.generic_merge_entities import MergeEntities
...
class GroupsLocal(GenericCRUDML, metaclass=MetaLogger,
    ...
    def merge_entities(self, entity_id1 : int, entity_id2 : int, main_entity_ml_id: int):
        merge_instance = MergeEntities(default_schema =DEFAULT_SCHEMA_NAME,default_ml_table_name ='group_ml_table')
        MergeEntities.merge_entities(merge_instance, schema_name=DEFAULT_SCHEMA_NAME,table_name='group_table', entity_id1=entity_id1, entity_id2=entity_id2, main_entity_ml_id=main_entity_ml_id)
