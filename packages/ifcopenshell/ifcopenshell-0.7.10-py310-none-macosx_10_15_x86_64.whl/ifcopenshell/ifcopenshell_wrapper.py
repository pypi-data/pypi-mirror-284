...
class piecewise_function(implicit_item):
    ...
    def __init__(self, *args):
        r"""
        __init__(piecewise_function self, ifcopenshell::geometry::taxonomy::piecewise_function::spans const & s, Settings settings=None, IfcBaseInterface instance=None) -> piecewise_function
        __init__(piecewise_function self, std::vector< ifcopenshell::geometry::taxonomy::piecewise_function::ptr,std::allocator< ifcopenshell::geometry::taxonomy::piecewise_function::ptr > > const & pwfs, Settings settings=None, IfcBaseInterface instance=None) -> piecewise_function
...
class entity_instance(IfcBaseInterface):
    ...
    def unset_value(self, index):
        r"""unset_value(entity_instance self, int index)"""
