...
class piecewise_function(implicit_item):
    ...
    def __init__(self, *args):
        """
        __init__(ifcopenshell::geometry::taxonomy::piecewise_function self, ifcopenshell::geometry::taxonomy::piecewise_function::spans const & s, Settings settings=None, IfcBaseInterface instance=None) -> piecewise_function
        __init__(ifcopenshell::geometry::taxonomy::piecewise_function self, ifcopenshell::geometry::taxonomy::piecewise_function::spans const & s, Settings settings=None) -> piecewise_function
        __init__(ifcopenshell::geometry::taxonomy::piecewise_function self, ifcopenshell::geometry::taxonomy::piecewise_function::spans const & s) -> piecewise_function
        __init__(ifcopenshell::geometry::taxonomy::piecewise_function self, std::vector< ifcopenshell::geometry::taxonomy::piecewise_function::ptr,std::allocator< ifcopenshell::geometry::taxonomy::piecewise_function::ptr > > const & pwfs, Settings settings=None, IfcBaseInterface instance=None) -> piecewise_function
        __init__(ifcopenshell::geometry::taxonomy::piecewise_function self, std::vector< ifcopenshell::geometry::taxonomy::piecewise_function::ptr,std::allocator< ifcopenshell::geometry::taxonomy::piecewise_function::ptr > > const & pwfs, Settings settings=None) -> piecewise_function
        __init__(ifcopenshell::geometry::taxonomy::piecewise_function self, std::vector< ifcopenshell::geometry::taxonomy::piecewise_function::ptr,std::allocator< ifcopenshell::geometry::taxonomy::piecewise_function::ptr > > const & pwfs) -> piecewise_function
    ...
    def evaluate2(self, *args):
        """
        evaluate2(piecewise_function self) -> std::pair< ifcopenshell::geometry::taxonomy::item::ptr,std::vector< double,std::allocator< double > > >
        evaluate2(piecewise_function self, double ustart, double uend, unsigned int nsteps) -> std::pair< ifcopenshell::geometry::taxonomy::item::ptr,std::vector< double,std::allocator< double > > >
        """
        return _ifcopenshell_wrapper.piecewise_function_evaluate2(self, *args)
...
class entity_instance(IfcBaseInterface):
    ...
    def data(self, *args):
        ...
        data(entity_instance self) -> IfcEntityInstanceData
        data(entity_instance self, IfcEntityInstanceData data)
        """
    ...
    def unset_value(self, index):
        """unset_value(entity_instance self, int index)"""
        return _ifcopenshell_wrapper.entity_instance_unset_value(self, index)
