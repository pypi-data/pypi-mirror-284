            ...
            if words[0] == 'tcp':
                ...
                try:
                    ...
                    for i in range(1, len(words)):
                        if ( words[i] in ['http', 'https', 'ws', 'wss']) and i < len(words)-1:
                    ...
                    if len(words) == 1:
                        ...
                        if words[1].isnumeric():
                            ...
                            self.coms.connect(words[1], 8765,requestProtocol)
                    ...
                    ws_help+= "\t[ws:host] to connect to a server at the default port\n"
                    ws_help+= "\t[ws:host:port] to connect to a server at a specific port\n"
                    self.print( ws_help)
