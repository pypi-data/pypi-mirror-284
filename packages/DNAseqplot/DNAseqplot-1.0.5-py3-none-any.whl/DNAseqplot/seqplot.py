...
def DNAseqplot(inputpath,input,outpath,outfile):
    os.chdir(inputpath)
...
def main():
    ...
    parser.add_argument("-V", "--version", action="version",version="DNAseqplot {}".format(__version__)\
                      ,help="Print version and exit")
    args = parser.parse_args()
    print('###Parameters:')
    print(args)
    print('###Parameters')
    DNAseqplot(args.inputpath,args.filename,args.outpath,args.outfile,args.version)
