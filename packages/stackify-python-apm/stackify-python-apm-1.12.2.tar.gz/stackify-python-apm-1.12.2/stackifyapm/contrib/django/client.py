...
class DjangoClient(Client):
    ...
    def __init__(self, config=None, **inline):
        ...
        config["RUMV2_ENABLED"] = getattr(django_settings, "RUMV2_ENABLED", constants.DEFAULT_RUM_ENABLED)
        config["RUM_SCRIPT_URL"] = getattr(django_settings, "RUM_SCRIPT_URL", constants.DEFAULT_RUM_SCRIPT_URL)
        config["RUM_KEY"] = getattr(django_settings, "RUM_KEY", constants.DEFAULT_RUM_KEY)
