...
class TestModelsQuantizedResnet1D(TestCase):
    def setUp(self):
        ...
        self.__data = RawDataModel(RawDataSets(train=train, test=test), name='test_quantizedresnet1d')
        self.__model_params = {
            'filters': (4, 6),
            'kernel_sizes': (5, 5),
    ...
    def test_quantized_resnet_1d_pytorch(self):
        ...
        self.assertEqual(type(trainresult.model.layers[0][0].smax), QuantizedMaxPool1d)
