...
def scatterplots( directory, output_directory, features_df, std_of_features_df):
    ...
    gu.plot_scatterplot_of_two_features( feature_1, feature_2, features_df.index, [resin_data.loc[i]["Label"] for i in features_df.index], xlabel = "Normalised SHM", ylabel = "Normalised ESCR 50% Failure", savefig = False, filename = output_directory + "Global/Scatterplots/New_Figure.pdf" )
