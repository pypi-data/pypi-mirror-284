...
class SparkProxyClient(object):
    ...
    def list_traffic_usages(self, username, start_time, end_time):
        """获取流量使用记录
        ...
        Returns:
            ...
            - ResponseInfo    请求的Response信息
        """
        ret, info = self.__post('ListTrafficUsage', {"reqUserId": username, "startTime": start_time, "endTime": end_time})
        return ret, info
