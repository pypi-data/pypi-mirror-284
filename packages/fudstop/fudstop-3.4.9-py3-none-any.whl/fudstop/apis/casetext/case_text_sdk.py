...
class CasetextSDK:
    ...
    async def parallell_search_cases(self,query, db=None):

        """Casetext"""

        endpoint = f"https://parallelsearch.casetext.com/__search/unified?q={query}&page=1&sort=relevance&type=case"
    ...
    async def parallell_search_briefs(self,query, db=None):



        endpoint = f"https://parallelsearch.casetext.com/__search/unified?q={query}&page=1&sort=relevance&type=brief"
    ...
    async def parallell_search_rules(self, query, db=None):


        endpoint = f"https://parallelsearch.casetext.com/__search/unified?q={query}&page=1&sort=relevance&type=rule"
    ...
    async def parallell_search_statutes(self, query, db=None):
        

        endpoint = f"https://parallelsearch.casetext.com/__search/unified?q={query}&page=1&sort=relevance&type=statute"
