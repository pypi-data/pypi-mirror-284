...
class WebullOptionScreener:
    ...
    async def get_token(self, type:str='2'):
        endpoint = f"https://u1suser.webullfintech.com/api/user/v1/login/account/v2"

        
        async with httpx.AsyncClient(headers=self.headers) as client:
            data = await client.post(endpoint, json={"account":"CHUCKDUSTIN12@GMAIL.COM","accountType":type,"pwd":"fb050b003c6d84da626a4f53f8a1b400","deviceId":"gldaboazf4y28thligawz4a7xamqu91g","deviceName":"Windows Chrome","grade":1,"regionId":1})
        data = data.json()
