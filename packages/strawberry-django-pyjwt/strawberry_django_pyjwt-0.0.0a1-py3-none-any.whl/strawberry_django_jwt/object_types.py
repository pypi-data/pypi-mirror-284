...
@strawberry.type(name="JWTDeletePayload")
class DeleteType:
    deleted: bool


@strawberry.type(name="JWTTokenPayload")
@inject_fields(
    {
...
@strawberry.type(name="JWTTokenReturnPayload")
class PayloadType:
    payload: TokenPayloadType


@strawberry.type(name="JWTTokenDataPayload")
class TokenDataType:
    payload: TokenPayloadType
    token: str = ""
