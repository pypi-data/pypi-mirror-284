...
class DatasetSelector(MyViewer):
    ...
    backup_on_load =  param.Boolean(False, doc='show all components / sequences')
    
    def __init__(self, dataset, cfg_path, **param):
        ...
        self._layout = pn.Column(self.wselect, 
                                 ...
                                 pn.Row(self.param.save_auto, self.param.backup_on_load)
                                 )
