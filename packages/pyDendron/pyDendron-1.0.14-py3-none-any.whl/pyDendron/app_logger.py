...
def catch_bokeh_log(cb_connection, cb_disconnection):
    """
    ...
    class BohehFilter(logging.Filter):
        def __init__(self, cb_connection, cb_disconnection):
    ...
    logger_bokeh.addFilter(BohehFilter(cb_connection, cb_disconnection))
