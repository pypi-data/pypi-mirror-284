...
class DatasetPackageBuilder(Viewer):
    ...
    def __init__(self, dataset, parameters, treeview, **params):
        ...
        self.wcolumn = pn.widgets.AutocompleteInput(name='Column', min_characters=0, options=list(sequences_dtype_dict.keys()), placeholder='Select a column', width=bt_size*2)
        ...
        self._layout = pn.Column(
                        ...
                        pn.Row(self.bt_select, 
                               ...
                               pn.pane.HTML('<b>Option:</b>', align=('start', 'center')),self.add_parent),
