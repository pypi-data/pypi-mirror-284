...
class DatasetPackageEditor(Viewer):
    ...
    def __init__(self, dataset, parameters, **params):
        ...
        self.bt_stats = pn.widgets.Button(name='Add', icon='column-insert-left', button_type='primary', align=('start', 'end'))
        ...
        self.bt_add = pn.widgets.Button(name='Add', icon='cube-plus', button_type='primary', align=('start', 'end'))
        self.bt_add.on_click(self.on_add)

        self.package_merge =  pn.widgets.Select(name='Package to merge:', options=[])
