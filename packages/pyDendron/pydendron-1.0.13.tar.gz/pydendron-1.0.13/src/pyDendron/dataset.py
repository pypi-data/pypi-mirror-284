...
class Dataset(param.Parameterized):
    ...
    def update_version(self, version):
        ...
        # if version <= 3:
        #     self.new_workshop()
        #     self.sequences[PITH_ABSENT] = pd.NA
        #     self.sequences[TAG] = pd.NA
        # if version <= 4:
        #     self.new_trash()
    ...
    def append(self, dataset, verify_integrity=True, notify=True):
        """
    ...
    def set_dates(self, idx, date_begin, data_length=None, sequences=None, warning=True):
        ...
        if pd.notna(date_begin):
            ...
            sequences.at[idx, DATE_END] = date_begin + data_length
