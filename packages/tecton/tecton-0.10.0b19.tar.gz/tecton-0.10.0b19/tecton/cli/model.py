...
@click.option(
    ...
    "--archive-root-dir",
    default=None,
    help="Root path to use for storing custom model files.",
    type=click.Path(exists=True),
)
def create(model_config_file, archive_root_dir):
    """Create a custom model"""
    _create(model_config_file, archive_root_dir)
...
def _create(model_config_file: str, archive_root_dir: Optional[str]):
    """Create a custom model"""
    print(type(model_config_file))
    print(type(archive_root_dir))
