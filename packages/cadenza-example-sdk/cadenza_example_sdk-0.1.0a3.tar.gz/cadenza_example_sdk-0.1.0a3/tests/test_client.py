...
from cadenza_example_sdk import Cadenza, AsyncCadenza, APIResponseValidationError
from cadenza_example_sdk._models import BaseModel, FinalRequestOptions
from cadenza_example_sdk._constants import RAW_RESPONSE_HEADER
from cadenza_example_sdk._exceptions import CadenzaError, APIStatusError, APITimeoutError, APIResponseValidationError
from cadenza_example_sdk._base_client import (
    DEFAULT_TIMEOUT,
...
class TestCadenza:
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "cadenza_example_sdk/_legacy_response.py",
                        "cadenza_example_sdk/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "cadenza_example_sdk/_compat.py",
    ...
    @mock.patch("cadenza_example_sdk._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
