...
TKS_MARKET_DATA_SERVICE_API_WS = os.getenv("TKS_MARKET_DATA_SERVICE_API_WS", "ws://localhost:8400")
TKS_MARKET_DATA_SERVICE_API_HTTP = os.getenv("TKS_MARKET_DATA_SERVICE_API_WS", "http://localhost:8400/")
...
class MarketMgr:
    ...
    async def get_real_time_data(self, markets, callback, max_retries=6, short_interval=10, long_interval=600):
        ...
        uri = f"{TKS_MARKET_DATA_SERVICE_API_WS}/stream/price"
        retry_count = 0
    ...
    async def get_last_price(self, market, exchange=None):
        ...
        url = f"{TKS_MARKET_DATA_SERVICE_API_HTTP}price/{market.upper()}"
        if exchange:
    ...
    async def get_meta_market_indicator_data(self, callback):
        url = f"{TKS_MARKET_DATA_SERVICE_API_WS}/tv/meta_market_indicator"
        try:
