...
class UnplannedItems(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["order_keys", "order_keys_count", "performer_keys", "performer_keys_count", "transport_keys", "transport_keys_count", "hardlink_keys", "hardlink_keys_count", "fact_keys", "fact_keys_count"]
