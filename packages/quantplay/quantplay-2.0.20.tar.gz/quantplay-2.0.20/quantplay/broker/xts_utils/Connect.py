...
class XTSConnect(XTSCommon):
    ...
    def _get(self, route: str, params=None):
        """Alias for sending a GET request."""
        return self._request(route, "GET", params)

    def _post(self, route: str, params=None):
        """Alias for sending a POST request."""
        return self._request(route, "POST", params)

    def _put(self, route: str, params=None):
        """Alias for sending a PUT request."""
        return self._request(route, "PUT", params)

    def _delete(self, route: str, params=None):
        """Alias for sending a DELETE request."""
        return self._request(route, "DELETE", params)

    def _request(
        self, route: str, method: Literal["GET", "POST", "PUT", "DELETE"], parameters=None
    ):
