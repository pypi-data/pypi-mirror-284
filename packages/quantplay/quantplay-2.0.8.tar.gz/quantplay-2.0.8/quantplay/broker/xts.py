...
from quantplay.model.broker.generics import (
    ExchangeType,
    ModifyOrderRequest,
    TransactionType,
...
from quantplay.model.broker.generics import OrderType as NewOrderType
...
class XTS(Broker):
    ...
    def get_order_type(self, order_type: NewOrderType) -> str:
    ...
    def modify_order(self, order_to_modify: ModifyOrderRequest) -> str:
        order_id = order_to_modify.get("order_id", None)
        price = order_to_modify.get("price", None)
        trigger_price = order_to_modify.get("trigger_price", None)
        order_type = order_to_modify.get("order_type", None)
        tag = order_to_modify.get("tag", None)
        product = order_to_modify.get("product", None)
