...
from ..compiler.select_compiler import SelectCompiler
from ..compiler.types_compiler import TypesCompiler
from ..header.csv_header_parser import HeaderParser
from ..header.header_lexer import HeaderLexer
from ..header.header_merger import HeaderMerger
from ..header.odoo_header_parser import OdooHeaderParser

_logger = logging.getLogger(__name__)


# Uses header lexer, parser and matcher to create a mapping object.
# With that mapping object, it constructs:
# - select query: select columns from table (join table)*
# - insert query: insert into table (column names) values (values where select ...)
# - update query: update table set (column = value)+
# - delete query: delete from table where ....
