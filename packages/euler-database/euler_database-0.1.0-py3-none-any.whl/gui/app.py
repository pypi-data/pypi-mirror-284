...
class KnowledgeGraphApp:
    def __init__(self, root):
        ...
        self.euler_logo = tk.PhotoImage(file="C:\\Users\\DS203\\Desktop\\euler_graph_database\\icons\\logo.png").subsample(5, 5)
      
        self.header_frame = ctk.CTkFrame(root)
        self.header_frame.pack(side=ctk.TOP, fill=ctk.X)

        self.logo_label = ctk.CTkLabel(self.header_frame, image=self.euler_logo, text='')
