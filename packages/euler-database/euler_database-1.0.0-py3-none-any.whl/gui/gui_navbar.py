...
class Navbar:
    ...
    def create_icons(self):
        ...
        self.open_icon = tk.PhotoImage(file=os.path.join(icon_dir, 'open.png')).subsample(2, 2)
        self.save_icon = tk.PhotoImage(file=os.path.join(icon_dir, 'save.png')).subsample(2, 2)
        self.save_query_icon = tk.PhotoImage(file=os.path.join(icon_dir, 'save_query.png')).subsample(2, 2)
        self.visual_icon = tk.PhotoImage(file=os.path.join(icon_dir, 'visual.png')).subsample(2, 2)
        self.exit_icon = tk.PhotoImage(file=os.path.join(icon_dir, 'exit.png')).subsample(2, 2)
