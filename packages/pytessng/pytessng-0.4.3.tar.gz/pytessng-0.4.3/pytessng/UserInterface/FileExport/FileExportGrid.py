...
class FileExportGrid(BaseUserInterface):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # FIXME 未能解决通过再次点击菜单栏关闭界面的问题，只能手动点击关闭窗口
    ...
    def set_button_connect(self):
        ...
        # 把其他关联上
        custom_actions = [GlobalVar.action_network_edit_split, GlobalVar.action_network_edit_remove, GlobalVar.action_network_edit_reverse]
