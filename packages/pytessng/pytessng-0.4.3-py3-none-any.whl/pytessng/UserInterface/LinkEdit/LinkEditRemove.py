...
class LinkEditRemove(BaseClass):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # 按钮
        self.action = GlobalVar.action_network_edit_remove
        ...
        # 把其他关联上
        custom_actions = [GlobalVar.action_network_edit_split, GlobalVar.action_network_edit_reverse, GlobalVar.action_file_export_grid]
    ...
    def load(self):
        ...
        if self.action.isChecked():
            ...
            GlobalVar.is_need_select_network_edit_remove = True
            # 回调函数
            GlobalVar.function_network_edit_remove = self.apply_remove_link
        # 关闭
        else:
            self.action.setChecked(False)
            GlobalVar.is_need_select_network_edit_remove = False
    ...
    def apply_remove_link(self, event, mode: int = 1):
        # 按下左键
