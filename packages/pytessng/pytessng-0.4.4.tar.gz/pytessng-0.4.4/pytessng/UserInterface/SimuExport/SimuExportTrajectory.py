...
class SimuExportTrajectory(BaseUserInterface):
    ...
    def apply_button_action(self):
        ...
        # 配置全局变量
        GlobalVar.simu_export_traj_proj_string = traj_proj_string
        GlobalVar.simu_export_traj_config_json = traj_json_config
        GlobalVar.simu_export_traj_config_kafka = traj_kafka_config
