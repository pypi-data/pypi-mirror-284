...
# For some reason it says that MNE, and GUY is not part of the list. FIX
...
class ReadPdf:
    ...
    def run():
        try:
            ReadPdf.updating_date()
            print("An error occured: {e}", e)
    
            # Setting up the reader
            reader = ReadPdf.set_up_reader()
