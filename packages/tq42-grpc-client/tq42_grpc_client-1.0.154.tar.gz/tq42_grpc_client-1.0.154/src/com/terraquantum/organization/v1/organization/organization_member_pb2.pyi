...
class OrganizationMemberProto(_message.Message):
    __slots__ = ("id", "organization_id", "user_id", "status", "permissions", "organization_owner", "email", "first_name", "last_name")
    ...
    permissions: _organization_member_permission_pb2.OrganizationMemberPermissionProto
    organization_owner: bool
    email: str
    first_name: str
    last_name: str
    def __init__(self, id: _Optional[str] = ..., organization_id: _Optional[str] = ..., user_id: _Optional[str] = ..., status: _Optional[_Union[_organization_member_status_pb2.OrganizationMemberStatusProto, str]] = ..., permissions: _Optional[_Union[_organization_member_permission_pb2.OrganizationMemberPermissionProto, _Mapping]] = ..., organization_owner: bool = ..., email: _Optional[str] = ..., first_name: _Optional[str] = ..., last_name: _Optional[str] = ...) -> None: ...
