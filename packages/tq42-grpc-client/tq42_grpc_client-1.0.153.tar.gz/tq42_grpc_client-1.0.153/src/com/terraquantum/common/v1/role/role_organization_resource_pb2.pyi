...
class OrganizationResourceRoleTypeProto(_message.Message):
    __slots__ = ("organization_resource_role_id", "role_type")
    ...
    def __init__(self, organization_resource_role_id: _Optional[str] = ..., role_type: _Optional[_Union[_role_type_pb2.RoleTypeProto, str]] = ...) -> None: ...
