...
# vision_ip : str = "192.168.10.148"
# vision_port : int = 2006

vision_ip : str = "192.168.100.102"
vision_port : int = 2006
...
def Trigger():
    ...
    try:
        ...
        result = Trigger_func(socketfunc)
        socketfunc.is_close()
