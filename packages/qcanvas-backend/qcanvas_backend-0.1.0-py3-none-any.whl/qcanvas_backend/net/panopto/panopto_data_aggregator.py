...
from qcanvas_api_clients.panopto import PanoptoClient, FolderInfo

import qcanvas_backend.gql_queries as gql
from qcanvas_backend.net.panopto.folder_with_sessions import FolderWithSessions
    ...
    async def get_course_panopto_folders(
        ...
        for folder in folders:
            try:
                ...
                _logger.info('No close match for folder "%s", ignoring', folder.name)
                continue
            except ValueError:
