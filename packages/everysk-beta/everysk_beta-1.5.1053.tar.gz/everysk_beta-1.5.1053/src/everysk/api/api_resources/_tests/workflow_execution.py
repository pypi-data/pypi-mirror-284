...
class APIWorkflowExecutionTestCase(TestCase):
    ...
    @patch('everysk.api.api_resources.worker_execution.WorkerExecution.retrieve')
    @patch('everysk.api.api_resources.workflow_execution.WorkflowExecution.retrieve')
    @patch('everysk.api.utils.sleep', return_value=None)
