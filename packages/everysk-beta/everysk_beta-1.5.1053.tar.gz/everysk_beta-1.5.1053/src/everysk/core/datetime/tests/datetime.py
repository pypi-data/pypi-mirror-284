...
class DateTimeTestCase(TestCase):
    ...
    def test_string_date_to_datetime_with_now(self):
        date_string = '20230815 ' + datetime.utcnow().strftime('%H:%M:%S')
        expected_result = DateTime.strptime(date_string, '%Y%m%d %H:%M:%S')
        result = DateTime(2023, 8, 15).force_time('NOW')
        self.assertEqual(result.__class__, DateTime)
    ...
    def test_string_date_to_datetime_with_last_minute(self):
        ...
        self.assertEqual(result.__class__, DateTime)
        self.assertEqual(result, DateTime(2023, 8, 15, 23, 59, 59))
    ...
    def test_datetime_to_datetime_custom_time(self):
        ...
        self.assertEqual(result.__class__, DateTime)
        self.assertEqual(result, DateTime(2023, 1, 1, 23, 59, 59))
