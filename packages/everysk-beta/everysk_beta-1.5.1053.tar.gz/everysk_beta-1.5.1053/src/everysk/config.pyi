...
class Settings:
    ...
    EVERYSK_SDK_ENGINES_MODULES_PATH: dict
    EVERYSK_SDK_ENTITIES_MODULES_PATH: dict
    EVERYSK_SDK_HTTP_DEFAULT_TIMEOUT: int
    EVERYSK_SDK_MODULES_PATH: dict
    ...
    WORKER_TEMPLATE_BARRIER_TYPE: str
    WORKER_TEMPLATE_BASIC_TYPE: str
    WORKER_TEMPLATE_CATCH_TYPE: str
    WORKER_TEMPLATE_CATEGORIES: list
    WORKER_TEMPLATE_CONDITIONAL_TYPE: str
    WORKER_TEMPLATE_DEFAULT_SCRIPT_RUNTIME: str
    WORKER_TEMPLATE_DEFAULT_TYPE: str
    WORKER_TEMPLATE_ENDER_TYPE: str
    WORKER_TEMPLATE_FORKER_TYPE: str
    WORKER_TEMPLATE_ICONS: list
    WORKER_TEMPLATE_ID_PREFIX: str
    WORKER_TEMPLATE_SCRIPT_INPUTS_MAX_SIZE: int
    WORKER_TEMPLATE_SCRIPT_OUTPUTS_MAX_SIZE: int
    WORKER_TEMPLATE_SCRIPT_RUNTIMES: list
    WORKER_TEMPLATE_SCRIPT_SOURCE_MAX_SIZE: int
    WORKER_TEMPLATE_SCRIPT_SOURCE_MIN_SIZE: int
    WORKER_TEMPLATE_STARTER_TYPE: str
    WORKER_TEMPLATE_TRY_TYPE: str
