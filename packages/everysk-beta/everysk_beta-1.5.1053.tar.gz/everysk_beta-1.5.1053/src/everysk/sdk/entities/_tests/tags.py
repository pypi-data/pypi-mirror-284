...
class TagsTestCase(TestCase):
    ...
    def test_append_empty_tag(self):
        empty_tag = ''
        tags = Tags()
        with self.assertRaises(FieldValueError, msg="Tags: The value cannot be empty"):
    ...
    def test_append_short_tag(self):
        short_tag = ''
        tags = Tags()
        with self.assertRaises(FieldValueError, msg=f"Tags: '{short_tag}' size it's not between {tags.min_size} and {settings.ENTITY_MAX_TAG_LENGTH}"):
