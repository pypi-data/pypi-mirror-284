...
from everysk.core.datetime import DateTime, timezone, Date
...
class TestBaseEntity(TestCase):
    ...
    def test_load(self):
        expected_data = '{"class_name": "Query", "method_name": "load", "self_obj": {"_klass": "Portfolio", "filters": [["workspace", "=", "my_workspace"]], "order": [], "projection": null, "distinct_on": [], "limit": null, "offset": null, "page_size": null, "page_token": null, "_clean_order": [], "__class_path__": "everysk.sdk.entities.query.Query"}, "params": {"offset": 5}}'
    ...
    def test_list(self):
        expected_data = '{"class_name": "Query", "method_name": "loads", "self_obj": {"_klass": "Portfolio", "filters": [["workspace", "=", "my_workspace"]], "order": [], "projection": null, "distinct_on": [], "limit": null, "offset": null, "page_size": null, "page_token": null, "_clean_order": [], "__class_path__": "everysk.sdk.entities.query.Query"}, "params": {"limit": 10, "offset": 5}}'
    ...
    def test_page(self):
        ...
        expected_data = '{"class_name": "Query", "method_name": "page", "self_obj": {"_klass": "Portfolio", "filters": [["workspace", "=", "my_workspace"]], "order": [], "projection": null, "distinct_on": [], "limit": null, "offset": null, "page_size": null, "page_token": null, "_clean_order": [], "__class_path__": "everysk.sdk.entities.query.Query"}, "params": {"page_size": 10, "page_token": "page_token"}}'
    ...
    def test_pages(self):
        ...
        expected_data = '{"class_name": "Query", "method_name": "page", "self_obj": {"_klass": "Portfolio", "filters": [["workspace", "=", "my_workspace"]], "order": [], "projection": null, "distinct_on": [], "limit": null, "offset": null, "page_size": null, "page_token": null, "_clean_order": [], "__class_path__": "everysk.sdk.entities.query.Query"}, "params": {"page_size": 10, "page_token": {"__undefined__": null}}}'
    ...
    def test_script_query(self):
        expected_data = '{"class_name": "Script", "method_name": "fetch", "self_obj": {"_klass": "Portfolio", "__class_path__": "everysk.sdk.entities.script.Script"}, "params": {"user_input": "port_12456", "variant": "select", "workspace": null}}'
    ...
    def test_retrieve(self):
        expected_data = '{"class_name": "Portfolio", "method_name": "retrieve", "self_obj": null, "params": {"entity_id": "port_1234567891011211234567890"}}'
    ...
    def test_modify(self):
        ...
        expected_data = '{"class_name": "Portfolio", "method_name": "modify", "self_obj": null, "params": {"entity_id": "port_1234567891011211234567890", "overwrites": {"base_currency": "BRL"}}}'
    ...
    def test_remove(self):
        expected_data = '{"class_name": "Portfolio", "method_name": "remove", "self_obj": null, "params": {"entity_id": "port_1234567891011211234567890"}}'
    ...
    def test_clone(self):
        sample_portfolio_data = self.sample_portfolio_data.copy()
        sample_portfolio_data['base_currency'] = 'BRL'
        expected_data = '{"class_name": "Portfolio", "method_name": "clone", "self_obj": null, "params": {"entity_id": "port_1234567891011211234567890", "overwrites": {"base_currency": "BRL"}}}'
    ...
    def test_modify_many(self):
        ...
        expected_data = '{"class_name": "Portfolio", "method_name": "modify_many", "self_obj": null, "params": {"entity_id_list": ["port_1234567891011211234567890", "port_1234567891011211234567891"], "overwrites": [{"name": "modified_1"}, {"name": "modified_2"}]}}'
        expected_response = []
    ...
    def test_remove_many(self):
        ...
        expected_data = '{"class_name": "Portfolio", "method_name": "remove_many", "self_obj": null, "params": {"entity_id_list": ["port_1234567891011211234567890", "port_1234567891011211234567891"]}}'
    ...
    def test_clone_many(self):
        ...
        expected_data = '{"class_name": "Portfolio", "method_name": "clone_many", "self_obj": null, "params": {"entity_id_list": ["port_1234567891011211234567890", "port_1234567891011211234567891"], "overwrites": [{"name": "modified_1"}, {"name": "modified_1"}]}}'
        expected_response = []
    ...
    def test_delete(self):
        self.sample_portfolio_data["securities"] = []
        expected_data = '{"class_name": "Portfolio", "method_name": "delete", "self_obj": {"id": "port_1234567891011211234567890", "workspace": "SampleWorkspace", "name": "SamplePortfolio", "tags": ["tag1", "tag2"], "link_uid": "ABC", "description": "Description", "nlv": 1000.0, "base_currency": "USD", "date": "20230909", "securities": [], "version": "1.0", "created_on": {"__datetime__": "2023-09-09T09:09:09.000009+00:00"}, "updated_on": {"__datetime__": "2023-09-09T09:09:09.000009+00:00"}, "level": "HIGH", "outstanding_shares": 1000, "source_hash": "XYZ", "status": "OK", "portfolio_uid": "UID123", "check_securities": false, "__class_path__": "everysk.sdk.entities.portfolio.base.Portfolio"}, "params": {}}'
        portfolio = Portfolio(**self.sample_portfolio_data)
