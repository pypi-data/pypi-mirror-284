...
class DatastoreTestCase(unittest.TestCase):
    ...
    def test_validate(self):
        expected_data = '{"class_name": "Datastore", "method_name": "validate", "self_obj": {"data": {"key1": "value1", "key2": "value2"}, "id": "dats_12345678", "name": "My Datastore", "description": "This is a sample datastore.", "tags": ["tag1", "tag2"], "link_uid": null, "workspace": "my_workspace", "date": "20230909", "level": "1", "version": "v1", "created_on": {"__datetime__": "2023-09-09T09:09:09.000009+00:00"}, "updated_on": {"__datetime__": "2023-09-09T09:09:09.000009+00:00"}, "__class_path__": "everysk.sdk.entities.datastore.base.Datastore"}, "params": {}}'
    ...
    def test_query_load_with_id(self):
        expected_data = '{"class_name": "Datastore", "method_name": "retrieve", "self_obj": null, "params": {"entity_id": "dats_1234567891011211234567890"}}'
    ...
    def test_query_load(self):
        expected_data = '{"class_name": "Query", "method_name": "load", "self_obj": {"_klass": "Datastore", "filters": [["workspace", "=", "SampleWorkspace"], ["link_uid", "=", "SampleLinkUID"]], "order": [], "projection": null, "distinct_on": [], "limit": null, "offset": null, "page_size": null, "page_token": null, "_clean_order": [], "__class_path__": "everysk.sdk.entities.query.Query"}, "params": {"offset": null}}'
