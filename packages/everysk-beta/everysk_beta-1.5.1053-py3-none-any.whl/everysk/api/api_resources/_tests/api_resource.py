...
###############################################################################
@patch.object(utils, 'create_api_requestor')
class APIResourceTestCase(TestCase):
    ...
    def test_refresh_method(self, mock_utils_create_api: MagicMock):
        resource = MockAPIResource({'param': 'value'}, {})
        resource.update = MagicMock()
        resource.clear_unsaved_values = MagicMock()
    ...
    def test_class_name_list(self,  mock_utils_create_api: MagicMock): # pylint: disable=unused-argument
        self.assertEqual(MockAPIResource.class_name_list(), 'testresources')

    def test_class_name_list_endswith_y(self,  mock_utils_create_api: MagicMock): # pylint: disable=unused-argument
        self.assertEqual(MockAPIResourceEndsWithY.class_name_list(), 'testresourceies')

    def test_class_name_list_endswith_x(self,  mock_utils_create_api: MagicMock): # pylint: disable=unused-argument
        self.assertEqual(MockAPIResourceEndsWithX.class_name_list(), 'testresourcexes')

    def test_class_url(self,  mock_utils_create_api: MagicMock): # pylint: disable=unused-argument
...
class RetrievableAPIResourceTestCase(TestCase):
    ...
    @patch('everysk.api.utils.create_api_requestor')
    def test_retrieve_method(self, mock_create_api_requestor):
        mock_api_requestor = Mock()
...
class ListableAPIResourceTestCase(TestCase):
    ...
    @patch('everysk.api.api_resources.api_resource.ListableAPIResource.list')
    def test_auto_paging_iter(self, mock_list):
        MockListableAPIResourceClassName = MagicMock()
