...
class TestTypebotStartInstanceNamePostRequestVariablesInner(unittest.TestCase):
    """TypebotStartInstanceNamePostRequestVariablesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TypebotStartInstanceNamePostRequestVariablesInner:
        """Test TypebotStartInstanceNamePostRequestVariablesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TypebotStartInstanceNamePostRequestVariablesInner`
        """
        model = TypebotStartInstanceNamePostRequestVariablesInner()
        if include_optional:
            return TypebotStartInstanceNamePostRequestVariablesInner(
                name = '',
                value = ''
            )
        else:
    ...
    def testTypebotStartInstanceNamePostRequestVariablesInner(self):
        """Test TypebotStartInstanceNamePostRequestVariablesInner"""
