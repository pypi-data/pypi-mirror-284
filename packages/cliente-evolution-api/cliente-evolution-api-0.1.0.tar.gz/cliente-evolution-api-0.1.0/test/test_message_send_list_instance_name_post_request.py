...
class TestMessageSendListInstanceNamePostRequest(unittest.TestCase):
    """MessageSendListInstanceNamePostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MessageSendListInstanceNamePostRequest:
        """Test MessageSendListInstanceNamePostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MessageSendListInstanceNamePostRequest`
        """
        model = MessageSendListInstanceNamePostRequest()
        if include_optional:
            return MessageSendListInstanceNamePostRequest(
                number = '',
                options = evolution_api_client.models._message_send_list__instance_name__post_request_options._message_sendList__instanceName__post_request_options(
                    delay = 56, 
                    presence = '', ),
                list_message = evolution_api_client.models._message_send_list__instance_name__post_request_list_message._message_sendList__instanceName__post_request_listMessage(
                    title = '', 
                    description = '', 
                    footer_text = '', 
                    button_text = '', 
                    sections = [
                        evolution_api_client.models._message_send_list__instance_name__post_request_list_message_sections_inner._message_sendList__instanceName__post_request_listMessage_sections_inner(
                            title = '', 
                            rows = [
                                evolution_api_client.models._message_send_list__instance_name__post_request_list_message_sections_inner_rows_inner._message_sendList__instanceName__post_request_listMessage_sections_inner_rows_inner(
                                    title = '', 
                                    description = '', 
                                    row_id = '', )
                                ], )
    ...
    def testMessageSendListInstanceNamePostRequest(self):
        """Test MessageSendListInstanceNamePostRequest"""
