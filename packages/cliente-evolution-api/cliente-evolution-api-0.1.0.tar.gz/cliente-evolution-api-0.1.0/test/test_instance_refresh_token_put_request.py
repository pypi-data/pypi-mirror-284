...
class TestInstanceRefreshTokenPutRequest(unittest.TestCase):
    """InstanceRefreshTokenPutRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InstanceRefreshTokenPutRequest:
        """Test InstanceRefreshTokenPutRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InstanceRefreshTokenPutRequest`
        """
        model = InstanceRefreshTokenPutRequest()
        if include_optional:
            return InstanceRefreshTokenPutRequest(
                old_token = ''
            )
        else:
            return InstanceRefreshTokenPutRequest(
    ...
    def testInstanceRefreshTokenPutRequest(self):
        """Test InstanceRefreshTokenPutRequest"""
