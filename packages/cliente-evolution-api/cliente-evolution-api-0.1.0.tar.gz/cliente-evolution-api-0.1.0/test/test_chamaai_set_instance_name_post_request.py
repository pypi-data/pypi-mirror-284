...
class TestChamaaiSetInstanceNamePostRequest(unittest.TestCase):
    """ChamaaiSetInstanceNamePostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChamaaiSetInstanceNamePostRequest:
        """Test ChamaaiSetInstanceNamePostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChamaaiSetInstanceNamePostRequest`
        """
        model = ChamaaiSetInstanceNamePostRequest()
        if include_optional:
            return ChamaaiSetInstanceNamePostRequest(
                enabled = True,
                url = '',
                token = '',
                wa_number = '',
                answer_by_audio = True
            )
        else:
            return ChamaaiSetInstanceNamePostRequest(
        )
    ...
    def testChamaaiSetInstanceNamePostRequest(self):
        """Test ChamaaiSetInstanceNamePostRequest"""
