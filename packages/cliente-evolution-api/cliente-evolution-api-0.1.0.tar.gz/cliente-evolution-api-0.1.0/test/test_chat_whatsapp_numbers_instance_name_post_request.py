...
class TestChatWhatsappNumbersInstanceNamePostRequest(unittest.TestCase):
    """ChatWhatsappNumbersInstanceNamePostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChatWhatsappNumbersInstanceNamePostRequest:
        """Test ChatWhatsappNumbersInstanceNamePostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChatWhatsappNumbersInstanceNamePostRequest`
        """
        model = ChatWhatsappNumbersInstanceNamePostRequest()
        if include_optional:
            return ChatWhatsappNumbersInstanceNamePostRequest(
                numbers = ["1234567890"]
            )
        else:
            return ChatWhatsappNumbersInstanceNamePostRequest(
    ...
    def testChatWhatsappNumbersInstanceNamePostRequest(self):
        """Test ChatWhatsappNumbersInstanceNamePostRequest"""
