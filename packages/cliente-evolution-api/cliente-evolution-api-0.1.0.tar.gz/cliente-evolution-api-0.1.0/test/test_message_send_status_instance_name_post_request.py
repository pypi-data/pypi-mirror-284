...
class TestMessageSendStatusInstanceNamePostRequest(unittest.TestCase):
    """MessageSendStatusInstanceNamePostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MessageSendStatusInstanceNamePostRequest:
        """Test MessageSendStatusInstanceNamePostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MessageSendStatusInstanceNamePostRequest`
        """
        model = MessageSendStatusInstanceNamePostRequest()
        if include_optional:
            return MessageSendStatusInstanceNamePostRequest(
                status_message = evolution_api_client.models._message_send_status__instance_name__post_request_status_message._message_sendStatus__instanceName__post_request_statusMessage(
                    type = 'text', 
                    content = '', 
                    background_color = '', 
                    font = 1, 
    ...
    def testMessageSendStatusInstanceNamePostRequest(self):
        """Test MessageSendStatusInstanceNamePostRequest"""
