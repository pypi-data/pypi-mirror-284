...
class TestProxySetInstanceNamePostRequest(unittest.TestCase):
    """ProxySetInstanceNamePostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProxySetInstanceNamePostRequest:
        """Test ProxySetInstanceNamePostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProxySetInstanceNamePostRequest`
        """
        model = ProxySetInstanceNamePostRequest()
        if include_optional:
            return ProxySetInstanceNamePostRequest(
                enabled = True,
                proxy = ''
            )
        else:
    ...
    def testProxySetInstanceNamePostRequest(self):
        """Test ProxySetInstanceNamePostRequest"""
