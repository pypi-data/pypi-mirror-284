...
class TestGroupCreateInstanceNamePostRequest(unittest.TestCase):
    """GroupCreateInstanceNamePostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GroupCreateInstanceNamePostRequest:
        """Test GroupCreateInstanceNamePostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroupCreateInstanceNamePostRequest`
        """
        model = GroupCreateInstanceNamePostRequest()
        if include_optional:
            return GroupCreateInstanceNamePostRequest(
                subject = '',
                description = '',
                participants = [
                    ''
    ...
    def testGroupCreateInstanceNamePostRequest(self):
        """Test GroupCreateInstanceNamePostRequest"""
