...
class TestChatwootSetInstanceNamePostRequest(unittest.TestCase):
    """ChatwootSetInstanceNamePostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChatwootSetInstanceNamePostRequest:
        """Test ChatwootSetInstanceNamePostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChatwootSetInstanceNamePostRequest`
        """
        model = ChatwootSetInstanceNamePostRequest()
        if include_optional:
            return ChatwootSetInstanceNamePostRequest(
                enabled = True,
                account_id = '',
                token = '',
                url = '',
                ...
                days_limit_import_messages = 1.337
            )
        else:
            return ChatwootSetInstanceNamePostRequest(
        )
    ...
    def testChatwootSetInstanceNamePostRequest(self):
        """Test ChatwootSetInstanceNamePostRequest"""
