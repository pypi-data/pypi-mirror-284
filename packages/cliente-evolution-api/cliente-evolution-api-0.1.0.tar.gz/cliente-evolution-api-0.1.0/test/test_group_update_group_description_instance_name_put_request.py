...
class TestGroupUpdateGroupDescriptionInstanceNamePutRequest(unittest.TestCase):
    """GroupUpdateGroupDescriptionInstanceNamePutRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GroupUpdateGroupDescriptionInstanceNamePutRequest:
        """Test GroupUpdateGroupDescriptionInstanceNamePutRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroupUpdateGroupDescriptionInstanceNamePutRequest`
        """
        model = GroupUpdateGroupDescriptionInstanceNamePutRequest()
        if include_optional:
            return GroupUpdateGroupDescriptionInstanceNamePutRequest(
                description = ''
            )
        else:
            return GroupUpdateGroupDescriptionInstanceNamePutRequest(
    ...
    def testGroupUpdateGroupDescriptionInstanceNamePutRequest(self):
        """Test GroupUpdateGroupDescriptionInstanceNamePutRequest"""
