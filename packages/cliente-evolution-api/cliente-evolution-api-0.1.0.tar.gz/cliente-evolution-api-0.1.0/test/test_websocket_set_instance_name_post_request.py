...
class TestWebsocketSetInstanceNamePostRequest(unittest.TestCase):
    """WebsocketSetInstanceNamePostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebsocketSetInstanceNamePostRequest:
        """Test WebsocketSetInstanceNamePostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebsocketSetInstanceNamePostRequest`
        """
        model = WebsocketSetInstanceNamePostRequest()
        if include_optional:
            return WebsocketSetInstanceNamePostRequest(
                enabled = True,
    ...
    def testWebsocketSetInstanceNamePostRequest(self):
        """Test WebsocketSetInstanceNamePostRequest"""
