...
class TestChatMarkMessageAsReadInstanceNamePutRequest(unittest.TestCase):
    """ChatMarkMessageAsReadInstanceNamePutRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChatMarkMessageAsReadInstanceNamePutRequest:
        """Test ChatMarkMessageAsReadInstanceNamePutRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChatMarkMessageAsReadInstanceNamePutRequest`
        """
        model = ChatMarkMessageAsReadInstanceNamePutRequest()
        if include_optional:
            return ChatMarkMessageAsReadInstanceNamePutRequest(
                read_messages = [
                    evolution_api_client.models._chat_mark_message_as_read__instance_name__put_request_read_messages_inner._chat_markMessageAsRead__instanceName__put_request_read_messages_inner(
                        remote_jid = '', 
                        from_me = True, 
                        id = '', )
                    ]
    ...
    def testChatMarkMessageAsReadInstanceNamePutRequest(self):
        """Test ChatMarkMessageAsReadInstanceNamePutRequest"""
