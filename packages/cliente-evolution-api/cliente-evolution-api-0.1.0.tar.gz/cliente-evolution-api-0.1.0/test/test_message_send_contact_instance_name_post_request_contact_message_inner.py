...
class TestMessageSendContactInstanceNamePostRequestContactMessageInner(unittest.TestCase):
    """MessageSendContactInstanceNamePostRequestContactMessageInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MessageSendContactInstanceNamePostRequestContactMessageInner:
        """Test MessageSendContactInstanceNamePostRequestContactMessageInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MessageSendContactInstanceNamePostRequestContactMessageInner`
        """
        model = MessageSendContactInstanceNamePostRequestContactMessageInner()
        if include_optional:
            return MessageSendContactInstanceNamePostRequestContactMessageInner(
                full_name = '',
                wuid = '',
                phone_number = '',
                organization = '',
    ...
    def testMessageSendContactInstanceNamePostRequestContactMessageInner(self):
        """Test MessageSendContactInstanceNamePostRequestContactMessageInner"""
