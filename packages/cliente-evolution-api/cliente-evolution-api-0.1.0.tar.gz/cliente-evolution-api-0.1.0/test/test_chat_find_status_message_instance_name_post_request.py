...
class TestChatFindStatusMessageInstanceNamePostRequest(unittest.TestCase):
    """ChatFindStatusMessageInstanceNamePostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChatFindStatusMessageInstanceNamePostRequest:
        """Test ChatFindStatusMessageInstanceNamePostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChatFindStatusMessageInstanceNamePostRequest`
        """
        model = ChatFindStatusMessageInstanceNamePostRequest()
        if include_optional:
            return ChatFindStatusMessageInstanceNamePostRequest(
                where = evolution_api_client.models._chat_find_status_message__instance_name__post_request_where._chat_findStatusMessage__instanceName__post_request_where(
                    id = '', )
            )
        else:
            return ChatFindStatusMessageInstanceNamePostRequest(
    ...
    def testChatFindStatusMessageInstanceNamePostRequest(self):
        """Test ChatFindStatusMessageInstanceNamePostRequest"""
