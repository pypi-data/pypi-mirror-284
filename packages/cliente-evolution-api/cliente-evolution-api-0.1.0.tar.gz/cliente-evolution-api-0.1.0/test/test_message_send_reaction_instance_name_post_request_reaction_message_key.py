...
class TestMessageSendReactionInstanceNamePostRequestReactionMessageKey(unittest.TestCase):
    """MessageSendReactionInstanceNamePostRequestReactionMessageKey unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MessageSendReactionInstanceNamePostRequestReactionMessageKey:
        """Test MessageSendReactionInstanceNamePostRequestReactionMessageKey
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MessageSendReactionInstanceNamePostRequestReactionMessageKey`
        """
        model = MessageSendReactionInstanceNamePostRequestReactionMessageKey()
        if include_optional:
            return MessageSendReactionInstanceNamePostRequestReactionMessageKey(
                remote_jid = '',
                from_me = True,
                id = ''
            )
    ...
    def testMessageSendReactionInstanceNamePostRequestReactionMessageKey(self):
        """Test MessageSendReactionInstanceNamePostRequestReactionMessageKey"""
