...
class TestChatUpdateProfileStatusInstanceNamePostRequest(unittest.TestCase):
    """ChatUpdateProfileStatusInstanceNamePostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChatUpdateProfileStatusInstanceNamePostRequest:
        """Test ChatUpdateProfileStatusInstanceNamePostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChatUpdateProfileStatusInstanceNamePostRequest`
        """
        model = ChatUpdateProfileStatusInstanceNamePostRequest()
        if include_optional:
            return ChatUpdateProfileStatusInstanceNamePostRequest(
                status = ''
            )
        else:
            return ChatUpdateProfileStatusInstanceNamePostRequest(
    ...
    def testChatUpdateProfileStatusInstanceNamePostRequest(self):
        """Test ChatUpdateProfileStatusInstanceNamePostRequest"""
