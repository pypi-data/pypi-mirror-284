...
class TestGroupUpdateSettingInstanceNamePutRequest(unittest.TestCase):
    """GroupUpdateSettingInstanceNamePutRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GroupUpdateSettingInstanceNamePutRequest:
        """Test GroupUpdateSettingInstanceNamePutRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroupUpdateSettingInstanceNamePutRequest`
        """
        model = GroupUpdateSettingInstanceNamePutRequest()
        if include_optional:
            return GroupUpdateSettingInstanceNamePutRequest(
                action = 'announcement'
            )
        else:
            return GroupUpdateSettingInstanceNamePutRequest(
    ...
    def testGroupUpdateSettingInstanceNamePutRequest(self):
        """Test GroupUpdateSettingInstanceNamePutRequest"""
