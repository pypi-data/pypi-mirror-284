...
class TestInstanceFetchInstancesGet200ResponseInnerInstance(unittest.TestCase):
    """InstanceFetchInstancesGet200ResponseInnerInstance unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InstanceFetchInstancesGet200ResponseInnerInstance:
        """Test InstanceFetchInstancesGet200ResponseInnerInstance
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InstanceFetchInstancesGet200ResponseInnerInstance`
        """
        model = InstanceFetchInstancesGet200ResponseInnerInstance()
        if include_optional:
            return InstanceFetchInstancesGet200ResponseInnerInstance(
                instance_name = '',
                owner = '',
                profile_name = '',
                profile_picture_url = '',
    ...
    def testInstanceFetchInstancesGet200ResponseInnerInstance(self):
        """Test InstanceFetchInstancesGet200ResponseInnerInstance"""
