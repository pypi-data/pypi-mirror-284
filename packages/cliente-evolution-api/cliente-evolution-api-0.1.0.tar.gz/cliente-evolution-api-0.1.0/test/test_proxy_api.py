...
class TestProxyApi(unittest.TestCase):
    ...
    def test_proxy_find_instance_name_get(self) -> None:
        """Test case for proxy_find_instance_name_get

        Retrieve the Proxy for a specific instance.
        """
        pass

    def test_proxy_set_instance_name_post(self) -> None:
        """Test case for proxy_set_instance_name_post
