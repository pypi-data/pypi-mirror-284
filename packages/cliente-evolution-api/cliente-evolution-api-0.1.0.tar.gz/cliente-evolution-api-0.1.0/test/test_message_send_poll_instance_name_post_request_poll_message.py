...
class TestMessageSendPollInstanceNamePostRequestPollMessage(unittest.TestCase):
    """MessageSendPollInstanceNamePostRequestPollMessage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MessageSendPollInstanceNamePostRequestPollMessage:
        """Test MessageSendPollInstanceNamePostRequestPollMessage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MessageSendPollInstanceNamePostRequestPollMessage`
        """
        model = MessageSendPollInstanceNamePostRequestPollMessage()
        if include_optional:
            return MessageSendPollInstanceNamePostRequestPollMessage(
                name = '',
                selectable_count = 56,
                values = [
                    ''
    ...
    def testMessageSendPollInstanceNamePostRequestPollMessage(self):
        """Test MessageSendPollInstanceNamePostRequestPollMessage"""
