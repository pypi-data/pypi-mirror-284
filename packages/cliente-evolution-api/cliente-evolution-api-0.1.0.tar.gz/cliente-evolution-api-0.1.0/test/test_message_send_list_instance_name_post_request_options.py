...
class TestMessageSendListInstanceNamePostRequestOptions(unittest.TestCase):
    """MessageSendListInstanceNamePostRequestOptions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MessageSendListInstanceNamePostRequestOptions:
        """Test MessageSendListInstanceNamePostRequestOptions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MessageSendListInstanceNamePostRequestOptions`
        """
        model = MessageSendListInstanceNamePostRequestOptions()
        if include_optional:
            return MessageSendListInstanceNamePostRequestOptions(
                delay = 56,
                presence = ''
            )
        else:
    ...
    def testMessageSendListInstanceNamePostRequestOptions(self):
        """Test MessageSendListInstanceNamePostRequestOptions"""
