...
class TestChatUpdatePrivacySettingsInstanceNamePutRequestPrivacySettings(unittest.TestCase):
    """ChatUpdatePrivacySettingsInstanceNamePutRequestPrivacySettings unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChatUpdatePrivacySettingsInstanceNamePutRequestPrivacySettings:
        """Test ChatUpdatePrivacySettingsInstanceNamePutRequestPrivacySettings
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChatUpdatePrivacySettingsInstanceNamePutRequestPrivacySettings`
        """
        model = ChatUpdatePrivacySettingsInstanceNamePutRequestPrivacySettings()
        if include_optional:
            return ChatUpdatePrivacySettingsInstanceNamePutRequestPrivacySettings(
                readreceipts = 'all',
                profile = 'all',
                status = 'all',
                online = 'all',
    ...
    def testChatUpdatePrivacySettingsInstanceNamePutRequestPrivacySettings(self):
        """Test ChatUpdatePrivacySettingsInstanceNamePutRequestPrivacySettings"""
