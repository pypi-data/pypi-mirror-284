...
class TestLabelHandleLabelInstanceNamePut200Response(unittest.TestCase):
    """LabelHandleLabelInstanceNamePut200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LabelHandleLabelInstanceNamePut200Response:
        """Test LabelHandleLabelInstanceNamePut200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LabelHandleLabelInstanceNamePut200Response`
        """
        model = LabelHandleLabelInstanceNamePut200Response()
        if include_optional:
            return LabelHandleLabelInstanceNamePut200Response(
                number_jid = '',
                label_id = '',
                remove = True,
                add = True
    ...
    def testLabelHandleLabelInstanceNamePut200Response(self):
        """Test LabelHandleLabelInstanceNamePut200Response"""
