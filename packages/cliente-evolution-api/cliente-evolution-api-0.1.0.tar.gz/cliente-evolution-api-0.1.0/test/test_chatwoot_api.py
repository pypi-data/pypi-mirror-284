...
class TestChatwootApi(unittest.TestCase):
    """ChatwootApi unit test stubs"""

    def setUp(self) -> None:
        self.api = ChatwootApi()

    def tearDown(self) -> None:
        pass

    def test_chatwoot_find_instance_name_get(self) -> None:
        """Test case for chatwoot_find_instance_name_get

        Retrieve the Chatwoot for a specific instance.
        """
        pass

    def test_chatwoot_set_instance_name_post(self) -> None:
        """Test case for chatwoot_set_instance_name_post
