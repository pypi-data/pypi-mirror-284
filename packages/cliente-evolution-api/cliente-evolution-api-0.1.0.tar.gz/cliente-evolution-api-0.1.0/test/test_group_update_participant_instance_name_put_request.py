...
class TestGroupUpdateParticipantInstanceNamePutRequest(unittest.TestCase):
    """GroupUpdateParticipantInstanceNamePutRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GroupUpdateParticipantInstanceNamePutRequest:
        """Test GroupUpdateParticipantInstanceNamePutRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroupUpdateParticipantInstanceNamePutRequest`
        """
        model = GroupUpdateParticipantInstanceNamePutRequest()
        if include_optional:
            return GroupUpdateParticipantInstanceNamePutRequest(
                action = 'add',
                participants = [
                    ''
                    ]
    ...
    def testGroupUpdateParticipantInstanceNamePutRequest(self):
        """Test GroupUpdateParticipantInstanceNamePutRequest"""
