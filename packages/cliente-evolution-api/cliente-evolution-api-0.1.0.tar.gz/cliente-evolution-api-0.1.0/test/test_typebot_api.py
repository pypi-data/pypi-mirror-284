...
class TestTypebotApi(unittest.TestCase):
    """TypebotApi unit test stubs"""
    ...
    def test_typebot_change_status_instance_name_post(self) -> None:
        """Test case for typebot_change_status_instance_name_post

        Change the status of the Typebot for an instance.
        """
        pass

    def test_typebot_find_instance_name_get(self) -> None:
        """Test case for typebot_find_instance_name_get

        Retrieve the Typebot for a specific instance.
        """
        pass

    def test_typebot_set_instance_name_post(self) -> None:
        """Test case for typebot_set_instance_name_post

        Set up or modify the Typebot for an instance.
        """
        pass

    def test_typebot_start_instance_name_post(self) -> None:
        """Test case for typebot_start_instance_name_post
