...
class TestMessageSendMediaInstanceNamePostRequestMediaMessage(unittest.TestCase):
    """MessageSendMediaInstanceNamePostRequestMediaMessage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MessageSendMediaInstanceNamePostRequestMediaMessage:
        """Test MessageSendMediaInstanceNamePostRequestMediaMessage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MessageSendMediaInstanceNamePostRequestMediaMessage`
        """
        model = MessageSendMediaInstanceNamePostRequestMediaMessage()
        if include_optional:
            return MessageSendMediaInstanceNamePostRequestMediaMessage(
                mediatype = 'image',
                file_name = '',
                caption = '',
                media = ''
    ...
    def testMessageSendMediaInstanceNamePostRequestMediaMessage(self):
        """Test MessageSendMediaInstanceNamePostRequestMediaMessage"""
