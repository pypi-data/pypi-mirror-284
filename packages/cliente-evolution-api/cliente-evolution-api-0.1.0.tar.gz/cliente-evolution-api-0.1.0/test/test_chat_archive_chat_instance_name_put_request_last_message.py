...
class TestChatArchiveChatInstanceNamePutRequestLastMessage(unittest.TestCase):
    """ChatArchiveChatInstanceNamePutRequestLastMessage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChatArchiveChatInstanceNamePutRequestLastMessage:
        """Test ChatArchiveChatInstanceNamePutRequestLastMessage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChatArchiveChatInstanceNamePutRequestLastMessage`
        """
        model = ChatArchiveChatInstanceNamePutRequestLastMessage()
        if include_optional:
            return ChatArchiveChatInstanceNamePutRequestLastMessage(
    ...
    def testChatArchiveChatInstanceNamePutRequestLastMessage(self):
        """Test ChatArchiveChatInstanceNamePutRequestLastMessage"""
