...
class TestChatUpdateProfilePictureInstanceNamePutRequest(unittest.TestCase):
    """ChatUpdateProfilePictureInstanceNamePutRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChatUpdateProfilePictureInstanceNamePutRequest:
        """Test ChatUpdateProfilePictureInstanceNamePutRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChatUpdateProfilePictureInstanceNamePutRequest`
        """
        model = ChatUpdateProfilePictureInstanceNamePutRequest()
        if include_optional:
            return ChatUpdateProfilePictureInstanceNamePutRequest(
                picture = ''
            )
        else:
            return ChatUpdateProfilePictureInstanceNamePutRequest(
    ...
    def testChatUpdateProfilePictureInstanceNamePutRequest(self):
        """Test ChatUpdateProfilePictureInstanceNamePutRequest"""
