...
class TestWebsocketApi(unittest.TestCase):
    ...
    def test_websocket_find_instance_name_get(self) -> None:
        """Test case for websocket_find_instance_name_get

        Retrieve the websocket settings for a specific instance.
        """
        pass

    def test_websocket_set_instance_name_post(self) -> None:
        """Test case for websocket_set_instance_name_post
