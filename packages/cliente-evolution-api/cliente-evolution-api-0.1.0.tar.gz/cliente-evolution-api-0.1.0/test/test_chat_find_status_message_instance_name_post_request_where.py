...
class TestChatFindStatusMessageInstanceNamePostRequestWhere(unittest.TestCase):
    """ChatFindStatusMessageInstanceNamePostRequestWhere unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChatFindStatusMessageInstanceNamePostRequestWhere:
        """Test ChatFindStatusMessageInstanceNamePostRequestWhere
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChatFindStatusMessageInstanceNamePostRequestWhere`
        """
        model = ChatFindStatusMessageInstanceNamePostRequestWhere()
        if include_optional:
            return ChatFindStatusMessageInstanceNamePostRequestWhere(
                id = ''
            )
        else:
            return ChatFindStatusMessageInstanceNamePostRequestWhere(
    ...
    def testChatFindStatusMessageInstanceNamePostRequestWhere(self):
        """Test ChatFindStatusMessageInstanceNamePostRequestWhere"""
