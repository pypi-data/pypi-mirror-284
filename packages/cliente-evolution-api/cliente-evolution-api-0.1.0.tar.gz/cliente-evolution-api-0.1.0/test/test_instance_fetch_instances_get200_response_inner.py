...
class TestInstanceFetchInstancesGet200ResponseInner(unittest.TestCase):
    """InstanceFetchInstancesGet200ResponseInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InstanceFetchInstancesGet200ResponseInner:
        """Test InstanceFetchInstancesGet200ResponseInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InstanceFetchInstancesGet200ResponseInner`
        """
        model = InstanceFetchInstancesGet200ResponseInner()
        if include_optional:
            return InstanceFetchInstancesGet200ResponseInner(
                instance = evolution_api_client.models._instance_fetch_instances_get_200_response_inner_instance._instance_fetchInstances_get_200_response_inner_instance(
                    instance_name = '', 
                    owner = '', 
                    profile_name = '', 
                    profile_picture_url = '', 
    ...
    def testInstanceFetchInstancesGet200ResponseInner(self):
        """Test InstanceFetchInstancesGet200ResponseInner"""
