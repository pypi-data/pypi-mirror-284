...
class TestChatUpdatePrivacySettingsInstanceNamePutRequest(unittest.TestCase):
    """ChatUpdatePrivacySettingsInstanceNamePutRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChatUpdatePrivacySettingsInstanceNamePutRequest:
        """Test ChatUpdatePrivacySettingsInstanceNamePutRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChatUpdatePrivacySettingsInstanceNamePutRequest`
        """
        model = ChatUpdatePrivacySettingsInstanceNamePutRequest()
        if include_optional:
            return ChatUpdatePrivacySettingsInstanceNamePutRequest(
                privacy_settings = evolution_api_client.models._chat_update_privacy_settings__instance_name__put_request_privacy_settings._chat_updatePrivacySettings__instanceName__put_request_privacySettings(
                    readreceipts = 'all', 
                    profile = 'all', 
                    status = 'all', 
                    online = 'all', 
    ...
    def testChatUpdatePrivacySettingsInstanceNamePutRequest(self):
        """Test ChatUpdatePrivacySettingsInstanceNamePutRequest"""
