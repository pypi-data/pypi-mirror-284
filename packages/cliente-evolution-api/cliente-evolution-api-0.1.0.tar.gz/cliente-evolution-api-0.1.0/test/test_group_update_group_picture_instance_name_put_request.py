...
class TestGroupUpdateGroupPictureInstanceNamePutRequest(unittest.TestCase):
    """GroupUpdateGroupPictureInstanceNamePutRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GroupUpdateGroupPictureInstanceNamePutRequest:
        """Test GroupUpdateGroupPictureInstanceNamePutRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroupUpdateGroupPictureInstanceNamePutRequest`
        """
        model = GroupUpdateGroupPictureInstanceNamePutRequest()
        if include_optional:
            return GroupUpdateGroupPictureInstanceNamePutRequest(
                image = ''
            )
        else:
            return GroupUpdateGroupPictureInstanceNamePutRequest(
    ...
    def testGroupUpdateGroupPictureInstanceNamePutRequest(self):
        """Test GroupUpdateGroupPictureInstanceNamePutRequest"""
