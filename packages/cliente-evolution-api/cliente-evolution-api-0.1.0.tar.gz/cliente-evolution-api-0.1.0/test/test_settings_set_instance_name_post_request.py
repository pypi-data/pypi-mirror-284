...
class TestSettingsSetInstanceNamePostRequest(unittest.TestCase):
    """SettingsSetInstanceNamePostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SettingsSetInstanceNamePostRequest:
        """Test SettingsSetInstanceNamePostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SettingsSetInstanceNamePostRequest`
        """
        model = SettingsSetInstanceNamePostRequest()
        if include_optional:
            return SettingsSetInstanceNamePostRequest(
                reject_call = True,
                msg_call = '',
                groups_ignore = True,
                always_online = True,
    ...
    def testSettingsSetInstanceNamePostRequest(self):
        """Test SettingsSetInstanceNamePostRequest"""
