...
class TestChatFindMessagesInstanceNamePostRequest(unittest.TestCase):
    """ChatFindMessagesInstanceNamePostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChatFindMessagesInstanceNamePostRequest:
        """Test ChatFindMessagesInstanceNamePostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChatFindMessagesInstanceNamePostRequest`
        """
        model = ChatFindMessagesInstanceNamePostRequest()
        if include_optional:
            return ChatFindMessagesInstanceNamePostRequest(
                where = evolution_api_client.models._chat_find_messages__instance_name__post_request_where._chat_findMessages__instanceName__post_request_where(
                    key = evolution_api_client.models._chat_mark_message_as_read__instance_name__put_request_read_messages_inner._chat_markMessageAsRead__instanceName__put_request_read_messages_inner(
                        remote_jid = '', 
                        from_me = True, 
                        id = '', ), 
                    message = evolution_api_client.models.message.message(), ),
                limit = 56
            )
        else:
            return ChatFindMessagesInstanceNamePostRequest(
    ...
    def testChatFindMessagesInstanceNamePostRequest(self):
        """Test ChatFindMessagesInstanceNamePostRequest"""
