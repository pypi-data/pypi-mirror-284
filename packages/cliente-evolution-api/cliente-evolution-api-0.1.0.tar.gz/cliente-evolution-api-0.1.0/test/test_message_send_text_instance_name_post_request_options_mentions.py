...
class TestMessageSendTextInstanceNamePostRequestOptionsMentions(unittest.TestCase):
    """MessageSendTextInstanceNamePostRequestOptionsMentions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MessageSendTextInstanceNamePostRequestOptionsMentions:
        """Test MessageSendTextInstanceNamePostRequestOptionsMentions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MessageSendTextInstanceNamePostRequestOptionsMentions`
        """
        model = MessageSendTextInstanceNamePostRequestOptionsMentions()
        if include_optional:
            return MessageSendTextInstanceNamePostRequestOptionsMentions(
                everyone = True,
                mentioned = [
                    ''
                    ]
    ...
    def testMessageSendTextInstanceNamePostRequestOptionsMentions(self):
        """Test MessageSendTextInstanceNamePostRequestOptionsMentions"""
