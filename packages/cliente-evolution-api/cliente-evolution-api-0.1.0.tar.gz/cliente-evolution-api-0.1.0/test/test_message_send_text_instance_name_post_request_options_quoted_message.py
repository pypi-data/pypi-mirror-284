...
class TestMessageSendTextInstanceNamePostRequestOptionsQuotedMessage(unittest.TestCase):
    """MessageSendTextInstanceNamePostRequestOptionsQuotedMessage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MessageSendTextInstanceNamePostRequestOptionsQuotedMessage:
        """Test MessageSendTextInstanceNamePostRequestOptionsQuotedMessage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MessageSendTextInstanceNamePostRequestOptionsQuotedMessage`
        """
        model = MessageSendTextInstanceNamePostRequestOptionsQuotedMessage()
        if include_optional:
            return MessageSendTextInstanceNamePostRequestOptionsQuotedMessage(
                conversation = ''
            )
        else:
            return MessageSendTextInstanceNamePostRequestOptionsQuotedMessage(
    ...
    def testMessageSendTextInstanceNamePostRequestOptionsQuotedMessage(self):
        """Test MessageSendTextInstanceNamePostRequestOptionsQuotedMessage"""
