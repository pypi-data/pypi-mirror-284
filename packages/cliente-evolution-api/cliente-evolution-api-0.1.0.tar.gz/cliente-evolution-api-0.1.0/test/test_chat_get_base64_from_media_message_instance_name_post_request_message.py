...
class TestChatGetBase64FromMediaMessageInstanceNamePostRequestMessage(unittest.TestCase):
    """ChatGetBase64FromMediaMessageInstanceNamePostRequestMessage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChatGetBase64FromMediaMessageInstanceNamePostRequestMessage:
        """Test ChatGetBase64FromMediaMessageInstanceNamePostRequestMessage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChatGetBase64FromMediaMessageInstanceNamePostRequestMessage`
        """
        model = ChatGetBase64FromMediaMessageInstanceNamePostRequestMessage()
        if include_optional:
            return ChatGetBase64FromMediaMessageInstanceNamePostRequestMessage(
                key = None
            )
        else:
            return ChatGetBase64FromMediaMessageInstanceNamePostRequestMessage(
    ...
    def testChatGetBase64FromMediaMessageInstanceNamePostRequestMessage(self):
        """Test ChatGetBase64FromMediaMessageInstanceNamePostRequestMessage"""
