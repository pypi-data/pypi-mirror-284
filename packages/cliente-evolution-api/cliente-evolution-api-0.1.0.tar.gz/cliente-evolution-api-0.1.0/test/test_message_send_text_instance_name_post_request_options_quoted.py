...
class TestMessageSendTextInstanceNamePostRequestOptionsQuoted(unittest.TestCase):
    """MessageSendTextInstanceNamePostRequestOptionsQuoted unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MessageSendTextInstanceNamePostRequestOptionsQuoted:
        """Test MessageSendTextInstanceNamePostRequestOptionsQuoted
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MessageSendTextInstanceNamePostRequestOptionsQuoted`
        """
        model = MessageSendTextInstanceNamePostRequestOptionsQuoted()
        if include_optional:
            return MessageSendTextInstanceNamePostRequestOptionsQuoted(
    ...
    def testMessageSendTextInstanceNamePostRequestOptionsQuoted(self):
        """Test MessageSendTextInstanceNamePostRequestOptionsQuoted"""
