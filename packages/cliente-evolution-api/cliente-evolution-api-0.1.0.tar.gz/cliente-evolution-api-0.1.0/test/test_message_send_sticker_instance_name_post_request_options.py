...
class TestMessageSendStickerInstanceNamePostRequestOptions(unittest.TestCase):
    """MessageSendStickerInstanceNamePostRequestOptions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MessageSendStickerInstanceNamePostRequestOptions:
        """Test MessageSendStickerInstanceNamePostRequestOptions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MessageSendStickerInstanceNamePostRequestOptions`
        """
        model = MessageSendStickerInstanceNamePostRequestOptions()
        if include_optional:
            return MessageSendStickerInstanceNamePostRequestOptions(
                delay = 56,
                presence = 'composing'
            )
        else:
    ...
    def testMessageSendStickerInstanceNamePostRequestOptions(self):
        """Test MessageSendStickerInstanceNamePostRequestOptions"""
