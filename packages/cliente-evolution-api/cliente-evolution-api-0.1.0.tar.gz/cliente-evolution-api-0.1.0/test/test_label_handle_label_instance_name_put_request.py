...
class TestLabelHandleLabelInstanceNamePutRequest(unittest.TestCase):
    """LabelHandleLabelInstanceNamePutRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LabelHandleLabelInstanceNamePutRequest:
        """Test LabelHandleLabelInstanceNamePutRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LabelHandleLabelInstanceNamePutRequest`
        """
        model = LabelHandleLabelInstanceNamePutRequest()
        if include_optional:
            return LabelHandleLabelInstanceNamePutRequest(
                number = '',
                label_id = '',
                action = 'add'
            )
    ...
    def testLabelHandleLabelInstanceNamePutRequest(self):
        """Test LabelHandleLabelInstanceNamePutRequest"""
