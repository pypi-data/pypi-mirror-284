...
class TestChatMarkMessageAsReadInstanceNamePutRequestReadMessagesInner(unittest.TestCase):
    """ChatMarkMessageAsReadInstanceNamePutRequestReadMessagesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChatMarkMessageAsReadInstanceNamePutRequestReadMessagesInner:
        """Test ChatMarkMessageAsReadInstanceNamePutRequestReadMessagesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChatMarkMessageAsReadInstanceNamePutRequestReadMessagesInner`
        """
        model = ChatMarkMessageAsReadInstanceNamePutRequestReadMessagesInner()
        if include_optional:
            return ChatMarkMessageAsReadInstanceNamePutRequestReadMessagesInner(
                remote_jid = '',
                from_me = True,
                id = ''
            )
    ...
    def testChatMarkMessageAsReadInstanceNamePutRequestReadMessagesInner(self):
        """Test ChatMarkMessageAsReadInstanceNamePutRequestReadMessagesInner"""
