...
class TestMessageSendStickerInstanceNamePostRequestStickerMessage(unittest.TestCase):
    """MessageSendStickerInstanceNamePostRequestStickerMessage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MessageSendStickerInstanceNamePostRequestStickerMessage:
        """Test MessageSendStickerInstanceNamePostRequestStickerMessage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MessageSendStickerInstanceNamePostRequestStickerMessage`
        """
        model = MessageSendStickerInstanceNamePostRequestStickerMessage()
        if include_optional:
            return MessageSendStickerInstanceNamePostRequestStickerMessage(
                image = ''
            )
        else:
            return MessageSendStickerInstanceNamePostRequestStickerMessage(
    ...
    def testMessageSendStickerInstanceNamePostRequestStickerMessage(self):
        """Test MessageSendStickerInstanceNamePostRequestStickerMessage"""
