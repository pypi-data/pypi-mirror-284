...
class TestInstanceConnectInstanceNameGet200Response(unittest.TestCase):
    """InstanceConnectInstanceNameGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InstanceConnectInstanceNameGet200Response:
        """Test InstanceConnectInstanceNameGet200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InstanceConnectInstanceNameGet200Response`
        """
        model = InstanceConnectInstanceNameGet200Response()
        if include_optional:
            return InstanceConnectInstanceNameGet200Response(
                code = '',
                var_base64 = ''
            )
        else:
    ...
    def testInstanceConnectInstanceNameGet200Response(self):
        """Test InstanceConnectInstanceNameGet200Response"""
