...
class TestMessageSendTextInstanceNamePostRequestOptionsQuotedKey(unittest.TestCase):
    """MessageSendTextInstanceNamePostRequestOptionsQuotedKey unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MessageSendTextInstanceNamePostRequestOptionsQuotedKey:
        """Test MessageSendTextInstanceNamePostRequestOptionsQuotedKey
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MessageSendTextInstanceNamePostRequestOptionsQuotedKey`
        """
        model = MessageSendTextInstanceNamePostRequestOptionsQuotedKey()
        if include_optional:
            return MessageSendTextInstanceNamePostRequestOptionsQuotedKey(
                remote_jid = '',
                from_me = True,
                id = ''
            )
    ...
    def testMessageSendTextInstanceNamePostRequestOptionsQuotedKey(self):
        """Test MessageSendTextInstanceNamePostRequestOptionsQuotedKey"""
