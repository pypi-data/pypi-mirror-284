...
class TestGroupToggleEphemeralInstanceNamePutRequest(unittest.TestCase):
    """GroupToggleEphemeralInstanceNamePutRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GroupToggleEphemeralInstanceNamePutRequest:
        """Test GroupToggleEphemeralInstanceNamePutRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroupToggleEphemeralInstanceNamePutRequest`
        """
        model = GroupToggleEphemeralInstanceNamePutRequest()
        if include_optional:
            return GroupToggleEphemeralInstanceNamePutRequest(
                expiration = 1.337
            )
        else:
            return GroupToggleEphemeralInstanceNamePutRequest(
    ...
    def testGroupToggleEphemeralInstanceNamePutRequest(self):
        """Test GroupToggleEphemeralInstanceNamePutRequest"""
