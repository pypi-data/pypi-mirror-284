...
class TestMessageSendTextInstanceNamePostRequestTextMessage(unittest.TestCase):
    """MessageSendTextInstanceNamePostRequestTextMessage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MessageSendTextInstanceNamePostRequestTextMessage:
        """Test MessageSendTextInstanceNamePostRequestTextMessage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MessageSendTextInstanceNamePostRequestTextMessage`
        """
        model = MessageSendTextInstanceNamePostRequestTextMessage()
        if include_optional:
            return MessageSendTextInstanceNamePostRequestTextMessage(
                text = 'Hello, World!'
            )
        else:
            return MessageSendTextInstanceNamePostRequestTextMessage(
    ...
    def testMessageSendTextInstanceNamePostRequestTextMessage(self):
        """Test MessageSendTextInstanceNamePostRequestTextMessage"""
