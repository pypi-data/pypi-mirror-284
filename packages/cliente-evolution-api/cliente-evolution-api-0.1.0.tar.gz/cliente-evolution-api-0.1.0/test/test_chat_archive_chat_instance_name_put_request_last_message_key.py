...
class TestChatArchiveChatInstanceNamePutRequestLastMessageKey(unittest.TestCase):
    """ChatArchiveChatInstanceNamePutRequestLastMessageKey unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChatArchiveChatInstanceNamePutRequestLastMessageKey:
        """Test ChatArchiveChatInstanceNamePutRequestLastMessageKey
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChatArchiveChatInstanceNamePutRequestLastMessageKey`
        """
        model = ChatArchiveChatInstanceNamePutRequestLastMessageKey()
        if include_optional:
            return ChatArchiveChatInstanceNamePutRequestLastMessageKey(
                remote_jid = '',
                from_me = True,
                id = ''
            )
    ...
    def testChatArchiveChatInstanceNamePutRequestLastMessageKey(self):
        """Test ChatArchiveChatInstanceNamePutRequestLastMessageKey"""
