...
class TestInstanceCreatePostRequest(unittest.TestCase):
    """InstanceCreatePostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InstanceCreatePostRequest:
        """Test InstanceCreatePostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InstanceCreatePostRequest`
        """
        model = InstanceCreatePostRequest()
        if include_optional:
            return InstanceCreatePostRequest(
                instance_name = '',
                token = '',
                qrcode = True
            )
    ...
    def testInstanceCreatePostRequest(self):
        """Test InstanceCreatePostRequest"""
