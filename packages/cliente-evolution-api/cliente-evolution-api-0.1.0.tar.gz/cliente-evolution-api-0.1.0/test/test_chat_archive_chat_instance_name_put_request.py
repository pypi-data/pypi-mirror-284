...
class TestChatArchiveChatInstanceNamePutRequest(unittest.TestCase):
    """ChatArchiveChatInstanceNamePutRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChatArchiveChatInstanceNamePutRequest:
        """Test ChatArchiveChatInstanceNamePutRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChatArchiveChatInstanceNamePutRequest`
        """
        model = ChatArchiveChatInstanceNamePutRequest()
        if include_optional:
            return ChatArchiveChatInstanceNamePutRequest(
                last_message = evolution_api_client.models._chat_archive_chat__instance_name__put_request_last_message._chat_archiveChat__instanceName__put_request_lastMessage(
                    key = evolution_api_client.models._chat_archive_chat__instance_name__put_request_last_message_key._chat_archiveChat__instanceName__put_request_lastMessage_key(
                        remote_jid = '', 
                        from_me = True, 
                        id = '', ), ),
                archive = True
    ...
    def testChatArchiveChatInstanceNamePutRequest(self):
        """Test ChatArchiveChatInstanceNamePutRequest"""
