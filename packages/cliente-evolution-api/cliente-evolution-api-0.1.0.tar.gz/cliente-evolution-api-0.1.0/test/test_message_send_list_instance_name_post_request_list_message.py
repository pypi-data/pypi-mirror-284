...
class TestMessageSendListInstanceNamePostRequestListMessage(unittest.TestCase):
    """MessageSendListInstanceNamePostRequestListMessage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MessageSendListInstanceNamePostRequestListMessage:
        """Test MessageSendListInstanceNamePostRequestListMessage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MessageSendListInstanceNamePostRequestListMessage`
        """
        model = MessageSendListInstanceNamePostRequestListMessage()
        if include_optional:
            return MessageSendListInstanceNamePostRequestListMessage(
                title = '',
                description = '',
                footer_text = '',
                button_text = '',
    ...
    def testMessageSendListInstanceNamePostRequestListMessage(self):
        """Test MessageSendListInstanceNamePostRequestListMessage"""
