...
class TestChatFindContactsInstanceNamePostRequestWhere(unittest.TestCase):
    """ChatFindContactsInstanceNamePostRequestWhere unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChatFindContactsInstanceNamePostRequestWhere:
        """Test ChatFindContactsInstanceNamePostRequestWhere
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChatFindContactsInstanceNamePostRequestWhere`
        """
        model = ChatFindContactsInstanceNamePostRequestWhere()
        if include_optional:
            return ChatFindContactsInstanceNamePostRequestWhere(
                id = ''
            )
        else:
            return ChatFindContactsInstanceNamePostRequestWhere(
    ...
    def testChatFindContactsInstanceNamePostRequestWhere(self):
        """Test ChatFindContactsInstanceNamePostRequestWhere"""
