...
class TestMessageSendLocationInstanceNamePostRequestLocationMessage(unittest.TestCase):
    """MessageSendLocationInstanceNamePostRequestLocationMessage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MessageSendLocationInstanceNamePostRequestLocationMessage:
        """Test MessageSendLocationInstanceNamePostRequestLocationMessage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MessageSendLocationInstanceNamePostRequestLocationMessage`
        """
        model = MessageSendLocationInstanceNamePostRequestLocationMessage()
        if include_optional:
            return MessageSendLocationInstanceNamePostRequestLocationMessage(
                name = '',
                address = '',
                latitude = 1.337,
                longitude = 1.337
    ...
    def testMessageSendLocationInstanceNamePostRequestLocationMessage(self):
        """Test MessageSendLocationInstanceNamePostRequestLocationMessage"""
