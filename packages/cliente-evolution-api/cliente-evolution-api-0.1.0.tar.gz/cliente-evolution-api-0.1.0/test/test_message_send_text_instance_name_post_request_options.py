...
class TestMessageSendTextInstanceNamePostRequestOptions(unittest.TestCase):
    """MessageSendTextInstanceNamePostRequestOptions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MessageSendTextInstanceNamePostRequestOptions:
        """Test MessageSendTextInstanceNamePostRequestOptions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MessageSendTextInstanceNamePostRequestOptions`
        """
        model = MessageSendTextInstanceNamePostRequestOptions()
        if include_optional:
            return MessageSendTextInstanceNamePostRequestOptions(
                delay = 56,
                presence = 'composing',
                link_preview = True,
    ...
    def testMessageSendTextInstanceNamePostRequestOptions(self):
        """Test MessageSendTextInstanceNamePostRequestOptions"""
