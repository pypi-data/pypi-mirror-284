...
class TestChatFetchBusinessProfileInstanceNamePostRequest(unittest.TestCase):
    """ChatFetchBusinessProfileInstanceNamePostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChatFetchBusinessProfileInstanceNamePostRequest:
        """Test ChatFetchBusinessProfileInstanceNamePostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChatFetchBusinessProfileInstanceNamePostRequest`
        """
        model = ChatFetchBusinessProfileInstanceNamePostRequest()
        if include_optional:
            return ChatFetchBusinessProfileInstanceNamePostRequest(
                number = ''
            )
        else:
            return ChatFetchBusinessProfileInstanceNamePostRequest(
    ...
    def testChatFetchBusinessProfileInstanceNamePostRequest(self):
        """Test ChatFetchBusinessProfileInstanceNamePostRequest"""
