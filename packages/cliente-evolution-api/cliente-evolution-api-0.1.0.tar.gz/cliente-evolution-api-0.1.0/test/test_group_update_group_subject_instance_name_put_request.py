...
class TestGroupUpdateGroupSubjectInstanceNamePutRequest(unittest.TestCase):
    """GroupUpdateGroupSubjectInstanceNamePutRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GroupUpdateGroupSubjectInstanceNamePutRequest:
        """Test GroupUpdateGroupSubjectInstanceNamePutRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroupUpdateGroupSubjectInstanceNamePutRequest`
        """
        model = GroupUpdateGroupSubjectInstanceNamePutRequest()
        if include_optional:
            return GroupUpdateGroupSubjectInstanceNamePutRequest(
                subject = ''
            )
        else:
            return GroupUpdateGroupSubjectInstanceNamePutRequest(
    ...
    def testGroupUpdateGroupSubjectInstanceNamePutRequest(self):
        """Test GroupUpdateGroupSubjectInstanceNamePutRequest"""
