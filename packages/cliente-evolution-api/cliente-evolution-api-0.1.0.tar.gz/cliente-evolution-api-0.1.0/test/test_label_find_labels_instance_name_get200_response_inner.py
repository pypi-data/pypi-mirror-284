...
class TestLabelFindLabelsInstanceNameGet200ResponseInner(unittest.TestCase):
    """LabelFindLabelsInstanceNameGet200ResponseInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LabelFindLabelsInstanceNameGet200ResponseInner:
        """Test LabelFindLabelsInstanceNameGet200ResponseInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LabelFindLabelsInstanceNameGet200ResponseInner`
        """
        model = LabelFindLabelsInstanceNameGet200ResponseInner()
        if include_optional:
            return LabelFindLabelsInstanceNameGet200ResponseInner(
                color = 56,
                name = '',
                id = '',
                predefined_id = ''
    ...
    def testLabelFindLabelsInstanceNameGet200ResponseInner(self):
        """Test LabelFindLabelsInstanceNameGet200ResponseInner"""
