...
class TestTypebotStartInstanceNamePostRequest(unittest.TestCase):
    """TypebotStartInstanceNamePostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TypebotStartInstanceNamePostRequest:
        """Test TypebotStartInstanceNamePostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TypebotStartInstanceNamePostRequest`
        """
        model = TypebotStartInstanceNamePostRequest()
        if include_optional:
            return TypebotStartInstanceNamePostRequest(
                url = '',
                typebot = '',
                remote_jid = '',
                start_session = True,
                variables = [
                    evolution_api_client.models._typebot_start__instance_name__post_request_variables_inner._typebot_start__instanceName__post_request_variables_inner(
                        name = '', 
                        value = '', )
                    ]
            )
    ...
    def testTypebotStartInstanceNamePostRequest(self):
        """Test TypebotStartInstanceNamePostRequest"""
