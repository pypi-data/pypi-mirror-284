...
class TestChatFindContactsInstanceNamePostRequest(unittest.TestCase):
    """ChatFindContactsInstanceNamePostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChatFindContactsInstanceNamePostRequest:
        """Test ChatFindContactsInstanceNamePostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChatFindContactsInstanceNamePostRequest`
        """
        model = ChatFindContactsInstanceNamePostRequest()
        if include_optional:
            return ChatFindContactsInstanceNamePostRequest(
                where = evolution_api_client.models._chat_find_contacts__instance_name__post_request_where._chat_findContacts__instanceName__post_request_where(
                    id = '', )
            )
        else:
            return ChatFindContactsInstanceNamePostRequest(
    ...
    def testChatFindContactsInstanceNamePostRequest(self):
        """Test ChatFindContactsInstanceNamePostRequest"""
