...
class TestMessageSendListInstanceNamePostRequestListMessageSectionsInnerRowsInner(unittest.TestCase):
    """MessageSendListInstanceNamePostRequestListMessageSectionsInnerRowsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MessageSendListInstanceNamePostRequestListMessageSectionsInnerRowsInner:
        """Test MessageSendListInstanceNamePostRequestListMessageSectionsInnerRowsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MessageSendListInstanceNamePostRequestListMessageSectionsInnerRowsInner`
        """
        model = MessageSendListInstanceNamePostRequestListMessageSectionsInnerRowsInner()
        if include_optional:
            return MessageSendListInstanceNamePostRequestListMessageSectionsInnerRowsInner(
                title = '',
                description = '',
                row_id = ''
            )
    ...
    def testMessageSendListInstanceNamePostRequestListMessageSectionsInnerRowsInner(self):
        """Test MessageSendListInstanceNamePostRequestListMessageSectionsInnerRowsInner"""
