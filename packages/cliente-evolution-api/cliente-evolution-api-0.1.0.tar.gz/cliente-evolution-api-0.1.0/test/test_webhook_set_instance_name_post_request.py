...
class TestWebhookSetInstanceNamePostRequest(unittest.TestCase):
    """WebhookSetInstanceNamePostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookSetInstanceNamePostRequest:
        """Test WebhookSetInstanceNamePostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookSetInstanceNamePostRequest`
        """
        model = WebhookSetInstanceNamePostRequest()
        if include_optional:
            return WebhookSetInstanceNamePostRequest(
                url = '',
    ...
    def testWebhookSetInstanceNamePostRequest(self):
        """Test WebhookSetInstanceNamePostRequest"""
