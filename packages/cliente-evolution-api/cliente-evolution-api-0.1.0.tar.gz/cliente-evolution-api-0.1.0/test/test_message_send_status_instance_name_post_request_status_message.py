...
class TestMessageSendStatusInstanceNamePostRequestStatusMessage(unittest.TestCase):
    """MessageSendStatusInstanceNamePostRequestStatusMessage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MessageSendStatusInstanceNamePostRequestStatusMessage:
        """Test MessageSendStatusInstanceNamePostRequestStatusMessage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MessageSendStatusInstanceNamePostRequestStatusMessage`
        """
        model = MessageSendStatusInstanceNamePostRequestStatusMessage()
        if include_optional:
            return MessageSendStatusInstanceNamePostRequestStatusMessage(
                type = 'text',
                content = '',
                background_color = '',
                font = 1,
    ...
    def testMessageSendStatusInstanceNamePostRequestStatusMessage(self):
        """Test MessageSendStatusInstanceNamePostRequestStatusMessage"""
