...
class TestChatUpdateProfileNameInstanceNamePostRequest(unittest.TestCase):
    """ChatUpdateProfileNameInstanceNamePostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChatUpdateProfileNameInstanceNamePostRequest:
        """Test ChatUpdateProfileNameInstanceNamePostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChatUpdateProfileNameInstanceNamePostRequest`
        """
        model = ChatUpdateProfileNameInstanceNamePostRequest()
        if include_optional:
            return ChatUpdateProfileNameInstanceNamePostRequest(
                name = ''
            )
        else:
            return ChatUpdateProfileNameInstanceNamePostRequest(
    ...
    def testChatUpdateProfileNameInstanceNamePostRequest(self):
        """Test ChatUpdateProfileNameInstanceNamePostRequest"""
