...
class TestLabelControllerApi(unittest.TestCase):
    """LabelControllerApi unit test stubs"""

    def setUp(self) -> None:
        self.api = LabelControllerApi()

    def tearDown(self) -> None:
        pass

    def test_label_find_labels_instance_name_get(self) -> None:
        """Test case for label_find_labels_instance_name_get

        List all labels for an instance.
        """
        pass

    def test_label_handle_label_instance_name_put(self) -> None:
        """Test case for label_handle_label_instance_name_put
