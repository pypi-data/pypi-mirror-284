...
class TestChatFetchProfilePictureUrlInstanceNamePostRequest(unittest.TestCase):
    """ChatFetchProfilePictureUrlInstanceNamePostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChatFetchProfilePictureUrlInstanceNamePostRequest:
        """Test ChatFetchProfilePictureUrlInstanceNamePostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChatFetchProfilePictureUrlInstanceNamePostRequest`
        """
        model = ChatFetchProfilePictureUrlInstanceNamePostRequest()
        if include_optional:
            return ChatFetchProfilePictureUrlInstanceNamePostRequest(
                number = ''
            )
        else:
            return ChatFetchProfilePictureUrlInstanceNamePostRequest(
    ...
    def testChatFetchProfilePictureUrlInstanceNamePostRequest(self):
        """Test ChatFetchProfilePictureUrlInstanceNamePostRequest"""
