...
class TestTypebotSetInstanceNamePostRequest(unittest.TestCase):
    """TypebotSetInstanceNamePostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TypebotSetInstanceNamePostRequest:
        """Test TypebotSetInstanceNamePostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TypebotSetInstanceNamePostRequest`
        """
        model = TypebotSetInstanceNamePostRequest()
        if include_optional:
            return TypebotSetInstanceNamePostRequest(
                enabled = True,
                url = '',
                typebot = '',
                expire = 1.337,
    ...
    def testTypebotSetInstanceNamePostRequest(self):
        """Test TypebotSetInstanceNamePostRequest"""
