...
class TestMessageSendReactionInstanceNamePostRequest(unittest.TestCase):
    """MessageSendReactionInstanceNamePostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MessageSendReactionInstanceNamePostRequest:
        """Test MessageSendReactionInstanceNamePostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MessageSendReactionInstanceNamePostRequest`
        """
        model = MessageSendReactionInstanceNamePostRequest()
        if include_optional:
            return MessageSendReactionInstanceNamePostRequest(
                reaction_message = evolution_api_client.models._message_send_reaction__instance_name__post_request_reaction_message._message_sendReaction__instanceName__post_request_reactionMessage(
                    key = evolution_api_client.models._message_send_reaction__instance_name__post_request_reaction_message_key._message_sendReaction__instanceName__post_request_reactionMessage_key(
                        remote_jid = '', 
                        from_me = True, 
                        id = '', ), 
                    reaction = '', )
    ...
    def testMessageSendReactionInstanceNamePostRequest(self):
        """Test MessageSendReactionInstanceNamePostRequest"""
