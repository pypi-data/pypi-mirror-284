...
class TestGroupSendInviteInstanceNamePostRequest(unittest.TestCase):
    """GroupSendInviteInstanceNamePostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GroupSendInviteInstanceNamePostRequest:
        """Test GroupSendInviteInstanceNamePostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroupSendInviteInstanceNamePostRequest`
        """
        model = GroupSendInviteInstanceNamePostRequest()
        if include_optional:
            return GroupSendInviteInstanceNamePostRequest(
                group_jid = '',
                description = '',
                numbers = [
                    ''
    ...
    def testGroupSendInviteInstanceNamePostRequest(self):
        """Test GroupSendInviteInstanceNamePostRequest"""
