...
class TestChatGetBase64FromMediaMessageInstanceNamePostRequest(unittest.TestCase):
    """ChatGetBase64FromMediaMessageInstanceNamePostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChatGetBase64FromMediaMessageInstanceNamePostRequest:
        """Test ChatGetBase64FromMediaMessageInstanceNamePostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChatGetBase64FromMediaMessageInstanceNamePostRequest`
        """
        model = ChatGetBase64FromMediaMessageInstanceNamePostRequest()
        if include_optional:
            return ChatGetBase64FromMediaMessageInstanceNamePostRequest(
                message = evolution_api_client.models._chat_get_base64_from_media_message__instance_name__post_request_message._chat_getBase64FromMediaMessage__instanceName__post_request_message(
                    key = evolution_api_client.models.key.key(), ),
                convert_to_mp4 = True
            )
        else:
            return ChatGetBase64FromMediaMessageInstanceNamePostRequest(
    ...
    def testChatGetBase64FromMediaMessageInstanceNamePostRequest(self):
        """Test ChatGetBase64FromMediaMessageInstanceNamePostRequest"""
