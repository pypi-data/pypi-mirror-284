...
class TestRabbitMQApi(unittest.TestCase):
    """RabbitMQApi unit test stubs"""

    def setUp(self) -> None:
        self.api = RabbitMQApi()

    def tearDown(self) -> None:
        pass

    def test_rabbitmq_find_instance_name_get(self) -> None:
        """Test case for rabbitmq_find_instance_name_get

        Retrieve the RabbitMQ settings for a specific instance.
        """
        pass

    def test_rabbitmq_set_instance_name_post(self) -> None:
        """Test case for rabbitmq_set_instance_name_post
