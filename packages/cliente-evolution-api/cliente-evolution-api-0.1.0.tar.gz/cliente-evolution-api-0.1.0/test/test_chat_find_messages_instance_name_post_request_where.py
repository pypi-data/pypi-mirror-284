...
class TestChatFindMessagesInstanceNamePostRequestWhere(unittest.TestCase):
    """ChatFindMessagesInstanceNamePostRequestWhere unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChatFindMessagesInstanceNamePostRequestWhere:
        """Test ChatFindMessagesInstanceNamePostRequestWhere
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChatFindMessagesInstanceNamePostRequestWhere`
        """
        model = ChatFindMessagesInstanceNamePostRequestWhere()
        if include_optional:
            return ChatFindMessagesInstanceNamePostRequestWhere(
    ...
    def testChatFindMessagesInstanceNamePostRequestWhere(self):
        """Test ChatFindMessagesInstanceNamePostRequestWhere"""
