...
class TestMessageSendReactionInstanceNamePostRequestReactionMessage(unittest.TestCase):
    """MessageSendReactionInstanceNamePostRequestReactionMessage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MessageSendReactionInstanceNamePostRequestReactionMessage:
        """Test MessageSendReactionInstanceNamePostRequestReactionMessage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MessageSendReactionInstanceNamePostRequestReactionMessage`
        """
        model = MessageSendReactionInstanceNamePostRequestReactionMessage()
        if include_optional:
            return MessageSendReactionInstanceNamePostRequestReactionMessage(
    ...
    def testMessageSendReactionInstanceNamePostRequestReactionMessage(self):
        """Test MessageSendReactionInstanceNamePostRequestReactionMessage"""
