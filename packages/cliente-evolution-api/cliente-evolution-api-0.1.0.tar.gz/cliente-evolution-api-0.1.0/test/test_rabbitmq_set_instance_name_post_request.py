...
class TestRabbitmqSetInstanceNamePostRequest(unittest.TestCase):
    """RabbitmqSetInstanceNamePostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RabbitmqSetInstanceNamePostRequest:
        """Test RabbitmqSetInstanceNamePostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RabbitmqSetInstanceNamePostRequest`
        """
        model = RabbitmqSetInstanceNamePostRequest()
        if include_optional:
            return RabbitmqSetInstanceNamePostRequest(
                enabled = True,
    ...
    def testRabbitmqSetInstanceNamePostRequest(self):
        """Test RabbitmqSetInstanceNamePostRequest"""
