...
class TestMessageSendStickerInstanceNamePostRequest(unittest.TestCase):
    """MessageSendStickerInstanceNamePostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MessageSendStickerInstanceNamePostRequest:
        """Test MessageSendStickerInstanceNamePostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MessageSendStickerInstanceNamePostRequest`
        """
        model = MessageSendStickerInstanceNamePostRequest()
        if include_optional:
            return MessageSendStickerInstanceNamePostRequest(
                number = '1234567890',
                sticker_message = evolution_api_client.models._message_send_sticker__instance_name__post_request_sticker_message._message_sendSticker__instanceName__post_request_stickerMessage(
                    image = '', ),
                options = evolution_api_client.models._message_send_sticker__instance_name__post_request_options._message_sendSticker__instanceName__post_request_options(
                    delay = 56, 
                    presence = 'composing', )
            )
        else:
    ...
    def testMessageSendStickerInstanceNamePostRequest(self):
        """Test MessageSendStickerInstanceNamePostRequest"""
