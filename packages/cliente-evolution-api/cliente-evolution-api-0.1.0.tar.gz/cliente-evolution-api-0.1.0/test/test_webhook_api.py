...
class TestWebhookApi(unittest.TestCase):
    ...
    def test_webhook_find_instance_name_get(self) -> None:
        """Test case for webhook_find_instance_name_get

        Retrieve the webhook settings for a specific instance.
        """
        pass

    def test_webhook_set_instance_name_post(self) -> None:
        """Test case for webhook_set_instance_name_post
