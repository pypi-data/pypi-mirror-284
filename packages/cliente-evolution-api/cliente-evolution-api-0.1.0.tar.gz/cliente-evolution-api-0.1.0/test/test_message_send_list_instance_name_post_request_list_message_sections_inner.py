...
class TestMessageSendListInstanceNamePostRequestListMessageSectionsInner(unittest.TestCase):
    """MessageSendListInstanceNamePostRequestListMessageSectionsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MessageSendListInstanceNamePostRequestListMessageSectionsInner:
        """Test MessageSendListInstanceNamePostRequestListMessageSectionsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MessageSendListInstanceNamePostRequestListMessageSectionsInner`
        """
        model = MessageSendListInstanceNamePostRequestListMessageSectionsInner()
        if include_optional:
            return MessageSendListInstanceNamePostRequestListMessageSectionsInner(
                title = '',
                rows = [
    ...
    def testMessageSendListInstanceNamePostRequestListMessageSectionsInner(self):
        """Test MessageSendListInstanceNamePostRequestListMessageSectionsInner"""
