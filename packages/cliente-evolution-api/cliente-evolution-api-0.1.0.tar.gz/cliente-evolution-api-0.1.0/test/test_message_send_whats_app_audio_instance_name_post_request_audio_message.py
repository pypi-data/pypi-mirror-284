...
class TestMessageSendWhatsAppAudioInstanceNamePostRequestAudioMessage(unittest.TestCase):
    """MessageSendWhatsAppAudioInstanceNamePostRequestAudioMessage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MessageSendWhatsAppAudioInstanceNamePostRequestAudioMessage:
        """Test MessageSendWhatsAppAudioInstanceNamePostRequestAudioMessage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MessageSendWhatsAppAudioInstanceNamePostRequestAudioMessage`
        """
        model = MessageSendWhatsAppAudioInstanceNamePostRequestAudioMessage()
        if include_optional:
            return MessageSendWhatsAppAudioInstanceNamePostRequestAudioMessage(
                audio = ''
            )
        else:
            return MessageSendWhatsAppAudioInstanceNamePostRequestAudioMessage(
    ...
    def testMessageSendWhatsAppAudioInstanceNamePostRequestAudioMessage(self):
        """Test MessageSendWhatsAppAudioInstanceNamePostRequestAudioMessage"""
