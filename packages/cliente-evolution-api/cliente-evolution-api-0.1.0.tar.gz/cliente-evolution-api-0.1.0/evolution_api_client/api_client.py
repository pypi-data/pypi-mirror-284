...
from evolution_api_client.api_response import ApiResponse, T as ApiResponseT
import evolution_api_client.models
from evolution_api_client import rest
from evolution_api_client.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(evolution_api_client.models, klass)
