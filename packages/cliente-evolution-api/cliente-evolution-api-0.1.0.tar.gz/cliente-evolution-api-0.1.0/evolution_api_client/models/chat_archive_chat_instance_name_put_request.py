...
class ChatArchiveChatInstanceNamePutRequest(BaseModel):
    """
    ChatArchiveChatInstanceNamePutRequest
    """ # noqa: E501
    last_message: ChatArchiveChatInstanceNamePutRequestLastMessage = Field(alias="lastMessage")
    archive: StrictBool = Field(description="Indicates whether to archive the chat.")
    __properties: ClassVar[List[str]] = ["lastMessage", "archive"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChatArchiveChatInstanceNamePutRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChatArchiveChatInstanceNamePutRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "lastMessage": ChatArchiveChatInstanceNamePutRequestLastMessage.from_dict(obj["lastMessage"]) if obj.get("lastMessage") is not None else None,
