...
class ChatFindContactsInstanceNamePostRequestWhere(BaseModel):
    """
    ChatFindContactsInstanceNamePostRequestWhere
    """ # noqa: E501
    id: StrictStr = Field(description="Unique ID of the contact to be fetched.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChatFindContactsInstanceNamePostRequestWhere from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChatFindContactsInstanceNamePostRequestWhere from a dict"""
        if obj is None:
            return None
