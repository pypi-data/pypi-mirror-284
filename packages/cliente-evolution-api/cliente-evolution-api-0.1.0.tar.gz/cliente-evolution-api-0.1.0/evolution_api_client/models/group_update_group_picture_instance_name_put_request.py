...
class GroupUpdateGroupPictureInstanceNamePutRequest(BaseModel):
    """
    GroupUpdateGroupPictureInstanceNamePutRequest
    """ # noqa: E501
    image: Optional[StrictStr] = Field(default=None, description="- required - URL of the new group picture.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GroupUpdateGroupPictureInstanceNamePutRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GroupUpdateGroupPictureInstanceNamePutRequest from a dict"""
        if obj is None:
            return None
