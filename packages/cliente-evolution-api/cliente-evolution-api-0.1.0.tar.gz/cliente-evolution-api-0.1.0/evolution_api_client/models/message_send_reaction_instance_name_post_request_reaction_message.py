...
class MessageSendReactionInstanceNamePostRequestReactionMessage(BaseModel):
    """
    MessageSendReactionInstanceNamePostRequestReactionMessage
    """ # noqa: E501
    key: Optional[MessageSendReactionInstanceNamePostRequestReactionMessageKey] = None
    reaction: Annotated[str, Field(strict=True, max_length=1)] = Field(description="Reaction character (e.g., emoji).")
    __properties: ClassVar[List[str]] = ["key", "reaction"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MessageSendReactionInstanceNamePostRequestReactionMessage from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MessageSendReactionInstanceNamePostRequestReactionMessage from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "key": MessageSendReactionInstanceNamePostRequestReactionMessageKey.from_dict(obj["key"]) if obj.get("key") is not None else None,
