...
class InstanceFetchInstancesGet200ResponseInner(BaseModel):
    """
    InstanceFetchInstancesGet200ResponseInner
    """ # noqa: E501
    instance: Optional[InstanceFetchInstancesGet200ResponseInnerInstance] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InstanceFetchInstancesGet200ResponseInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InstanceFetchInstancesGet200ResponseInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "instance": InstanceFetchInstancesGet200ResponseInnerInstance.from_dict(obj["instance"]) if obj.get("instance") is not None else None
        })
        return _obj
