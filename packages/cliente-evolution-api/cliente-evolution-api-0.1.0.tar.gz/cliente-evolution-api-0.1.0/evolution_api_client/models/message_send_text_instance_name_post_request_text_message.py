...
class MessageSendTextInstanceNamePostRequestTextMessage(BaseModel):
    """
    MessageSendTextInstanceNamePostRequestTextMessage
    """ # noqa: E501
    text: Optional[StrictStr] = Field(default=None, description="The content of the text message.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MessageSendTextInstanceNamePostRequestTextMessage from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MessageSendTextInstanceNamePostRequestTextMessage from a dict"""
        if obj is None:
            return None
