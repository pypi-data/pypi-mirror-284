...
class GroupUpdateGroupDescriptionInstanceNamePutRequest(BaseModel):
    """
    GroupUpdateGroupDescriptionInstanceNamePutRequest
    """ # noqa: E501
    description: Optional[StrictStr] = Field(default=None, description="- required - The new description of the group.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GroupUpdateGroupDescriptionInstanceNamePutRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GroupUpdateGroupDescriptionInstanceNamePutRequest from a dict"""
        if obj is None:
            return None
