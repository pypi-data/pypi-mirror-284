...
class ChatMarkMessageAsReadInstanceNamePutRequestReadMessagesInner(BaseModel):
    """
    ChatMarkMessageAsReadInstanceNamePutRequestReadMessagesInner
    """ # noqa: E501
    remote_jid: StrictStr = Field(description="ID of the recipient of the message.", alias="remoteJid")
    from_me: StrictBool = Field(description="Indicates if the message was sent from the user.", alias="fromMe")
    id: StrictStr = Field(description="Unique ID of the message.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChatMarkMessageAsReadInstanceNamePutRequestReadMessagesInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChatMarkMessageAsReadInstanceNamePutRequestReadMessagesInner from a dict"""
        if obj is None:
            return None
