...
class MessageSendWhatsAppAudioInstanceNamePostRequest(BaseModel):
    """
    MessageSendWhatsAppAudioInstanceNamePostRequest
    """ # noqa: E501
    number: StrictStr = Field(description="The recipient's phone number.")
    audio_message: Optional[MessageSendWhatsAppAudioInstanceNamePostRequestAudioMessage] = Field(default=None, alias="audioMessage")
    options: Optional[MessageSendTextInstanceNamePostRequestOptions] = None
    __properties: ClassVar[List[str]] = ["number", "audioMessage", "options"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MessageSendWhatsAppAudioInstanceNamePostRequest from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of audio_message
        if self.audio_message:
            _dict['audioMessage'] = self.audio_message.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MessageSendWhatsAppAudioInstanceNamePostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "audioMessage": MessageSendWhatsAppAudioInstanceNamePostRequestAudioMessage.from_dict(obj["audioMessage"]) if obj.get("audioMessage") is not None else None,
