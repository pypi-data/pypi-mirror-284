...
class ChatUpdateProfilePictureInstanceNamePutRequest(BaseModel):
    """
    ChatUpdateProfilePictureInstanceNamePutRequest
    """ # noqa: E501
    picture: Optional[StrictStr] = Field(default=None, description="- required - The new profile picture of the contact.")
    __properties: ClassVar[List[str]] = ["picture"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChatUpdateProfilePictureInstanceNamePutRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChatUpdateProfilePictureInstanceNamePutRequest from a dict"""
        if obj is None:
            return None
