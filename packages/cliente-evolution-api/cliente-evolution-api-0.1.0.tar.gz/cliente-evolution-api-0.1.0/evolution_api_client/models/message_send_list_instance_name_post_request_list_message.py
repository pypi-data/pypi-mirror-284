...
class MessageSendListInstanceNamePostRequestListMessage(BaseModel):
    """
    ...
    sections: Optional[List[MessageSendListInstanceNamePostRequestListMessageSectionsInner]] = None
    __properties: ClassVar[List[str]] = ["title", "description", "footerText", "buttonText", "sections"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MessageSendListInstanceNamePostRequestListMessage from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MessageSendListInstanceNamePostRequestListMessage from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "sections": [MessageSendListInstanceNamePostRequestListMessageSectionsInner.from_dict(_item) for _item in obj["sections"]] if obj.get("sections") is not None else None
        })
        return _obj
