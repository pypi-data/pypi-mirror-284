...
class GroupUpdateGroupSubjectInstanceNamePutRequest(BaseModel):
    """
    GroupUpdateGroupSubjectInstanceNamePutRequest
    """ # noqa: E501
    subject: Optional[StrictStr] = Field(default=None, description="- required - The new name of the group.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GroupUpdateGroupSubjectInstanceNamePutRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GroupUpdateGroupSubjectInstanceNamePutRequest from a dict"""
        if obj is None:
            return None
