...
class MessageSendStickerInstanceNamePostRequest(BaseModel):
    """
    MessageSendStickerInstanceNamePostRequest
    """ # noqa: E501
    number: StrictStr = Field(description="The recipient's phone number.")
    sticker_message: Optional[MessageSendStickerInstanceNamePostRequestStickerMessage] = Field(default=None, alias="stickerMessage")
    options: Optional[MessageSendStickerInstanceNamePostRequestOptions] = None
    __properties: ClassVar[List[str]] = ["number", "stickerMessage", "options"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MessageSendStickerInstanceNamePostRequest from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of sticker_message
        if self.sticker_message:
            _dict['stickerMessage'] = self.sticker_message.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MessageSendStickerInstanceNamePostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "stickerMessage": MessageSendStickerInstanceNamePostRequestStickerMessage.from_dict(obj["stickerMessage"]) if obj.get("stickerMessage") is not None else None,
            "options": MessageSendStickerInstanceNamePostRequestOptions.from_dict(obj["options"]) if obj.get("options") is not None else None
        })
        return _obj
