...
class MessageSendPollInstanceNamePostRequest(BaseModel):
    """
    ...
    poll_message: Optional[MessageSendPollInstanceNamePostRequestPollMessage] = Field(default=None, alias="pollMessage")
    options: Optional[MessageSendTextInstanceNamePostRequestOptions] = None
    __properties: ClassVar[List[str]] = ["number", "pollMessage", "options"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MessageSendPollInstanceNamePostRequest from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of poll_message
        if self.poll_message:
            _dict['pollMessage'] = self.poll_message.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MessageSendPollInstanceNamePostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "pollMessage": MessageSendPollInstanceNamePostRequestPollMessage.from_dict(obj["pollMessage"]) if obj.get("pollMessage") is not None else None,
