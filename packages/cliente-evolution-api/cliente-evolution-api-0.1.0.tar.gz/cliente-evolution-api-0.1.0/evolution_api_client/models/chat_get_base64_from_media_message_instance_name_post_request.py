...
class ChatGetBase64FromMediaMessageInstanceNamePostRequest(BaseModel):
    """
    ChatGetBase64FromMediaMessageInstanceNamePostRequest
    """ # noqa: E501
    message: Optional[ChatGetBase64FromMediaMessageInstanceNamePostRequestMessage] = None
    convert_to_mp4: Optional[StrictBool] = Field(default=None, description="Indicates whether to convert the media to MP4 format.", alias="convertToMp4")
    __properties: ClassVar[List[str]] = ["message", "convertToMp4"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChatGetBase64FromMediaMessageInstanceNamePostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChatGetBase64FromMediaMessageInstanceNamePostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "message": ChatGetBase64FromMediaMessageInstanceNamePostRequestMessage.from_dict(obj["message"]) if obj.get("message") is not None else None,
            "convertToMp4": obj.get("convertToMp4")
        })
        return _obj
