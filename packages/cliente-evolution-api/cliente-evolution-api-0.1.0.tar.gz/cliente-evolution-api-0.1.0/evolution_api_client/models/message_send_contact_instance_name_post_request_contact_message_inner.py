...
class MessageSendContactInstanceNamePostRequestContactMessageInner(BaseModel):
    """
    MessageSendContactInstanceNamePostRequestContactMessageInner
    """ # noqa: E501
    full_name: StrictStr = Field(description="Full name of the contact.", alias="fullName")
    wuid: StrictStr = Field(description="Unique identifier for the contact.")
    phone_number: StrictStr = Field(description="Phone number of the contact.", alias="phoneNumber")
    organization: Optional[StrictStr] = Field(default=None, description="Organization of the contact.")
    email: Optional[StrictStr] = Field(default=None, description="Email address of the contact.")
    url: Optional[StrictStr] = Field(default=None, description="Url of the contact.")
    __properties: ClassVar[List[str]] = ["fullName", "wuid", "phoneNumber", "organization", "email", "url"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MessageSendContactInstanceNamePostRequestContactMessageInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MessageSendContactInstanceNamePostRequestContactMessageInner from a dict"""
        if obj is None:
            return None
