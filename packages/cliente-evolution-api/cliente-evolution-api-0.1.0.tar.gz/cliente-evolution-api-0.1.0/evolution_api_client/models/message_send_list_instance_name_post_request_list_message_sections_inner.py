...
class MessageSendListInstanceNamePostRequestListMessageSectionsInner(BaseModel):
    """
    MessageSendListInstanceNamePostRequestListMessageSectionsInner
    """ # noqa: E501
    title: Optional[StrictStr] = None
    rows: Optional[List[MessageSendListInstanceNamePostRequestListMessageSectionsInnerRowsInner]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MessageSendListInstanceNamePostRequestListMessageSectionsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MessageSendListInstanceNamePostRequestListMessageSectionsInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "title": obj.get("title"),
            "rows": [MessageSendListInstanceNamePostRequestListMessageSectionsInnerRowsInner.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
        return _obj
