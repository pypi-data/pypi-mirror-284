...
class MessageSendMediaInstanceNamePostRequest(BaseModel):
    """
    MessageSendMediaInstanceNamePostRequest
    """ # noqa: E501
    number: Optional[StrictStr] = Field(default=None, description="The recipient's phone number.")
    media_message: Optional[MessageSendMediaInstanceNamePostRequestMediaMessage] = Field(default=None, alias="mediaMessage")
    options: Optional[MessageSendTextInstanceNamePostRequestOptions] = None
    __properties: ClassVar[List[str]] = ["number", "mediaMessage", "options"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MessageSendMediaInstanceNamePostRequest from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of media_message
        if self.media_message:
            _dict['mediaMessage'] = self.media_message.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MessageSendMediaInstanceNamePostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "mediaMessage": MessageSendMediaInstanceNamePostRequestMediaMessage.from_dict(obj["mediaMessage"]) if obj.get("mediaMessage") is not None else None,
