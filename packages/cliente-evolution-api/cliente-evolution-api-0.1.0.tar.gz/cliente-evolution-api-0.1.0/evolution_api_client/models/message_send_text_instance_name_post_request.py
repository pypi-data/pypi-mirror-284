...
class MessageSendTextInstanceNamePostRequest(BaseModel):
    """
    MessageSendTextInstanceNamePostRequest
    """ # noqa: E501
    number: StrictStr = Field(description="The recipient's phone number.")
    text_message: MessageSendTextInstanceNamePostRequestTextMessage = Field(alias="textMessage")
    options: Optional[MessageSendTextInstanceNamePostRequestOptions] = None
    __properties: ClassVar[List[str]] = ["number", "textMessage", "options"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MessageSendTextInstanceNamePostRequest from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of text_message
        if self.text_message:
            _dict['textMessage'] = self.text_message.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MessageSendTextInstanceNamePostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "textMessage": MessageSendTextInstanceNamePostRequestTextMessage.from_dict(obj["textMessage"]) if obj.get("textMessage") is not None else None,
