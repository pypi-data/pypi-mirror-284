...
class ChatFetchProfilePictureUrlInstanceNamePostRequest(BaseModel):
    """
    ChatFetchProfilePictureUrlInstanceNamePostRequest
    """ # noqa: E501
    number: StrictStr = Field(description="WhatsApp phone number whose profile picture URL needs to be fetched.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChatFetchProfilePictureUrlInstanceNamePostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChatFetchProfilePictureUrlInstanceNamePostRequest from a dict"""
        if obj is None:
            return None
