...
class GroupUpdateParticipantInstanceNamePutRequest(BaseModel):
    """
    GroupUpdateParticipantInstanceNamePutRequest
    """ # noqa: E501
    action: Optional[StrictStr] = Field(default=None, description="- required - The action to be taken on the participant.")
    participants: Optional[List[StrictStr]] = Field(default=None, description="- required - List of participant phone numbers to be updated.")
    __properties: ClassVar[List[str]] = ["action", "participants"]
    ...
    def action_validate_enum(cls, value):
        ...
        if value not in set(['add', 'remove', 'promote', 'demote']):
            raise ValueError("must be one of enum values ('add', 'remove', 'promote', 'demote')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GroupUpdateParticipantInstanceNamePutRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GroupUpdateParticipantInstanceNamePutRequest from a dict"""
        if obj is None:
            return None
