...
class ChatFindContactsInstanceNamePostRequest(BaseModel):
    """
    ChatFindContactsInstanceNamePostRequest
    """ # noqa: E501
    where: Optional[ChatFindContactsInstanceNamePostRequestWhere] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChatFindContactsInstanceNamePostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChatFindContactsInstanceNamePostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "where": ChatFindContactsInstanceNamePostRequestWhere.from_dict(obj["where"]) if obj.get("where") is not None else None
        })
        return _obj
