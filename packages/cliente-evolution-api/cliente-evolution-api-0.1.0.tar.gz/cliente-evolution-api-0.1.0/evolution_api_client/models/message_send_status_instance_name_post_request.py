...
class MessageSendStatusInstanceNamePostRequest(BaseModel):
    """
    MessageSendStatusInstanceNamePostRequest
    """ # noqa: E501
    status_message: Optional[MessageSendStatusInstanceNamePostRequestStatusMessage] = Field(default=None, alias="statusMessage")
    __properties: ClassVar[List[str]] = ["statusMessage"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MessageSendStatusInstanceNamePostRequest from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.status_message:
            _dict['statusMessage'] = self.status_message.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MessageSendStatusInstanceNamePostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "statusMessage": MessageSendStatusInstanceNamePostRequestStatusMessage.from_dict(obj["statusMessage"]) if obj.get("statusMessage") is not None else None
        })
        return _obj
