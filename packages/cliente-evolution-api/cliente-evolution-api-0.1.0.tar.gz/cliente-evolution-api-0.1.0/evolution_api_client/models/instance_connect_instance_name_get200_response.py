...
class InstanceConnectInstanceNameGet200Response(BaseModel):
    """
    InstanceConnectInstanceNameGet200Response
    """ # noqa: E501
    code: Optional[StrictStr] = None
    var_base64: Optional[StrictStr] = Field(default=None, description="The QR Code as a string.", alias="base64")
    __properties: ClassVar[List[str]] = ["code", "base64"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InstanceConnectInstanceNameGet200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InstanceConnectInstanceNameGet200Response from a dict"""
        if obj is None:
            return None
