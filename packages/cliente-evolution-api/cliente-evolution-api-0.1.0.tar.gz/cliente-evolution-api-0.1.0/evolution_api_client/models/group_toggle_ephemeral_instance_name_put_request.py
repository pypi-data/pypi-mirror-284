...
class GroupToggleEphemeralInstanceNamePutRequest(BaseModel):
    """
    GroupToggleEphemeralInstanceNamePutRequest
    """ # noqa: E501
    expiration: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="- required - The action to be taken on the participant.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GroupToggleEphemeralInstanceNamePutRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GroupToggleEphemeralInstanceNamePutRequest from a dict"""
        if obj is None:
            return None
