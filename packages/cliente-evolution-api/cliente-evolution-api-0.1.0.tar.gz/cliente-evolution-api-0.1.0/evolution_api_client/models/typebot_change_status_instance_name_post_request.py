...
class TypebotChangeStatusInstanceNamePostRequest(BaseModel):
    """
    ...
    status: Optional[StrictStr] = Field(default=None, description="The Typebot Status.")
    __properties: ClassVar[List[str]] = ["remoteJid", "status"]
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['opened', 'paused', 'closed']):
            raise ValueError("must be one of enum values ('opened', 'paused', 'closed')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TypebotChangeStatusInstanceNamePostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TypebotChangeStatusInstanceNamePostRequest from a dict"""
        if obj is None:
            return None
