...
class ChamaaiSetInstanceNamePostRequest(BaseModel):
    """
    ChamaaiSetInstanceNamePostRequest
    """ # noqa: E501
    enabled: Optional[StrictBool] = Field(default=None, description="Indicates whether to enable the Chamai AI integration.")
    url: Optional[StrictStr] = Field(default=None, description="The Chamai AI URL.")
    token: Optional[StrictStr] = Field(default=None, description="The Chamai AI Token.")
    wa_number: Optional[StrictStr] = Field(default=None, description="The Chamai AI WhatsApp Number.", alias="waNumber")
    answer_by_audio: Optional[StrictBool] = Field(default=None, description="Indicates whether to answer by audio.", alias="answerByAudio")
    __properties: ClassVar[List[str]] = ["enabled", "url", "token", "waNumber", "answerByAudio"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChamaaiSetInstanceNamePostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChamaaiSetInstanceNamePostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "url": obj.get("url"),
            "token": obj.get("token"),
            "waNumber": obj.get("waNumber"),
            "answerByAudio": obj.get("answerByAudio")
        })
        return _obj
