...
class ChatUpdatePrivacySettingsInstanceNamePutRequest(BaseModel):
    """
    ChatUpdatePrivacySettingsInstanceNamePutRequest
    """ # noqa: E501
    privacy_settings: Optional[ChatUpdatePrivacySettingsInstanceNamePutRequestPrivacySettings] = Field(default=None, alias="privacySettings")
    __properties: ClassVar[List[str]] = ["privacySettings"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChatUpdatePrivacySettingsInstanceNamePutRequest from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of privacy_settings
        if self.privacy_settings:
            _dict['privacySettings'] = self.privacy_settings.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChatUpdatePrivacySettingsInstanceNamePutRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "privacySettings": ChatUpdatePrivacySettingsInstanceNamePutRequestPrivacySettings.from_dict(obj["privacySettings"]) if obj.get("privacySettings") is not None else None
        })
        return _obj
