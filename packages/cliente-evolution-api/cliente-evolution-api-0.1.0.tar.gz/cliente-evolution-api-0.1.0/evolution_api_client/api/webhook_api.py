...
class WebhookApi:
    ...
    @validate_call
    def webhook_find_instance_name_get(
        self,
        ...
        """Retrieve the webhook settings for a specific instance.
        ...
        _param = self._webhook_find_instance_name_get_serialize(
    ...
    @validate_call
    def webhook_find_instance_name_get_with_http_info(
        self,
        instance_name: Annotated[StrictStr, Field(description="- required")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def webhook_find_instance_name_get_without_preload_content(
        self,
        instance_name: Annotated[StrictStr, Field(description="- required")],
        _request_timeout: Union[
            None,
    ...
    def _webhook_find_instance_name_get_serialize(
        self,
        instance_name,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/webhook/find/{instanceName}',
    ...
    @validate_call
    def webhook_set_instance_name_post(
        self,
        instance_name: Annotated[StrictStr, Field(description="- required")],
        webhook_set_instance_name_post_request: WebhookSetInstanceNamePostRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param instance_name: - required (required)
        :type instance_name: str
        :param webhook_set_instance_name_post_request: (required)
        :type webhook_set_instance_name_post_request: WebhookSetInstanceNamePostRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._webhook_set_instance_name_post_serialize(
            instance_name=instance_name,
            webhook_set_instance_name_post_request=webhook_set_instance_name_post_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def webhook_set_instance_name_post_with_http_info(
        self,
        instance_name: Annotated[StrictStr, Field(description="- required")],
        webhook_set_instance_name_post_request: WebhookSetInstanceNamePostRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def webhook_set_instance_name_post_without_preload_content(
        self,
        instance_name: Annotated[StrictStr, Field(description="- required")],
        webhook_set_instance_name_post_request: WebhookSetInstanceNamePostRequest,
        _request_timeout: Union[
    ...
    def _webhook_set_instance_name_post_serialize(
        self,
        instance_name,
        webhook_set_instance_name_post_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if webhook_set_instance_name_post_request is not None:
            _body_params = webhook_set_instance_name_post_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/webhook/set/{instanceName}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
