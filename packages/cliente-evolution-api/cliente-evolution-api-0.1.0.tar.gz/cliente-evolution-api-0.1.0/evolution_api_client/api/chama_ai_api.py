...
class ChamaAIApi:
    ...
    @validate_call
    def chamaai_find_instance_name_get(
        self,
        ...
        _param = self._chamaai_find_instance_name_get_serialize(
    ...
    @validate_call
    def chamaai_find_instance_name_get_with_http_info(
        self,
        instance_name: Annotated[StrictStr, Field(description="- required")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def chamaai_find_instance_name_get_without_preload_content(
        self,
        instance_name: Annotated[StrictStr, Field(description="- required")],
        _request_timeout: Union[
            None,
    ...
    def _chamaai_find_instance_name_get_serialize(
        self,
        instance_name,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/chamaai/find/{instanceName}',
    ...
    @validate_call
    def chamaai_set_instance_name_post(
        self,
        instance_name: Annotated[StrictStr, Field(description="- required")],
        chamaai_set_instance_name_post_request: ChamaaiSetInstanceNamePostRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        """Set up or modify the Chama AI for an instance.


        :param instance_name: - required (required)
        :type instance_name: str
        :param chamaai_set_instance_name_post_request: (required)
        :type chamaai_set_instance_name_post_request: ChamaaiSetInstanceNamePostRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._chamaai_set_instance_name_post_serialize(
            instance_name=instance_name,
            chamaai_set_instance_name_post_request=chamaai_set_instance_name_post_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def chamaai_set_instance_name_post_with_http_info(
        self,
        instance_name: Annotated[StrictStr, Field(description="- required")],
        chamaai_set_instance_name_post_request: ChamaaiSetInstanceNamePostRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def chamaai_set_instance_name_post_without_preload_content(
        self,
        instance_name: Annotated[StrictStr, Field(description="- required")],
        chamaai_set_instance_name_post_request: ChamaaiSetInstanceNamePostRequest,
        _request_timeout: Union[
    ...
    def _chamaai_set_instance_name_post_serialize(
        self,
        instance_name,
        chamaai_set_instance_name_post_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if chamaai_set_instance_name_post_request is not None:
            _body_params = chamaai_set_instance_name_post_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/chamaai/set/{instanceName}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
