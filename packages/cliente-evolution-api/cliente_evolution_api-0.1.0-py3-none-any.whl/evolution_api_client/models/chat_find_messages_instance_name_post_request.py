...
class ChatFindMessagesInstanceNamePostRequest(BaseModel):
    """
    ChatFindMessagesInstanceNamePostRequest
    """ # noqa: E501
    where: Optional[ChatFindMessagesInstanceNamePostRequestWhere] = None
    limit: Optional[StrictInt] = Field(default=None, description="Maximum number of messages to retrieve.")
    __properties: ClassVar[List[str]] = ["where", "limit"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChatFindMessagesInstanceNamePostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChatFindMessagesInstanceNamePostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "where": ChatFindMessagesInstanceNamePostRequestWhere.from_dict(obj["where"]) if obj.get("where") is not None else None,
            "limit": obj.get("limit")
        })
        return _obj
