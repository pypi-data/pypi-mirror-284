...
class ChatUpdateProfileStatusInstanceNamePostRequest(BaseModel):
    """
    ChatUpdateProfileStatusInstanceNamePostRequest
    """ # noqa: E501
    status: Optional[StrictStr] = Field(default=None, description="- required - The new status of the contact.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChatUpdateProfileStatusInstanceNamePostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChatUpdateProfileStatusInstanceNamePostRequest from a dict"""
        if obj is None:
            return None
