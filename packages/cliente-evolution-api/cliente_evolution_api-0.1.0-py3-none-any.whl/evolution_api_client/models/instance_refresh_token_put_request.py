...
class InstanceRefreshTokenPutRequest(BaseModel):
    """
    InstanceRefreshTokenPutRequest
    """ # noqa: E501
    old_token: Optional[StrictStr] = Field(default=None, description="- required - The expired JWT token.", alias="oldToken")
    __properties: ClassVar[List[str]] = ["oldToken"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InstanceRefreshTokenPutRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InstanceRefreshTokenPutRequest from a dict"""
        if obj is None:
            return None
