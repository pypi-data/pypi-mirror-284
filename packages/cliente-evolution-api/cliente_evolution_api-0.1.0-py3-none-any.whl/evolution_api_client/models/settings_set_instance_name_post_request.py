...
class SettingsSetInstanceNamePostRequest(BaseModel):
    """
    SettingsSetInstanceNamePostRequest
    """ # noqa: E501
    reject_call: Optional[StrictBool] = Field(default=None, description="Indicates whether to reject incoming calls.")
    msg_call: Optional[StrictStr] = Field(default=None, description="Message to be sent when rejecting a call.")
    groups_ignore: Optional[StrictBool] = Field(default=None, description="Indicates whether to ignore group messages.")
    always_online: Optional[StrictBool] = Field(default=None, description="Indicates whether to keep the instance always online.")
    read_messages: Optional[StrictBool] = Field(default=None, description="Indicates whether to mark messages as read.")
    read_status: Optional[StrictBool] = Field(default=None, description="Indicates whether to mark status messages as read.")
    sync_full_history: Optional[StrictBool] = Field(default=None, description="Indicates whether to request a full history messages sync on connect.")
    __properties: ClassVar[List[str]] = ["reject_call", "msg_call", "groups_ignore", "always_online", "read_messages", "read_status", "sync_full_history"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SettingsSetInstanceNamePostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SettingsSetInstanceNamePostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "reject_call": obj.get("reject_call"),
            "msg_call": obj.get("msg_call"),
            "groups_ignore": obj.get("groups_ignore"),
            "always_online": obj.get("always_online"),
            "read_messages": obj.get("read_messages"),
            "read_status": obj.get("read_status"),
            "sync_full_history": obj.get("sync_full_history")
        })
        return _obj
