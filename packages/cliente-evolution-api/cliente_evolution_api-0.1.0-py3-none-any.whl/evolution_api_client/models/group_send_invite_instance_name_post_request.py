...
class GroupSendInviteInstanceNamePostRequest(BaseModel):
    """
    GroupSendInviteInstanceNamePostRequest
    """ # noqa: E501
    group_jid: Optional[StrictStr] = Field(default=None, description="The unique identifier of the group.", alias="groupJid")
    description: Optional[StrictStr] = Field(default=None, description="The new description of the group.")
    numbers: Optional[List[StrictStr]] = Field(default=None, description="List of participant phone numbers to be invited.")
    __properties: ClassVar[List[str]] = ["groupJid", "description", "numbers"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GroupSendInviteInstanceNamePostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GroupSendInviteInstanceNamePostRequest from a dict"""
        if obj is None:
            return None
