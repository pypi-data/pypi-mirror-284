...
class ChatMarkMessageAsReadInstanceNamePutRequest(BaseModel):
    """
    ChatMarkMessageAsReadInstanceNamePutRequest
    """ # noqa: E501
    read_messages: List[ChatMarkMessageAsReadInstanceNamePutRequestReadMessagesInner]
    __properties: ClassVar[List[str]] = ["read_messages"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChatMarkMessageAsReadInstanceNamePutRequest from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in read_messages (list)
        _items = []
        if self.read_messages:
            for _item in self.read_messages:
                if _item:
                    _items.append(_item.to_dict())
            _dict['read_messages'] = _items
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChatMarkMessageAsReadInstanceNamePutRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "read_messages": [ChatMarkMessageAsReadInstanceNamePutRequestReadMessagesInner.from_dict(_item) for _item in obj["read_messages"]] if obj.get("read_messages") is not None else None
        })
        return _obj
