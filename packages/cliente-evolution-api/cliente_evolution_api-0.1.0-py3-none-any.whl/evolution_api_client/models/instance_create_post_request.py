...
class InstanceCreatePostRequest(BaseModel):
    """
    InstanceCreatePostRequest
    """ # noqa: E501
    instance_name: Optional[StrictStr] = Field(default=None, description="Name of the instance (optional).", alias="instanceName")
    token: Optional[StrictStr] = Field(default=None, description="Token of the instance (optional).")
    qrcode: Optional[StrictBool] = Field(default=None, description="QR Code of the instance (optional).")
    __properties: ClassVar[List[str]] = ["instanceName", "token", "qrcode"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InstanceCreatePostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InstanceCreatePostRequest from a dict"""
        if obj is None:
            return None
