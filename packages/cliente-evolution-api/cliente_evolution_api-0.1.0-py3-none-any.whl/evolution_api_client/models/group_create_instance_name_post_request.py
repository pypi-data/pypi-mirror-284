...
class GroupCreateInstanceNamePostRequest(BaseModel):
    """
    GroupCreateInstanceNamePostRequest
    """ # noqa: E501
    subject: Optional[StrictStr] = Field(default=None, description="- required - The name of the group.")
    description: Optional[StrictStr] = Field(default=None, description="- optional - A brief description or summary of the group.")
    participants: Optional[List[StrictStr]] = Field(default=None, description="- required - List of participant phone numbers.")
    __properties: ClassVar[List[str]] = ["subject", "description", "participants"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GroupCreateInstanceNamePostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GroupCreateInstanceNamePostRequest from a dict"""
        if obj is None:
            return None
