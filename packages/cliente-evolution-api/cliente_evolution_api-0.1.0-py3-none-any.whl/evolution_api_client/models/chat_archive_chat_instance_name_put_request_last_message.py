...
class ChatArchiveChatInstanceNamePutRequestLastMessage(BaseModel):
    """
    ChatArchiveChatInstanceNamePutRequestLastMessage
    """ # noqa: E501
    key: Optional[ChatArchiveChatInstanceNamePutRequestLastMessageKey] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChatArchiveChatInstanceNamePutRequestLastMessage from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChatArchiveChatInstanceNamePutRequestLastMessage from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "key": ChatArchiveChatInstanceNamePutRequestLastMessageKey.from_dict(obj["key"]) if obj.get("key") is not None else None
        })
        return _obj
