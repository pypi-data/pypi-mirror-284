...
class MessageSendContactInstanceNamePostRequest(BaseModel):
    """
    MessageSendContactInstanceNamePostRequest
    """ # noqa: E501
    number: StrictStr = Field(description="The recipient's phone number.")
    contact_message: Optional[List[MessageSendContactInstanceNamePostRequestContactMessageInner]] = Field(default=None, alias="contactMessage")
    options: Optional[MessageSendTextInstanceNamePostRequestOptions] = None
    __properties: ClassVar[List[str]] = ["number", "contactMessage", "options"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MessageSendContactInstanceNamePostRequest from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in contact_message (list)
        _items = []
        if self.contact_message:
            for _item in self.contact_message:
                if _item:
                    _items.append(_item.to_dict())
            _dict['contactMessage'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MessageSendContactInstanceNamePostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "contactMessage": [MessageSendContactInstanceNamePostRequestContactMessageInner.from_dict(_item) for _item in obj["contactMessage"]] if obj.get("contactMessage") is not None else None,
            "options": MessageSendTextInstanceNamePostRequestOptions.from_dict(obj["options"]) if obj.get("options") is not None else None
        })
        return _obj
