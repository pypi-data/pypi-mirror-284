...
class WebhookSetInstanceNamePostRequest(BaseModel):
    """
    WebhookSetInstanceNamePostRequest
    """ # noqa: E501
    url: Optional[StrictStr] = Field(default=None, description="The endpoint URL where the webhook data will be sent.")
    webhook_by_events: Optional[StrictBool] = Field(default=None, description="Indicates whether to send the webhook data by events.")
    webhook_base64: Optional[StrictBool] = Field(default=None, description="Indicates whether to send the webhook data in Base64 format.")
    events: Optional[List[StrictStr]] = Field(default=None, description="List of events to be sent to the webhook.")
    __properties: ClassVar[List[str]] = ["url", "webhook_by_events", "webhook_base64", "events"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WebhookSetInstanceNamePostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WebhookSetInstanceNamePostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "url": obj.get("url"),
            "webhook_by_events": obj.get("webhook_by_events"),
            "webhook_base64": obj.get("webhook_base64"),
