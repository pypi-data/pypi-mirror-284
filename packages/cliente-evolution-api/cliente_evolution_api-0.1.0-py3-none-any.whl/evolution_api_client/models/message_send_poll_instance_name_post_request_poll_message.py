...
class MessageSendPollInstanceNamePostRequestPollMessage(BaseModel):
    """
    MessageSendPollInstanceNamePostRequestPollMessage
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Name or title of the poll.")
    selectable_count: Optional[StrictInt] = Field(default=None, description="Number of selectable options.", alias="selectableCount")
    values: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["name", "selectableCount", "values"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MessageSendPollInstanceNamePostRequestPollMessage from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MessageSendPollInstanceNamePostRequestPollMessage from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "selectableCount": obj.get("selectableCount"),
