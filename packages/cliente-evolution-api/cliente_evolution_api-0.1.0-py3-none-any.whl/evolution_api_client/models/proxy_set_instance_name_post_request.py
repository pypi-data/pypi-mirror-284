...
class ProxySetInstanceNamePostRequest(BaseModel):
    """
    ProxySetInstanceNamePostRequest
    """ # noqa: E501
    enabled: Optional[StrictBool] = Field(default=None, description="Indicates whether to enable the Proxy integration.")
    proxy: Optional[StrictStr] = Field(default=None, description="The Proxy URI.")
    __properties: ClassVar[List[str]] = ["enabled", "proxy"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ProxySetInstanceNamePostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ProxySetInstanceNamePostRequest from a dict"""
        if obj is None:
            return None
