...
class MessageSendTextInstanceNamePostRequestOptionsQuotedMessage(BaseModel):
    """
    MessageSendTextInstanceNamePostRequestOptionsQuotedMessage
    """ # noqa: E501
    conversation: Optional[StrictStr] = Field(default=None, description="The content of the quoted message.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MessageSendTextInstanceNamePostRequestOptionsQuotedMessage from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MessageSendTextInstanceNamePostRequestOptionsQuotedMessage from a dict"""
        if obj is None:
            return None
