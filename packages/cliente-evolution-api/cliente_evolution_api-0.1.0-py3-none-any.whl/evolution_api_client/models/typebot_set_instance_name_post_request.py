...
class TypebotSetInstanceNamePostRequest(BaseModel):
    """
    TypebotSetInstanceNamePostRequest
    """ # noqa: E501
    enabled: Optional[StrictBool] = Field(default=None, description="Indicates whether to enable the Typebot integration.")
    url: Optional[StrictStr] = Field(default=None, description="The Chatwoot URL.")
    typebot: Optional[StrictStr] = Field(default=None, description="The Typebot Name.")
    expire: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The Typebot Expire.")
    keyword_finish: Optional[StrictStr] = Field(default=None, description="The Typebot Keyword Finish.")
    delay_message: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The Typebot Delay Message.")
    unknown_message: Optional[StrictStr] = Field(default=None, description="The Typebot Unknown Message.")
    listening_from_me: Optional[StrictBool] = Field(default=None, description="Indicates whether to listening from me.")
    __properties: ClassVar[List[str]] = ["enabled", "url", "typebot", "expire", "keyword_finish", "delay_message", "unknown_message", "listening_from_me"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TypebotSetInstanceNamePostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TypebotSetInstanceNamePostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "url": obj.get("url"),
            "typebot": obj.get("typebot"),
            "expire": obj.get("expire"),
            "keyword_finish": obj.get("keyword_finish"),
            "delay_message": obj.get("delay_message"),
            "unknown_message": obj.get("unknown_message"),
            "listening_from_me": obj.get("listening_from_me")
        })
        return _obj
