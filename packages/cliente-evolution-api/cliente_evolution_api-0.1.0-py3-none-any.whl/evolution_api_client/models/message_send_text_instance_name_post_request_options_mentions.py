...
class MessageSendTextInstanceNamePostRequestOptionsMentions(BaseModel):
    """
    MessageSendTextInstanceNamePostRequestOptionsMentions
    """ # noqa: E501
    everyone: Optional[StrictBool] = Field(default=None, description="Indicates whether to mention everyone.")
    mentioned: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["everyone", "mentioned"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MessageSendTextInstanceNamePostRequestOptionsMentions from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MessageSendTextInstanceNamePostRequestOptionsMentions from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "everyone": obj.get("everyone"),
            "mentioned": obj.get("mentioned")
        })
        return _obj
