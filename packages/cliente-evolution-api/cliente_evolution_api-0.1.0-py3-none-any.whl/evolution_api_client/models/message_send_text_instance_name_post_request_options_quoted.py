...
class MessageSendTextInstanceNamePostRequestOptionsQuoted(BaseModel):
    """
    MessageSendTextInstanceNamePostRequestOptionsQuoted
    """ # noqa: E501
    key: Optional[MessageSendTextInstanceNamePostRequestOptionsQuotedKey] = None
    message: Optional[MessageSendTextInstanceNamePostRequestOptionsQuotedMessage] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MessageSendTextInstanceNamePostRequestOptionsQuoted from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MessageSendTextInstanceNamePostRequestOptionsQuoted from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "key": MessageSendTextInstanceNamePostRequestOptionsQuotedKey.from_dict(obj["key"]) if obj.get("key") is not None else None,
            "message": MessageSendTextInstanceNamePostRequestOptionsQuotedMessage.from_dict(obj["message"]) if obj.get("message") is not None else None
        })
        return _obj
