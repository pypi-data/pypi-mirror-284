...
class ChatFetchBusinessProfileInstanceNamePostRequest(BaseModel):
    """
    ChatFetchBusinessProfileInstanceNamePostRequest
    """ # noqa: E501
    number: Optional[StrictStr] = Field(default=None, description="- required - The phone number of the contact.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChatFetchBusinessProfileInstanceNamePostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChatFetchBusinessProfileInstanceNamePostRequest from a dict"""
        if obj is None:
            return None
