...
class InstanceFetchInstancesGet200ResponseInnerInstance(BaseModel):
    """
    ...
    profile_status: Optional[StrictStr] = Field(default=None, alias="profileStatus")
    status: Optional[StrictStr] = None
    server_url: Optional[StrictStr] = Field(default=None, alias="serverUrl")
    apikey: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["instanceName", "owner", "profileName", "profilePictureUrl", "profileStatus", "status", "serverUrl", "apikey"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InstanceFetchInstancesGet200ResponseInnerInstance from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InstanceFetchInstancesGet200ResponseInnerInstance from a dict"""
        if obj is None:
            return None
