...
class ChatFindMessagesInstanceNamePostRequestWhere(BaseModel):
    """
    ChatFindMessagesInstanceNamePostRequestWhere
    """ # noqa: E501
    key: ChatMarkMessageAsReadInstanceNamePutRequestReadMessagesInner
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChatFindMessagesInstanceNamePostRequestWhere from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChatFindMessagesInstanceNamePostRequestWhere from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "key": ChatMarkMessageAsReadInstanceNamePutRequestReadMessagesInner.from_dict(obj["key"]) if obj.get("key") is not None else None,
