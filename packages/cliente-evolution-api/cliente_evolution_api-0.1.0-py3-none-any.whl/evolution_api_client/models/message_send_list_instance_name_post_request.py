...
class MessageSendListInstanceNamePostRequest(BaseModel):
    """
    MessageSendListInstanceNamePostRequest
    """ # noqa: E501
    number: Optional[StrictStr] = None
    options: Optional[MessageSendListInstanceNamePostRequestOptions] = None
    list_message: Optional[MessageSendListInstanceNamePostRequestListMessage] = Field(default=None, alias="listMessage")
    __properties: ClassVar[List[str]] = ["number", "options", "listMessage"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MessageSendListInstanceNamePostRequest from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of list_message
        if self.list_message:
            _dict['listMessage'] = self.list_message.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MessageSendListInstanceNamePostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "options": MessageSendListInstanceNamePostRequestOptions.from_dict(obj["options"]) if obj.get("options") is not None else None,
            "listMessage": MessageSendListInstanceNamePostRequestListMessage.from_dict(obj["listMessage"]) if obj.get("listMessage") is not None else None
        })
        return _obj
