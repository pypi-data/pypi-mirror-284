...
class ChatUpdateProfileNameInstanceNamePostRequest(BaseModel):
    """
    ChatUpdateProfileNameInstanceNamePostRequest
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="- required - The new name of the contact.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChatUpdateProfileNameInstanceNamePostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChatUpdateProfileNameInstanceNamePostRequest from a dict"""
        if obj is None:
            return None
