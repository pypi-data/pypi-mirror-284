...
class TypebotStartInstanceNamePostRequest(BaseModel):
    """
    TypebotStartInstanceNamePostRequest
    """ # noqa: E501
    url: Optional[StrictStr] = Field(default=None, description="The Typebot URL.")
    typebot: Optional[StrictStr] = Field(default=None, description="The Typebot Name.")
    remote_jid: Optional[StrictStr] = Field(default=None, description="The Typebot RemoteJid.", alias="remoteJid")
    start_session: Optional[StrictBool] = Field(default=None, description="Indicates whether to start session.", alias="startSession")
    variables: Optional[List[TypebotStartInstanceNamePostRequestVariablesInner]] = Field(default=None, description="List of variables.")
    __properties: ClassVar[List[str]] = ["url", "typebot", "remoteJid", "startSession", "variables"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TypebotStartInstanceNamePostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TypebotStartInstanceNamePostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "remoteJid": obj.get("remoteJid"),
            "startSession": obj.get("startSession"),
            "variables": [TypebotStartInstanceNamePostRequestVariablesInner.from_dict(_item) for _item in obj["variables"]] if obj.get("variables") is not None else None
        })
        return _obj
