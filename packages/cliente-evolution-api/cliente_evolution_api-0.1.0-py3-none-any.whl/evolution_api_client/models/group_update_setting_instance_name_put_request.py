...
class GroupUpdateSettingInstanceNamePutRequest(BaseModel):
    """
    ...
    def action_validate_enum(cls, value):
        ...
        if value not in set(['announcement', 'not_announcement', 'locked', 'unlocked']):
            raise ValueError("must be one of enum values ('announcement', 'not_announcement', 'locked', 'unlocked')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GroupUpdateSettingInstanceNamePutRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GroupUpdateSettingInstanceNamePutRequest from a dict"""
        if obj is None:
            return None
