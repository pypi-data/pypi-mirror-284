...
class ChatFindStatusMessageInstanceNamePostRequestWhere(BaseModel):
    """
    ChatFindStatusMessageInstanceNamePostRequestWhere
    """ # noqa: E501
    id: StrictStr = Field(description="Unique ID of the status message to be fetched.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChatFindStatusMessageInstanceNamePostRequestWhere from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChatFindStatusMessageInstanceNamePostRequestWhere from a dict"""
        if obj is None:
            return None
