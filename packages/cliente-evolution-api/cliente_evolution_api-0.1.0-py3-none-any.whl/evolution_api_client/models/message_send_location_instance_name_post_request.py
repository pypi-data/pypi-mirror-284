...
class MessageSendLocationInstanceNamePostRequest(BaseModel):
    """
    MessageSendLocationInstanceNamePostRequest
    """ # noqa: E501
    number: StrictStr = Field(description="The recipient's phone number.")
    location_message: Optional[MessageSendLocationInstanceNamePostRequestLocationMessage] = Field(default=None, alias="locationMessage")
    options: Optional[MessageSendTextInstanceNamePostRequestOptions] = None
    __properties: ClassVar[List[str]] = ["number", "locationMessage", "options"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MessageSendLocationInstanceNamePostRequest from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of location_message
        if self.location_message:
            _dict['locationMessage'] = self.location_message.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MessageSendLocationInstanceNamePostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "locationMessage": MessageSendLocationInstanceNamePostRequestLocationMessage.from_dict(obj["locationMessage"]) if obj.get("locationMessage") is not None else None,
