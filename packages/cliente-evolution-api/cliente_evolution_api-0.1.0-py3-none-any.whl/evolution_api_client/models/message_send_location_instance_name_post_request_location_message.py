...
class MessageSendLocationInstanceNamePostRequestLocationMessage(BaseModel):
    """
    MessageSendLocationInstanceNamePostRequestLocationMessage
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Name or title of the location.")
    address: Optional[StrictStr] = Field(default=None, description="Detailed address of the location.")
    latitude: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Latitude of the location.")
    longitude: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Longitude of the location.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MessageSendLocationInstanceNamePostRequestLocationMessage from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MessageSendLocationInstanceNamePostRequestLocationMessage from a dict"""
        if obj is None:
            return None
