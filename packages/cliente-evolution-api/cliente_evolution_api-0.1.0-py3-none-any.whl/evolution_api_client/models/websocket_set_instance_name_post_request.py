...
class WebsocketSetInstanceNamePostRequest(BaseModel):
    """
    WebsocketSetInstanceNamePostRequest
    """ # noqa: E501
    enabled: Optional[StrictBool] = Field(default=None, description="Indicates whether to enable the websocket.")
    events: Optional[List[StrictStr]] = Field(default=None, description="List of events to be sent to the websocket.")
    __properties: ClassVar[List[str]] = ["enabled", "events"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WebsocketSetInstanceNamePostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WebsocketSetInstanceNamePostRequest from a dict"""
        if obj is None:
            return None
