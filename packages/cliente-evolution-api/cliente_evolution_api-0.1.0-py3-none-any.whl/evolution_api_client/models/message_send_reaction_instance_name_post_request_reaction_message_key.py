...
class MessageSendReactionInstanceNamePostRequestReactionMessageKey(BaseModel):
    """
    MessageSendReactionInstanceNamePostRequestReactionMessageKey
    """ # noqa: E501
    remote_jid: Optional[StrictStr] = Field(default=None, description="The ID of the recipient of the original message.", alias="remoteJid")
    from_me: Optional[StrictBool] = Field(default=None, description="Indicates if the reaction was sent from the user.", alias="fromMe")
    id: Optional[StrictStr] = Field(default=None, description="The ID of the original message.")
    __properties: ClassVar[List[str]] = ["remoteJid", "fromMe", "id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MessageSendReactionInstanceNamePostRequestReactionMessageKey from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MessageSendReactionInstanceNamePostRequestReactionMessageKey from a dict"""
        if obj is None:
            return None
