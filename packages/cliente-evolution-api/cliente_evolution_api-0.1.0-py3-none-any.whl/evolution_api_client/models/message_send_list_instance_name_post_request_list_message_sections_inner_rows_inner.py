...
class MessageSendListInstanceNamePostRequestListMessageSectionsInnerRowsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["title", "description", "rowId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MessageSendListInstanceNamePostRequestListMessageSectionsInnerRowsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MessageSendListInstanceNamePostRequestListMessageSectionsInnerRowsInner from a dict"""
        if obj is None:
            return None
