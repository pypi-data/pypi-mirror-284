...
class MessageSendWhatsAppAudioInstanceNamePostRequestAudioMessage(BaseModel):
    """
    MessageSendWhatsAppAudioInstanceNamePostRequestAudioMessage
    """ # noqa: E501
    audio: StrictStr = Field(description="URL of the audio file to be sent.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MessageSendWhatsAppAudioInstanceNamePostRequestAudioMessage from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MessageSendWhatsAppAudioInstanceNamePostRequestAudioMessage from a dict"""
        if obj is None:
            return None
