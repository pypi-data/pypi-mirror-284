...
class LabelFindLabelsInstanceNameGet200ResponseInner(BaseModel):
    """
    ...
    name: StrictStr
    id: StrictStr
    predefined_id: Optional[StrictStr] = Field(default=None, alias="predefinedId")
    __properties: ClassVar[List[str]] = ["color", "name", "id", "predefinedId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LabelFindLabelsInstanceNameGet200ResponseInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LabelFindLabelsInstanceNameGet200ResponseInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "id": obj.get("id"),
            "predefinedId": obj.get("predefinedId")
        })
        return _obj
