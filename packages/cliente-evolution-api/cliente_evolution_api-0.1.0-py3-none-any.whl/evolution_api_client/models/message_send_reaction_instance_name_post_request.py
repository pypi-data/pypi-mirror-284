...
class MessageSendReactionInstanceNamePostRequest(BaseModel):
    """
    MessageSendReactionInstanceNamePostRequest
    """ # noqa: E501
    reaction_message: Optional[MessageSendReactionInstanceNamePostRequestReactionMessage] = Field(default=None, alias="reactionMessage")
    __properties: ClassVar[List[str]] = ["reactionMessage"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MessageSendReactionInstanceNamePostRequest from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of reaction_message
        if self.reaction_message:
            _dict['reactionMessage'] = self.reaction_message.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MessageSendReactionInstanceNamePostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "reactionMessage": MessageSendReactionInstanceNamePostRequestReactionMessage.from_dict(obj["reactionMessage"]) if obj.get("reactionMessage") is not None else None
        })
        return _obj
