...
class LabelHandleLabelInstanceNamePut200Response(BaseModel):
    """
    LabelHandleLabelInstanceNamePut200Response
    """ # noqa: E501
    number_jid: StrictStr = Field(alias="numberJid")
    label_id: StrictStr = Field(alias="labelId")
    remove: Optional[StrictBool] = None
    add: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["numberJid", "labelId", "remove", "add"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LabelHandleLabelInstanceNamePut200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LabelHandleLabelInstanceNamePut200Response from a dict"""
        if obj is None:
            return None
