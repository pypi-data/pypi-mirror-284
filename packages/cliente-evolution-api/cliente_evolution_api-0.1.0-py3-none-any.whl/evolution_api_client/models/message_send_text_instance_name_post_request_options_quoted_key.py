...
class MessageSendTextInstanceNamePostRequestOptionsQuotedKey(BaseModel):
    """
    ...
    from_me: Optional[StrictBool] = Field(default=None, description="Indicates if the message was sent from the user.", alias="fromMe")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MessageSendTextInstanceNamePostRequestOptionsQuotedKey from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MessageSendTextInstanceNamePostRequestOptionsQuotedKey from a dict"""
        if obj is None:
            return None
