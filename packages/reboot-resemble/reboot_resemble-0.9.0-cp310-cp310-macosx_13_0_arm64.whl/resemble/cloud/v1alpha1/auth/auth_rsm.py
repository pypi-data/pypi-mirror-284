        ...
        if method == 'Create':
            ...
            while True:
                ...
                try:
                    ...
                    raise APIKey.CreateAborted.from_status(status)
            ...
            while True:
                ...
                try:
                    ...
                    # Reconstitute the error that the server threw, if it was a declared error.
                    status = await rpc_status_async.from_call(call)
                    raise APIKey.RevokeAborted.from_status(status)
...
resemble.cloud.v1alpha1.auth.auth_pb2.InvalidInputError        ]
    ...
    class WeakReference:
        ...
        def __init__(
            ...
            *,
            ...
            self._actor_id = (
                ...
                else resemble.aio.types.ActorId.from_key(APIKey.__state_type_name__, actor_key_or_id)
            )
        ...
        class _Schedule:
            ...
            def __init__(
                self,
                tasks: typing.Callable[[resemble.aio.contexts.TransactionContext | resemble.aio.contexts.WorkflowContext | resemble.aio.workflows.Workflow], APIKeyTasksStub],
                *,
                when: typing.Optional[datetime | timedelta] = None,
...
class APIKeyWeakReferenceNodeAdaptor(APIKey.WeakReference):
