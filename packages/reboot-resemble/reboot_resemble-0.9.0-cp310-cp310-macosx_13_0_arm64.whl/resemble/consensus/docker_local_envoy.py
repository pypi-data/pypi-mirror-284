...
class DockerLocalEnvoy(LocalEnvoy):
    ...
    def __init__(
        ...
        *,
        ...
        self._envoy_dir_name = DOCKERIZED_ENVOY_DIR
        ...
        self._proxied_server_host = 'host.docker.internal'  # Routes traffic back to the host.
    ...
    async def _docker_run_envoy(self) -> None:
        ...
        if self._use_tls:
            local_envoy_run_command += [
                f'--volume={self._tmp_envoy_crt}:{self._envoy_crt}',
                f'--volume={self._tmp_envoy_key}:{self._envoy_key}',
            ]

        local_envoy_run_command += [
            '--add-host=host.docker.internal:host-gateway',
            f'--volume={self._tmp_envoy_config}:{self._envoy_config}:ro',
