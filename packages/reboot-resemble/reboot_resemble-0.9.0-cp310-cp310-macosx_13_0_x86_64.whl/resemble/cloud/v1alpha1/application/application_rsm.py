        ...
        if method == 'Create':
            ...
            while True:
                ...
                try:
                    ...
                    raise Application.CreateAborted.from_status(status)
            ...
            while True:
                ...
                try:
                    ...
                    # Reconstitute the error that the server threw, if it was a declared error.
                    status = await rpc_status_async.from_call(call)
                    raise Application.UpAborted.from_status(status)
            ...
            while True:
                ...
                try:
                    ...
                    # Reconstitute the error that the server threw, if it was a declared error.
                    status = await rpc_status_async.from_call(call)
                    raise Application.UpTaskAborted.from_status(status)
            ...
            while True:
                ...
                try:
                    ...
                    # Reconstitute the error that the server threw, if it was a declared error.
                    status = await rpc_status_async.from_call(call)
                    raise Application.DownAborted.from_status(status)
            ...
            while True:
                ...
                try:
                    ...
                    # Reconstitute the error that the server threw, if it was a declared error.
                    status = await rpc_status_async.from_call(call)
                    raise Application.DownTaskAborted.from_status(status)
...
resemble.cloud.v1alpha1.application.application_pb2.InvalidInputError        ]
    ...
    class WeakReference:
        ...
        def __init__(
            ...
            *,
            ...
            self._actor_id = (
                ...
                else resemble.aio.types.ActorId.from_key(Application.__state_type_name__, actor_key_or_id)
            )
        ...
        class _Schedule:
            ...
            def __init__(
                self,
                tasks: typing.Callable[[resemble.aio.contexts.TransactionContext | resemble.aio.contexts.WorkflowContext | resemble.aio.workflows.Workflow], ApplicationTasksStub],
                *,
                when: typing.Optional[datetime | timedelta] = None,
...
class ApplicationWeakReferenceNodeAdaptor(Application.WeakReference):
