...
class SortedMapServicerMiddleware(resemble.aio.internals.middleware.Middleware):
    ...
    async def react_mutate(
        ...
        if method == 'Insert':
            ...
            while True:
                ...
                stub = resemble.integrations.collections.v1.sorted_map_pb2_grpc.SortedMapInterfaceStub(
                ...
                try:
                    ...
                    raise SortedMap.InsertAborted.from_status(status)
            ...
            while True:
                ...
                try:
                    ...
                    # Reconstitute the error that the server threw, if it was a declared error.
                    status = await rpc_status_async.from_call(call)
                    raise SortedMap.RemoveAborted.from_status(status)
            ...
            async def run_Insert(
                ...
                async with self._state_manager.task_workflow(
                    ...
                    response = await (SortedMapWorkflowStub(
                        ...
                        typing.cast(resemble.integrations.collections.v1.sorted_map_pb2.InsertRequest, task.request),
            ...
            async def run_Remove(
                ...
                async with self._state_manager.task_workflow(
                    ...
                    response = await (SortedMapWorkflowStub(
                        ...
                        typing.cast(resemble.integrations.collections.v1.sorted_map_pb2.RemoveRequest, task.request),
                        bearer_token=__internal_magic_token__,
                        idempotency=resemble.aio.idempotency.Idempotency(
                            alias=f'Task {task.task_id.task_uuid}',
                        ),
            ...
            async def run_Range(
                ...
                async with self._state_manager.task_workflow(
                    ...
                    response = await (SortedMapWorkflowStub(
                        ...
                        typing.cast(resemble.integrations.collections.v1.sorted_map_pb2.RangeRequest, task.request),
                        bearer_token=__internal_magic_token__,
                    ))
    ...
    async def _schedule_Insert(
        ...
        *,
        ...
        headers: resemble.aio.headers.Headers,
        grpc_context: grpc.aio.ServicerContext,
    ) -> tuple[resemble.aio.contexts.WriterContext, resemble.integrations.collections.v1.sorted_map_pb2.InsertResponse]:
    ...
    async def Insert(
        ...
        if authoritative_consensus != self.consensus_id:
            ...
            stub = resemble.integrations.collections.v1.sorted_map_pb2_grpc.SortedMapInterfaceStub(channel)
            call = stub.Insert(
                request=request,
    ...
    async def _schedule_Remove(
        ...
        *,
        ...
        headers: resemble.aio.headers.Headers,
        grpc_context: grpc.aio.ServicerContext,
    ) -> tuple[resemble.aio.contexts.WriterContext, resemble.integrations.collections.v1.sorted_map_pb2.RemoveResponse]:
        context: resemble.aio.contexts.WriterContext = self.create_context(
            headers=headers,
            context_type=resemble.aio.contexts.WriterContext,
        )
    ...
    async def _schedule_Range(
        ...
        *,
        ...
        headers: resemble.aio.headers.Headers,
        grpc_context: grpc.aio.ServicerContext,
    ) -> tuple[resemble.aio.contexts.WriterContext, resemble.integrations.collections.v1.sorted_map_pb2.RangeResponse]:
        context: resemble.aio.contexts.WriterContext = self.create_context(
            headers=headers,
            context_type=resemble.aio.contexts.WriterContext,
        )
...
class _SortedMapStub(resemble.aio.stubs.Stub):
    ...
    __service_name__ = resemble.aio.types.ServiceName('resemble.integrations.collections.v1.SortedMapInterface')
...
SortedMapStateType: typing.TypeAlias = resemble.integrations.collections.v1.sorted_map_pb2.SortedMap
        ...
        *,
        ...
        if method_name == 'resemble.integrations.collections.v1.SortedMap.Insert':
            return await self.Insert(
                context,
                typing.cast(resemble.integrations.collections.v1.sorted_map_pb2.SortedMap, state),
                typing.cast(resemble.integrations.collections.v1.sorted_map_pb2.InsertRequest, request),
            )
        elif method_name == 'resemble.integrations.collections.v1.SortedMap.Remove':
            return await self.Remove(
                context,
                typing.cast(resemble.integrations.collections.v1.sorted_map_pb2.SortedMap, state),
                typing.cast(resemble.integrations.collections.v1.sorted_map_pb2.RemoveRequest, request),
            )
        elif method_name == 'resemble.integrations.collections.v1.SortedMap.Range':
            return await self.Range(
                context,
                typing.cast(resemble.integrations.collections.v1.sorted_map_pb2.SortedMap, state),
                typing.cast(resemble.integrations.collections.v1.sorted_map_pb2.RangeRequest, request),
            )
        else:
...
class SortedMapServicer(resemble.aio.servicers.Servicer):
    ...
    __service_name__ = resemble.aio.types.ServiceName('resemble.integrations.collections.v1.SortedMapInterface')
    __state_type_name__ = resemble.aio.types.StateTypeName('resemble.integrations.collections.v1.SortedMap')
...
class SortedMap:
    ...
    State: typing.TypeAlias = resemble.integrations.collections.v1.sorted_map_pb2.SortedMap
    ...
    class InsertFuture:
        ...
        def __await__(self) -> typing.Generator[None, None, resemble.integrations.collections.v1.sorted_map_pb2.InsertResponse]:
    ...
    class RemoveFuture:
        ...
        def __await__(self) -> typing.Generator[None, None, resemble.integrations.collections.v1.sorted_map_pb2.RemoveResponse]:
            """Awaits for task to finish and returns it's response."""
    ...
    class RangeFuture:
        ...
        def __await__(self) -> typing.Generator[None, None, resemble.integrations.collections.v1.sorted_map_pb2.RangeResponse]:
            """Awaits for task to finish and returns it's response."""
    ...
    class WeakReference:
        ...
        def __init__(
            ...
            *,
            ...
            self._actor_id = (
                ...
                else resemble.aio.types.ActorId.from_key(SortedMap.__state_type_name__, actor_key_or_id)
            )
        ...
        class _Reactively:
            ...
            async def Range(
                ...
                *,
                ...
                end_key: typing.Optional[str] = None,
                limit: typing.Optional[int] = None,
            ) -> typing.AsyncIterator[resemble.integrations.collections.v1.sorted_map_pb2.RangeResponse]:
        ...
        def reactively(self):
            return SortedMap.WeakReference._Reactively(
                service_name=resemble.aio.types.ServiceName('resemble.integrations.collections.v1.SortedMapInterface'),
                actor_id=self._actor_id,
                bearer_token=self._bearer_token,
            )
        ...
        class _Schedule:
            ...
            def __init__(
                self,
                tasks: typing.Callable[[resemble.aio.contexts.TransactionContext | resemble.aio.contexts.WorkflowContext | resemble.aio.workflows.Workflow], SortedMapTasksStub],
                *,
                when: typing.Optional[datetime | timedelta] = None,
                ...
                *,
                ...
                if isinstance(__context_or_workflow__, resemble.aio.contexts.TransactionContext):
                    return resemble.aio.tasks.TaskEffect(
                        service_name=resemble.aio.types.ServiceName(
                            'resemble.integrations.collections.v1.SortedMapInterface'
                        ),
                        actor_id=__context_or_workflow__.actor_id,
                        method_name='Insert',
                        request=request,
...
class SortedMapWeakReferenceNodeAdaptor(SortedMap.WeakReference):
