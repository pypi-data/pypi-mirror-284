...
class CreateSealCertificateRequest(BaseModel):
    """
    CreateSealCertificateRequest
    """ # noqa: E501
    seal_certificate: SealCertificateDto = Field(alias="sealCertificate")
    certificate_file: Union[StrictBytes, StrictStr] = Field(description="Certificate file", alias="certificateFile")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateSealCertificateRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateSealCertificateRequest from a dict"""
        if obj is None:
            return None
