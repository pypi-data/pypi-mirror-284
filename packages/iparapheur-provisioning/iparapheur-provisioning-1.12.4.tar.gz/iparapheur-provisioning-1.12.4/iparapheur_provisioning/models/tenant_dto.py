...
class TenantDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "templateInfoMap"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        if self.template_info_map:
            for _key in self.template_info_map:
                if self.template_info_map[_key]:
                    _field_dict[_key] = self.template_info_map[_key].to_dict()
