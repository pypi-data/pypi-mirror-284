    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        if self.associated_tenants:
            for _item in self.associated_tenants:
                if _item:
        ...
        if self.administered_tenants:
            for _item in self.administered_tenants:
                if _item:
                    _items.append(_item.to_dict())
        ...
        if self.administered_desks:
            for _item in self.administered_desks:
                if _item:
                    _items.append(_item.to_dict())
        ...
        if self.associated_desks:
            for _item in self.associated_desks:
                if _item:
                    _items.append(_item.to_dict())
        ...
        if self.supervised_desks:
            for _item in self.supervised_desks:
                if _item:
                    _items.append(_item.to_dict())
        ...
        if self.delegation_managed_desks:
            for _item in self.delegation_managed_desks:
                if _item:
                    _items.append(_item.to_dict())
