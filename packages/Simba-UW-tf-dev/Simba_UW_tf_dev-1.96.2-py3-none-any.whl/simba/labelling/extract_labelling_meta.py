...
class AnnotationMetaDataExtractor(ConfigReader):
    ...
    def run(self):
        ...
        for file_cnt, file_path in enumerate(self.target_file_paths):
            ...
            bouts.columns = ['ANNOTATED CLASSIFIER', 'ANNOTATED START TIME', 'ANNOTATED END TIME', 'ANNOTATED START FRAME','ANNOTATED START FRAME','ANNOTATED BOUT TIME (S)']
            bouts['VIDEO'] = video_name
            bouts = bouts[['VIDEO', 'ANNOTATED CLASSIFIER', 'ANNOTATED START TIME', 'ANNOTATED END TIME', 'ANNOTATED START FRAME','ANNOTATED START FRAME','ANNOTATED BOUT TIME (S)']]
