...
class Model:
    ...
    def train(self, input_width, input_height, keep_aspect_ratio, trainer=None, **kwargs):
        """
        ...
        kwargs['input_height'] = input_height
        kwargs['keep_aspect_ratio'] = keep_aspect_ratio
