...
def lazy_import():
    ...
    globals()['ResourceStatusRequestStatusEnum'] = ResourceStatusRequestStatusEnum
...
class ResourceStatusRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'status': (ResourceStatusRequestStatusEnum,),  # noqa: E501
    ...
    def _from_openapi_data(cls, status, *args, **kwargs):  # noqa: E501
        ...
        Args:
            status (ResourceStatusRequestStatusEnum):
