...
class Motifs():
    ...
    def triangle_alongz(self,
        ...
        pos = numpy.zeros((3,3))
        pos[0] = [0.0,0.0,1.0]
        pos[1] = [numpy.sqrt(3./4.),0.0,-0.5]
        pos[2] = [-1.0*numpy.sqrt(3./4.),0.0,-0.5]
        pos *= r
        return pos
    
    def tetrahedron_alongz(self,
                           r=1.0):
        '''
        ...
        pos = numpy.zeros((4,3))
        pos[0] = [0.0,0.0,1.0]
        pos[1] = [numpy.sqrt(8./9.),0.0,-1./3.]
        pos[2] = [-1.0*numpy.sqrt(2./9.),numpy.sqrt(2./3.),-1./3.]
        pos[3] = [-1.0*numpy.sqrt(2./9.),-1.0*numpy.sqrt(2./3.),-1./3.]
        pos *= r
        return pos
   
    def fourgon_alongz(self,
                       r=1.0):
        '''
           Quadruple bond
        '''
    ...
    def sevengon_alongz(self,
        ...
        pos[1] = [0,0,-1]
        pos[2] = [1,0,0]
        pos[3] = [numpy.sin(18./360*2.*numpy.pi), numpy.sin(72./360*2.*numpy.pi),0.0]
        pos[4] = [numpy.sin(18./360*2.*numpy.pi), -1.0*numpy.sin(72./360*2.*numpy.pi),0.0]
        pos[5] = [-1.0*numpy.sin(54./360*2.*numpy.pi), numpy.sin(36./360*2.*numpy.pi),0.0]
        pos[6] = [-1.0*numpy.sin(54./360*2.*numpy.pi), -1.0*numpy.sin(36./360*2.*numpy.pi),0.0]
        pos *= r
        return pos
    
    def eightgon_alongz(self,
                        r=1.0):
        '''
