...
class OwlSimClient(object):
    """Class acting as a client interface to MoveIt Robot MoveIt!  
    """
    def __init__(self, arm_group_name="arm",gripper_group_name="gripper",wait_for_servers=10):
    ...
    def is_running(self) -> bool:
        """
        Return True if robot movegroup is available False, if return false.
        """
        result = False
