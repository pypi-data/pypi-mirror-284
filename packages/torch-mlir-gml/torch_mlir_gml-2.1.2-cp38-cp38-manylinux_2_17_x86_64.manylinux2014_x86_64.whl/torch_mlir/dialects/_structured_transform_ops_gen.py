...
class PadOp(_ods_ir.OpView):
  ...
  def __init__(self, padded, pad, target, *, padding_values=None, padding_dimensions=None, pad_to_multiple_of=None, pack_paddings=None, transpose_paddings=None, copy_back_op=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
    ...
    if transpose_paddings is not None: attributes["transpose_paddings"] = (transpose_paddings if (
        ...
        not _ods_ir.AttrBuilder.contains('anonymous_456')) else
          _ods_ir.AttrBuilder.get('anonymous_456')(transpose_paddings, context=_ods_context))
