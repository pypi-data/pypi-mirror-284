...
async def actualInit(userid):
        ...
        async with websockets.connect('wss://eventsub.wss.twitch.tv/ws') as ws:
            tp.dic[userid]["ws"] = ws
            try:
                tp.EVENT_SUBSCRIPTION = tp.dic[userid]["EVENT_SUBSCRIPTION"]
                tp.TWITCH_ACCESS_TOKEN = tp.dic[userid]["TWITCH_ACCESS_TOKEN"]
                tp.TWITCH_CLIENT_ID = tp.dic[userid]["TWITCH_CLIENT_ID"]
