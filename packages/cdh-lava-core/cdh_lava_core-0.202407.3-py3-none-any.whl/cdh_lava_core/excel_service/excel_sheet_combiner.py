    ...
    def combine_sheets(cls, file_path, data_product_id, environment):
        ...
        with tracer.start_as_current_span("combine_sheets", attributes={"data_product_id": str(data_product_id), "environment": str(environment)}):
            try:
                ...
                new_columns = ['data_product_id', 'code_type', 'valueset_code', 'feature_name', 'parent_valueset_code', 'parent_concept_code', 'concept_code', 'concept_name',  'concept_sort', 'description','category_valueset_code','category_concept_code', 'concept_category_sort','formula','visibility_valueset_code','visibility_concept_code', 'color', 'meta_yyyy', 'meta_mm', 'sheet_name']
