...
class GroupClient:
    ...
    async def discover_groups(self, house_no: str) -> tuple[str, Optional[List[Group]] | Dict[str, Any]]:
        """
        ...
        sign = md5_encrypt(f"houseNo={house_no}{self._app_secret}{timestamp}")
        ...
        headers = {
            ...
            'time': str(timestamp),  # Ensure it's converted to string
            'sign': sign,
            'appVersion': self._app_version,
            'clientVersion': self._client_version,
            'clientModel': self._client_model,
            'service_appkey': '3f3008cf-54d2-43a5-aff5-eefeceb38335',
            'service_secretKey': '21f0d6dc1fd84cd0908b3672497def23',
            'traceId': '45864584845'
        }
    ...
    @staticmethod
    def _create_group_obj(group_dict: dict) -> Dict[str, Any]:
        """
