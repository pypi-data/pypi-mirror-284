...
class OrganizationMetricsResponseAllOfMetrics(BaseModel):
    total_jobs_compute_time: float = Field(..., alias="totalJobsComputeTime", description="Total compute time of all organizational jobs since the creation of the organization (including organizational project jobs). Compute time is the amount of computation time spent in jobs, in minutes used by an organization over a 12 month period, calculated as 1 x CPU + 3 x GPU minutes.")
    jobs_compute_time_current_year: float = Field(..., alias="jobsComputeTimeCurrentYear", description="Total compute time of all organizational jobs in the current contract (including organizational project jobs). Compute time is the amount of computation time spent in jobs, in minutes used by an organization over a 12 month period, calculated as 1 x CPU + 3 x GPU minutes.")
