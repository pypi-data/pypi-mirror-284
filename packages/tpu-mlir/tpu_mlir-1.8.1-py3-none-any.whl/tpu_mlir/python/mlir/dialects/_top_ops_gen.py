...
class AvgPoolOp(_ods_ir.OpView):
  ...
  def __init__(self, output, input, kernel_shape, strides, pads, *, ceil_mode=None, auto_pad=None, keepdims=None, pad_value=None, count_include_pad=None, do_relu=None, relu_limit=None, round_mode=None, first_round_mode=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class InputOp(_ods_ir.OpView):
  ...
  def __init__(self, output, input, *, is_shape=None, do_preprocess=None, pixel_format=None, channel_format=None, resize_dims=None, keep_aspect_ratio=None, keep_ratio_mode=None, pad_value=None, pad_type=None, scale=None, mean=None, customization_format=None, aligned=None, white_level=None, black_level=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
    operands.append(_get_op_result_or_value(input))
    _ods_context = _ods_get_default_loc_context(loc)
    if is_shape is not None: attributes["is_shape"] = (is_shape if (
        issubclass(type(is_shape), _ods_ir.Attribute) or
        not _ods_ir.AttrBuilder.contains('BoolAttr')) else
          _ods_ir.AttrBuilder.get('BoolAttr')(is_shape, context=_ods_context))
  ...
  @builtins.property
  def is_shape(self):
    return self.operation.attributes["is_shape"]

  @is_shape.setter
  def is_shape(self, value):
    if value is None:
      raise ValueError("'None' not allowed as value for mandatory attributes")
    self.operation.attributes["is_shape"] = value
...
class MaxPoolWithMaskOp(_ods_ir.OpView):
  ...
  def __init__(self, output, mask, input, kernel_shape, strides, pads, *, ceil_mode=None, auto_pad=None, keepdims=None, pad_value=None, count_include_pad=None, do_relu=None, relu_limit=None, round_mode=None, first_round_mode=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
