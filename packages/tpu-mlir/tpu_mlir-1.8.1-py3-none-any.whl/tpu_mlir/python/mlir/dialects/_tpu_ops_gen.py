...
class Pool1DOp(_ods_ir.OpView):
  ...
  def __init__(self, output, input, kernel_shape, strides, pads, pool_mode, *, pad_value=None, count_include_pad=None, do_relu=None, relu_limit=None, multiplier=None, rshift=None, scale=None, offset=None, round_mode=None, first_round_mode=None, layer_group=None, fp8_out_scale=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
