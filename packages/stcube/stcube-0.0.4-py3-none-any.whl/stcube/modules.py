...
class Module(Functional):
    ...
    sys = Functional.sys + ['mods', 'scan_individual_files', 'induce_name', 'build_path_tree', 'modularize', 'get_collection']

    def loading(self):
        cp_open = self.ce.get(FOpen)
        if not cp_open:
    ...
    @staticmethod
    def scan_individual_files(path):
        ff = FileFinder(path)
    ...
    @staticmethod
    def induce_name(c_files, h_files):
        """
    ...
    def get_collection(self):
        ...
        cs, hs = Module.scan_individual_files(core_path)
        # 用户名
        ...
        chtree = Module.build_path_tree(chfiles)
        # 计算默认模块名
...
if __name__ == '__main__':
    ...
    cs, hs = Module.scan_individual_files(path)
    print(Module.induce_name(cs, hs))
