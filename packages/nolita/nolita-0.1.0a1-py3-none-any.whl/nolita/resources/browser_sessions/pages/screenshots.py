...
from ....types.browser_sessions.pages.screenshot_retrieve_response import ScreenshotRetrieveResponse
...
class ScreenshotsResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        return self._get(
            f"/{browser_session}/page/{page_id}/screenshot/{type}",
