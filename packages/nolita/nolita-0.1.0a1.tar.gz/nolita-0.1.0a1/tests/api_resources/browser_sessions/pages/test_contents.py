...
class TestContents:
    ...
    def test_method_retrieve(self, client: Nolita) -> None:
        content = client.browser_sessions.pages.contents.retrieve(
            "markdown",
            browser_session="string",
            page_id="string",
        )
        assert_matches_type(ContentRetrieveResponse, content, path=["response"])

    @parametrize
    def test_raw_response_retrieve(self, client: Nolita) -> None:
        response = client.browser_sessions.pages.contents.with_raw_response.retrieve(
            "markdown",
            browser_session="string",
            page_id="string",
        )
    ...
    def test_streaming_response_retrieve(self, client: Nolita) -> None:
        with client.browser_sessions.pages.contents.with_streaming_response.retrieve(
            "markdown",
            browser_session="string",
            page_id="string",
        ) as response:
    ...
    def test_path_params_retrieve(self, client: Nolita) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `browser_session` but received ''"):
            client.browser_sessions.pages.contents.with_raw_response.retrieve(
                "markdown",
                browser_session="",
                page_id="string",
            )
...
class TestAsyncContents:
    ...
    async def test_method_retrieve(self, async_client: AsyncNolita) -> None:
        content = await async_client.browser_sessions.pages.contents.retrieve(
            "markdown",
            browser_session="string",
            page_id="string",
        )
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncNolita) -> None:
        response = await async_client.browser_sessions.pages.contents.with_raw_response.retrieve(
            "markdown",
            browser_session="string",
            page_id="string",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncNolita) -> None:
        async with async_client.browser_sessions.pages.contents.with_streaming_response.retrieve(
            "markdown",
            browser_session="string",
            page_id="string",
        ) as response:
    ...
    async def test_path_params_retrieve(self, async_client: AsyncNolita) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `browser_session` but received ''"):
            await async_client.browser_sessions.pages.contents.with_raw_response.retrieve(
                "markdown",
                browser_session="",
                page_id="string",
            )
