...
class RawFrames(_message.Message):
    __slots__ = ("channel", "payload")
    CHANNEL_FIELD_NUMBER: _ClassVar[int]
    PAYLOAD_FIELD_NUMBER: _ClassVar[int]
    channel: RawChannel
...
class RawChannel(_message.Message):
    __slots__ = ("bus_name", "request_id", "response_id", "extended_request_address", "extended_response_address")
    BUS_NAME_FIELD_NUMBER: _ClassVar[int]
    REQUEST_ID_FIELD_NUMBER: _ClassVar[int]
    RESPONSE_ID_FIELD_NUMBER: _ClassVar[int]
    EXTENDED_REQUEST_ADDRESS_FIELD_NUMBER: _ClassVar[int]
    ...
    extended_request_address: int
    extended_response_address: int
    def __init__(self, bus_name: _Optional[str] = ..., request_id: _Optional[int] = ..., response_id: _Optional[int] = ..., extended_request_address: _Optional[int] = ..., extended_response_address: _Optional[int] = ...) -> None: ...
