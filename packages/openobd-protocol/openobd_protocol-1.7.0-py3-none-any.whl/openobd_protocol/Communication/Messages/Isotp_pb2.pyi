...
class RawFrame(_message.Message):
    __slots__ = ("channel", "payload", "can_request_id")
    CHANNEL_FIELD_NUMBER: _ClassVar[int]
    PAYLOAD_FIELD_NUMBER: _ClassVar[int]
    CAN_REQUEST_ID_FIELD_NUMBER: _ClassVar[int]
    channel: RawChannel
    payload: str
    can_request_id: str
    def __init__(self, channel: _Optional[_Union[RawChannel, _Mapping]] = ..., payload: _Optional[str] = ..., can_request_id: _Optional[str] = ...) -> None: ...

class RawChannel(_message.Message):
    __slots__ = ("bus_name", "can_id")
    BUS_NAME_FIELD_NUMBER: _ClassVar[int]
    CAN_ID_FIELD_NUMBER: _ClassVar[int]
    bus_name: str
    can_id: _containers.RepeatedScalarFieldContainer[int]
    def __init__(self, bus_name: _Optional[str] = ..., can_id: _Optional[_Iterable[int]] = ...) -> None: ...
