...
class canStub(object):
    ...
    def __init__(self, channel):
        ...
        self.openRawStream = channel.stream_stream(
                ...
                request_serializer=openobd__protocol_dot_Communication_dot_Messages_dot_Isotp__pb2.RawFrame.SerializeToString,
                response_deserializer=openobd__protocol_dot_Communication_dot_Messages_dot_Isotp__pb2.RawFrame.FromString,
                )
...
def add_canServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'openRawStream': grpc.stream_stream_rpc_method_handler(
                    ...
                    request_deserializer=openobd__protocol_dot_Communication_dot_Messages_dot_Isotp__pb2.RawFrame.FromString,
                    response_serializer=openobd__protocol_dot_Communication_dot_Messages_dot_Isotp__pb2.RawFrame.SerializeToString,
            ),
    }
...
class can(object):
    ...
    def openRawStream(request_iterator,
        ...
        return grpc.experimental.stream_stream(request_iterator, target, '/openOBD.v1.can/openRawStream',
            openobd__protocol_dot_Communication_dot_Messages_dot_Isotp__pb2.RawFrame.SerializeToString,
            openobd__protocol_dot_Communication_dot_Messages_dot_Isotp__pb2.RawFrame.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
