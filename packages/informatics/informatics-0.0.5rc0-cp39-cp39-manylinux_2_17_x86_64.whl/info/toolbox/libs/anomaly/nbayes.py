...
_Bayes = getattr(_bayes_hook, '_Bayes')
...
def _a_updater(x: GenericArray, idx: ndarray, prior: list[DirTP], _bayes: list[_Bayes],
               use_update: bool = True) -> tuple[ndarray, list[_Bayes]]:
