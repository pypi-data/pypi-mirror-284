...
DEFAULT_SSH_CLIENT_PRIVATE_KEY_PATH = os.path.join(os.path.expanduser("~"), ".ssh", "id_rsa")
DEFAULT_SSH_CLIENT_PUBLIC_KEY_PATH = os.path.join(os.path.expanduser("~"), ".ssh", "id_rsa.pub")
