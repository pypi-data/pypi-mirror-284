...
class HostUrlConfig:
    ...
    host: URL = URL("https://api.antcde.io")
    data_model: URL = URL("https://api.antcde.io/docs/2.0/api-docs-v2.json")
    type: str = "api"
    version: str = "2.0"
    documentation: URL = URL("https://api.antcde.io/api/2.0/documentation")


class AlphaHostUrl:
    """Configuration for the alpha host URL."""
    host: URL = URL("https://api.alpha.antcde.io")
...
class ProjectPaths:
    ...
    LOCAL_DATA_MODEL: Path = Directories.DEV / "testing" / "api-docs-v2.13.json"
