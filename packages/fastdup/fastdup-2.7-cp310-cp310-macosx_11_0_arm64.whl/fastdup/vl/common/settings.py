...
class Settings(metaclass=MyMeta):
    ...
    DATA_INGESTION_MAX_FILES: ConfigValue = ConfigValue(int, default=10_000)
    DATA_INGESTION_MAX_SIZE_BYTES: ConfigValue = ConfigValue(int, default=10 * 1024 * 1024 * 1024)  # 10G
    ...
    PREFECT_API_URL: ConfigValue = ConfigValue(str, 'http://pl-local:4200/api')
