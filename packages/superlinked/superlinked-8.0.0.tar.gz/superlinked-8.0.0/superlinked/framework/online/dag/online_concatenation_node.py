...
class OnlineConcatenationNode(DefaultOnlineNode[ConcatenationNode, Vector], HasLength):
    ...
    @property
    def arithmetics_calculator(self) -> WeightArithmetics:
        return WeightArithmetics()
    ...
    def _evaluate_singles(
        ...
        vectors = [
            reduce(
                ...
                (
                    self.arithmetics_calculator.apply_vector_weight(
        ...
        weight_sum = self.arithmetics_calculator.get_weight_abs_sum(
