...
class TSCW_Output():
    ...
    def calculate_axial_forces_super(self, meta_data, t_vector, p_vector, t_total,
                                     t_etappe, i_etappen, T0:float = None, p_RR:float = 3):
...
class TSCW_TBHC(TSCW_Output):
    ...
    def plot_forces_difference(self, depths, save_folder:Path, xlimits, *args):
    ...
    def plot_pt_difference(self, depths, save_folder, *args):
