...
def get_gravity_constants(gravity_constant_name):
    ...
    return torch.tensor(tumin,dtype=torch_type), torch.tensor(mu,dtype=torch_type), torch.tensor(radiusearthkm,dtype=torch_type), torch.tensor(xke,dtype=torch_type), torch.tensor(j2,dtype=torch_type), torch.tensor(j3,dtype=torch_type), torch.tensor(j4,dtype=torch_type), torch.tensor(j3oj2,dtype=torch_type)
