...
class Regression:
    ...
    def detailed_matrix(self):
        ...
        try :
            ...
            print("Error in while calculating detailed_matrix ")
...
class Classification:
    ...
    def detailed_matrix(self):
        ...
        Returns:
            String
        """
        temp_model = self.model ; detailed_matrix_dict = {}
        try:
            temp_model = self.model.to_sklearn()
        except Exception as ex:
            pass
            
        average='weighted'
        if hasattr(temp_model,'n_classes_'):
