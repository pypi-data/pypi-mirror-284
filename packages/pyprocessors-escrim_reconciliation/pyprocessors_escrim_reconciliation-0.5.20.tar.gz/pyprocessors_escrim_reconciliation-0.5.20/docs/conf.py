...
import pyprocessors_escrim_reconciliation


# -- Project information -----------------------------------------------------

project = "pyprocessors_escrim_reconciliation"
copyright = "2021, Olivier Terrier"
author = "Olivier Terrier"
version = pyprocessors_escrim_reconciliation.__version__
release = pyprocessors_escrim_reconciliation.__version__
...
apidoc_module_dir = os.path.dirname(pyprocessors_escrim_reconciliation.__file__)
