...
from vectara_client.models import CreateCorpusRequest, CreateDocumentRequest
...
class CorpusManager:
    ...
    def create_corpus(self, corpus:CreateCorpusRequest, delete_existing=False, unique=True) -> int:
        """
        ...
        return self.corpora_api.create_corpus(corpus).corpusId
