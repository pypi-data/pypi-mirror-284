...
class TableResult(_ViewResult):
    ...
    row_headers: Incomplete
    enable_sorting_and_filtering: Incomplete
    def __init__(self, data: Sequence[Sequence[TableCellValue | TableCell]] | pandas.DataFrame | Styler, *, column_headers: Sequence[str | TableHeader] | None = None, row_headers: Sequence[str | TableHeader] | None = None, enable_sorting_and_filtering: bool | None = None) -> None: ...
