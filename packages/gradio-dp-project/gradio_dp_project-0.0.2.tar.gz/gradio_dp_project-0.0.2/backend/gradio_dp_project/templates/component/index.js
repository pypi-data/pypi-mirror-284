...
function ni(n, e, t) {
  ...
  function Q(g) {
    rt[g ? "unshift" : "push"](() => {
      V = g, t(16, V), t(7, p), t(14, S), t(15, Z);
    });
  }
  const de = () => {
    o("clear_status");
  ...
  return {
    c() {
      ...
      o = Te(), d && d.c(), Ve(
        ...
        /*placeholder*/
        n[5]
      ), Ve(f, "class", "svelte-l3vjji"), /*value*/
      n[0] === void 0 && oi(() => (
    ...
    p(c, q) {
      ...
      c[12] ? d ? d.p(c, q) : (d = Nt(c), d.c(), d.m(t, null)) : d && (d.d(1), d = null);
    },
    i(c) {
...
function yi(n, e, t) {
  ...
  function P() {
    return l(this, void 0, void 0, function* () {
      const y = z.get("appAccessKey"), x = z.get("clientName"), S = yield fetch("https://openapi.test.dp.tech/openapi/v1/open/user/project/list", {
        headers: { accessKey: y, "x-app-key": x }
      });
      if (S.ok) {
        const Z = yield S.json();
        t(13, L = Z.data.items.map((V) => [V.projectName, V.projectId]));
      }
    });
  }
  wi(() => {
