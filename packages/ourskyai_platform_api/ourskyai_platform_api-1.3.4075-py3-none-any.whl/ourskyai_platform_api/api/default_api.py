...
"""
    ...
    The version of the OpenAPI document: 1.3.4075
...
class DefaultApi:
    ...
    @validate_arguments
    def v1_get_embedded_query_url(self, question_type : StrictStr, node_id : Optional[StrictStr] = None, lookback_days : Optional[StrictInt] = None, **kwargs) -> V1GetEmbeddedQueryUrlResponse:  # noqa: E501
        ...
        >>> thread = api.v1_get_embedded_query_url(question_type, node_id, lookback_days, async_req=True)
        >>> result = thread.get()

        :param question_type: (required)
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.v1_get_embedded_query_url_with_http_info(question_type, node_id, lookback_days, **kwargs)  # noqa: E501

    @validate_arguments
    def v1_get_embedded_query_url_with_http_info(self, question_type : StrictStr, node_id : Optional[StrictStr] = None, lookback_days : Optional[StrictInt] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """v1_get_embedded_query_url  # noqa: E501
        ...
        >>> thread = api.v1_get_embedded_query_url_with_http_info(question_type, node_id, lookback_days, async_req=True)
        >>> result = thread.get()
        ...
        # process the query parameters
        _query_params = []
        if _params.get('question_type') is not None:  # noqa: E501
            _query_params.append(('questionType', _params['question_type']))

        if _params.get('node_id') is not None:  # noqa: E501
            _query_params.append(('nodeId', _params['node_id']))

        if _params.get('lookback_days') is not None:  # noqa: E501
            _query_params.append(('lookbackDays', _params['lookback_days']))
