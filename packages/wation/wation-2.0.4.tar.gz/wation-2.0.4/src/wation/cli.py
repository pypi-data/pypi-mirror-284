...
from modules.cli.encoder import main as cli_encoder_handler
from modules.cli.encoder import SUPPORTED_ALGORITHMS as ENCODER_SUPPORTED_ALGORITHMS

from modules.cli.decoder import main as cli_decoder_handler
from modules.cli.decoder import SUPPORTED_ALGORITHMS as DECODER_SUPPORTED_ALGORITHMS

from modules.cli.hash import main as cli_hash_handler
from modules.cli.hash import SUPPORTED_ALGORITHMS as HASH_SUPPORTED_ALGORITHMS

from modules.cli.uuid import main as cli_uuid_handler
from modules.cli.hashid import main as cli_hashid_handler
from modules.cli.collab import main as cli_collab_handler

from modules.cli.general import banner, clear_terminal
from modules.cli.share import main as cli_share_handler

from modules.cli.auth import arg_login, arg_logout
from modules.cli.open import arg_open
from modules.cli.connection import arg_connection
from modules.cli.profile import arg_profile
from modules.cli.update import update_package
from modules.miscellaneous import config
from modules.miscellaneous import server
    ...
    try:
        ...
        if client_id:
            ...
            if 'share' in features:
                ...
                share_command.set_defaults(func=cli_share_handler)
            ...
            if 'collab' in features:
                collab_command = cli_subparsers.add_parser('collab', help="Run the collab command.")
            ...
            # UUID command
            if 'uuid' in features:
                uuid_command = cli_subparsers.add_parser('uuid', help="Generate UUIDs.")
