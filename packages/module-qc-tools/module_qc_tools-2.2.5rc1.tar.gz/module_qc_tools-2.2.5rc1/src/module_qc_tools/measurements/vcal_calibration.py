...
def run(config, ps, yr, layer, debug_gnd, use_calib_adc):
    ...
    InjVcalRange = measurement_config["InjVcalRange"]
    ...
    Large_Range = [
        measurement_config["Large_Range"]["start"],
        measurement_config["Large_Range"]["stop"],
        measurement_config["Large_Range"]["step"],
    ]
    Small_Range = [
        measurement_config["Small_Range"]["start"],
        measurement_config["Small_Range"]["stop"],
        measurement_config["Small_Range"]["step"],
    ]
    vmux_value_GNDA = measurement_config["MonitorV_GND"]
