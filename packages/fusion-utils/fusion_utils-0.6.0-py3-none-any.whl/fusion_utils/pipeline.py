...
class Pipeline:
    ...
    def send_completion_email(self):
        ...
        for task_name, updates in self.status.items():
            ...
            task_summary = f"<span class='{ 'pass' if latest_update.get('success', False) else 'fail' }'>Task '{task_name}': {latest_update['status']} at {latest_update['timestamp']} (Execution Time: {execution_time_str})</span>"
