...
def add_chunks_to_vectorstore(vectorstore_id, chunks: List[Document]):
    """
...
async def add_chunks_to_vectorstore_async(vectorstore_id, chunks: List[Document]):
    """
    Every item in the chunks list must look like this
    {"content": "...", "metadata": {...}}
    """
...
def edit_chunk(vectorstore_id: str, chunk_id: str, document: Document):
    url = f"{baseUrl}/api/tenants/{tenant}/projects/{workspace}/runners/{runnerId}/information-store/vectorstore/{vectorstore_id}/chunks/{chunk_id}"
    headers = {
        "halerium-runner-token": runnerToken,
    }
...
async def edit_chunk_async(vectorstore_id: str, chunk_id: str, document: Document):
    url = f"{baseUrl}/api/tenants/{tenant}/projects/{workspace}/runners/{runnerId}/information-store/vectorstore/{vectorstore_id}/chunks/{chunk_id}"
    headers = {
        "halerium-runner-token": runnerToken,
    }
