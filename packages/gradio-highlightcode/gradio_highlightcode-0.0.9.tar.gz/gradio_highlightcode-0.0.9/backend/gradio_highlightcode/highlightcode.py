    ...
    def __init__(
        ...
        *,
        ...
        Parameters:
            ...
            highlights: Specifies the lines to highlight. Use the first number for the starting line, the second for the ending line, and the last parameter for the color.
        ...
        """
        if language not in highlightcode.languages:
