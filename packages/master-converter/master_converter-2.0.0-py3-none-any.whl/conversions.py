...
class Mass:
    class Grams:
        ...
        def Grams_Long_Tons(self):
            """Converts grams to long tons (Also known as the Imperial Ton) and reeturns the number of long tons"""

            lt = self.g / 1020408.1632653
            return lt
    ...
    class Milligrams:
        ...
        def Milligrams_Killigrams(self):
            """
            Converts milligrams to killigrams and returns the number of killigrams
            """
        ...
        def Milligrams_Short_Tons(self):
            """Converts milligrams to short tons (Alson known as US tons) and returns the number of short tons"""

            st = self.mg / 907185818.87128
            return st

        def Milligrams_Long_Tons(self):
            """Converts milligrams to long tons (or Imperial Tons) and returns the number of long tons"""

            lt = self.mg / 1016047453.4803
            return lt
    ...
    class Metric_Tons:
        ...
        def Metric_Tons_Grams(self):
            """
            Comverts metric tons to grams and returns the number of grams
            :return:
            """
    ...
    class Long_Tons:
        ...
        def Long_Tons_Milligrams(self):
            ...
            mg = self.long_ton * 1016047453.4803
            return mg
        ...
        def Long_Tons_Metric_Tons(self):
            ...
            tonnes = self.long_ton * 1.01604745
            return tonnes
