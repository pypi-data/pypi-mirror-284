...
class TensorQuantizer(nn.Module):
    ...
    def __init__(
        ...
        self._trt_high_precision_dtype = "Float"
    ...
    def set_from_attribute_dict(self, attribute_dict: Dict[str, Any]):
        ...
        if "enable" in attribute_dict:
            if attribute_dict["enable"]:
                ...
                self.disable()
        if "trt_high_precision_dtype" in attribute_dict:
            self.trt_high_precision_dtype = attribute_dict["trt_high_precision_dtype"]
