...
class AdmissionregistrationV1ValidatingAdmissionPolicyManager:
    def __init__(self, client: kubernetes.client.AdmissionregistrationV1Api) -> None:
        self.client = client
...
class AdmissionregistrationV1CollectionValidatingAdmissionPolicyManager:
    def __init__(self, client: kubernetes.client.AdmissionregistrationV1Api) -> None:
        self.client = client
...
class AdmissionregistrationV1ValidatingAdmissionPolicyStatusManager:
    def __init__(self, client: kubernetes.client.AdmissionregistrationV1Api) -> None:
        self.client = client
...
class AdmissionregistrationV1ValidatingAdmissionPolicyBindingManager:
    def __init__(self, client: kubernetes.client.AdmissionregistrationV1Api) -> None:
        self.client = client
...
class AdmissionregistrationV1CollectionValidatingAdmissionPolicyBindingManager:
    def __init__(self, client: kubernetes.client.AdmissionregistrationV1Api) -> None:
        self.client = client
...
class ResourceV1alpha2NamespacedResourceClaimParametersManager:
    def __init__(self, client: kubernetes.client.ResourceV1alpha2Api) -> None:
        self.client = client
    ...
    def list(
        ...
        *,
        ...
        timeout_seconds: typing.Optional[int] = None,
        watch: typing.Optional[bool] = None
    ) -> kubernetes.client.V1alpha2ResourceClaimParametersList:
        return self.client.list_namespaced_resource_claim_parameters(
            namespace=namespace,
            pretty=pretty,
            allow_watch_bookmarks=allow_watch_bookmarks,
            _continue=_continue,
    ...
    def create(
        ...
        *,
        ...
        field_manager: typing.Optional[str] = None,
        field_validation: typing.Optional[str] = None
    ) -> kubernetes.client.V1alpha2ResourceClaimParameters:
        return self.client.create_namespaced_resource_claim_parameters(
            namespace=namespace,
            body=body,
            pretty=pretty,
            dry_run=dry_run,
    ...
    def read(
        ...
        return self.client.read_namespaced_resource_claim_parameters(
            name=name, namespace=namespace, pretty=pretty
        )
    ...
    def replace(
        ...
        *,
        ...
        return self.client.replace_namespaced_resource_claim_parameters(
            name=name,
            namespace=namespace,
            body=body,
            pretty=pretty,
    ...
    def delete(
        ...
        *,
        ...
        return self.client.delete_namespaced_resource_claim_parameters(
            name=name,
            namespace=namespace,
            pretty=pretty,
            body=body,
    ...
    def patch(
        ...
        *,
        ...
        return self.client.patch_namespaced_resource_claim_parameters(
            name=name,
            namespace=namespace,
            body=body,
            pretty=pretty,
...
class ResourceV1alpha2CollectionNamespacedResourceClaimParametersManager:
    def __init__(self, client: kubernetes.client.ResourceV1alpha2Api) -> None:
        self.client = client
    ...
    def delete(
        ...
        *,
        ...
        return self.client.delete_collection_namespaced_resource_claim_parameters(
            namespace=namespace,
            pretty=pretty,
            body=body,
            _continue=_continue,
...
class ResourceV1alpha2NamespacedResourceClassParametersManager:
    def __init__(self, client: kubernetes.client.ResourceV1alpha2Api) -> None:
        self.client = client
    ...
    def list(
        ...
        *,
        ...
        timeout_seconds: typing.Optional[int] = None,
        watch: typing.Optional[bool] = None
    ) -> kubernetes.client.V1alpha2ResourceClassParametersList:
        return self.client.list_namespaced_resource_class_parameters(
            namespace=namespace,
            pretty=pretty,
            allow_watch_bookmarks=allow_watch_bookmarks,
            _continue=_continue,
    ...
    def create(
        ...
        *,
        ...
        field_manager: typing.Optional[str] = None,
        field_validation: typing.Optional[str] = None
    ) -> kubernetes.client.V1alpha2ResourceClassParameters:
        return self.client.create_namespaced_resource_class_parameters(
            namespace=namespace,
            body=body,
            pretty=pretty,
            dry_run=dry_run,
    ...
    def read(
        ...
        return self.client.read_namespaced_resource_class_parameters(
            name=name, namespace=namespace, pretty=pretty
        )
    ...
    def replace(
        ...
        *,
        ...
        return self.client.replace_namespaced_resource_class_parameters(
            name=name,
            namespace=namespace,
            body=body,
            pretty=pretty,
    ...
    def delete(
        ...
        *,
        ...
        return self.client.delete_namespaced_resource_class_parameters(
            name=name,
            namespace=namespace,
            pretty=pretty,
            body=body,
    ...
    def patch(
        ...
        *,
        ...
        return self.client.patch_namespaced_resource_class_parameters(
            name=name,
            namespace=namespace,
            body=body,
            pretty=pretty,
...
class ResourceV1alpha2CollectionNamespacedResourceClassParametersManager:
    def __init__(self, client: kubernetes.client.ResourceV1alpha2Api) -> None:
        self.client = client
    ...
    def delete(
        ...
        *,
        ...
        return self.client.delete_collection_namespaced_resource_class_parameters(
            namespace=namespace,
            pretty=pretty,
            body=body,
            _continue=_continue,
...
class ResourceV1alpha2ResourceClaimParametersForAllNamespacesManager:
    def __init__(self, client: kubernetes.client.ResourceV1alpha2Api) -> None:
        self.client = client
    ...
    def list(
        ...
        *,
        ...
        return self.client.list_resource_claim_parameters_for_all_namespaces(
            allow_watch_bookmarks=allow_watch_bookmarks,
            _continue=_continue,
            field_selector=field_selector,
            label_selector=label_selector,
...
class ResourceV1alpha2ResourceClassParametersForAllNamespacesManager:
    def __init__(self, client: kubernetes.client.ResourceV1alpha2Api) -> None:
        self.client = client
    ...
    def list(
        ...
        *,
        ...
        return self.client.list_resource_class_parameters_for_all_namespaces(
            allow_watch_bookmarks=allow_watch_bookmarks,
            _continue=_continue,
            field_selector=field_selector,
            label_selector=label_selector,
...
class ResourceV1alpha2ResourceSliceManager:
    def __init__(self, client: kubernetes.client.ResourceV1alpha2Api) -> None:
        self.client = client
    ...
    def list(
        ...
        *,
        ...
        timeout_seconds: typing.Optional[int] = None,
        watch: typing.Optional[bool] = None
    ) -> kubernetes.client.V1alpha2ResourceSliceList:
        return self.client.list_resource_slice(
            pretty=pretty,
            allow_watch_bookmarks=allow_watch_bookmarks,
            _continue=_continue,
            field_selector=field_selector,
    ...
    def create(
        ...
        *,
        ...
        field_manager: typing.Optional[str] = None,
        field_validation: typing.Optional[str] = None
    ) -> kubernetes.client.V1alpha2ResourceSlice:
        return self.client.create_resource_slice(
            body=body,
            pretty=pretty,
            dry_run=dry_run,
            field_manager=field_manager,
    ...
    def read(
        ...
        return self.client.read_resource_slice(name=name, pretty=pretty)
    ...
    def replace(
        ...
        *,
        ...
        return self.client.replace_resource_slice(
            name=name,
            body=body,
            pretty=pretty,
            dry_run=dry_run,
    ...
    def delete(
        ...
        *,
        ...
        return self.client.delete_resource_slice(
            name=name,
            pretty=pretty,
            body=body,
            dry_run=dry_run,
    ...
    def patch(
        ...
        *,
        ...
        return self.client.patch_resource_slice(
            name=name,
            body=body,
            pretty=pretty,
            dry_run=dry_run,
...
class ResourceV1alpha2CollectionResourceSliceManager:
    def __init__(self, client: kubernetes.client.ResourceV1alpha2Api) -> None:
        self.client = client
    ...
    def delete(
        ...
        *,
        ...
        return self.client.delete_collection_resource_slice(
            pretty=pretty,
            body=body,
            _continue=_continue,
            dry_run=dry_run,
...
class StoragemigrationV1alpha1StorageVersionMigrationManager:
    def __init__(self, client: kubernetes.client.StoragemigrationV1alpha1Api) -> None:
        self.client = client
    ...
    def list(
        ...
        *,
        ...
        timeout_seconds: typing.Optional[int] = None,
        watch: typing.Optional[bool] = None
    ) -> kubernetes.client.V1alpha1StorageVersionMigrationList:
        return self.client.list_storage_version_migration(
            pretty=pretty,
            allow_watch_bookmarks=allow_watch_bookmarks,
            _continue=_continue,
            field_selector=field_selector,
    ...
    def create(
        self,
        body: kubernetes.client.V1alpha1StorageVersionMigration,
        *,
        pretty: typing.Optional[str] = None,
        dry_run: typing.Optional[str] = None,
        field_manager: typing.Optional[str] = None,
        field_validation: typing.Optional[str] = None
    ) -> kubernetes.client.V1alpha1StorageVersionMigration:
        return self.client.create_storage_version_migration(
            body=body,
            pretty=pretty,
            dry_run=dry_run,
            field_manager=field_manager,
    ...
    def read(
        ...
        return self.client.read_storage_version_migration(name=name, pretty=pretty)
    ...
    def replace(
        ...
        *,
        ...
        return self.client.replace_storage_version_migration(
            name=name,
            body=body,
            pretty=pretty,
            dry_run=dry_run,
    ...
    def delete(
        ...
        *,
        ...
        return self.client.delete_storage_version_migration(
            name=name,
            pretty=pretty,
            body=body,
            dry_run=dry_run,
    ...
    def patch(
        ...
        *,
        ...
        return self.client.patch_storage_version_migration(
            name=name,
            body=body,
            pretty=pretty,
            dry_run=dry_run,
...
class StoragemigrationV1alpha1CollectionStorageVersionMigrationManager:
    def __init__(self, client: kubernetes.client.StoragemigrationV1alpha1Api) -> None:
        self.client = client
    ...
    def delete(
        ...
        *,
        ...
        return self.client.delete_collection_storage_version_migration(
            pretty=pretty,
            body=body,
            _continue=_continue,
            dry_run=dry_run,
...
class StoragemigrationV1alpha1StorageVersionMigrationStatusManager:
    def __init__(self, client: kubernetes.client.StoragemigrationV1alpha1Api) -> None:
        self.client = client
    ...
    def read(
        ...
        return self.client.read_storage_version_migration_status(
            name=name, pretty=pretty
        )
    ...
    def replace(
        ...
        *,
        ...
        return self.client.replace_storage_version_migration_status(
            name=name,
            body=body,
            pretty=pretty,
            dry_run=dry_run,
    ...
    def patch(
        ...
        *,
        ...
        return self.client.patch_storage_version_migration_status(
            name=name,
            body=body,
            pretty=pretty,
            dry_run=dry_run,
