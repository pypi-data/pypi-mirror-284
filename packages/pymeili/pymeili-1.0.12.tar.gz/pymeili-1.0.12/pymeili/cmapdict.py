            ...
            try:
                if theme == 'light':
                    ...
                    if index == '309': # blindness-friendly
                        return LinearSegmentedColormap.from_list('mycmap',["#403A27","#7C6B1A","#A89008","#E0D3B1","#EDEDED","#C9D3F6","#3A90FE","#3879D3","#384667"])
                    if index == '-309':
                        return LinearSegmentedColormap.from_list('mycmap',["#384667","#3879D3","#3A90FE","#C9D3F6","#EDEDED","#E0D3B1","#A89008","#7C6B1A","#403A27"])
