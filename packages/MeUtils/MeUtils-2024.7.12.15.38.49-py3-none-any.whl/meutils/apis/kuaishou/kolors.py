...
async def upload(file_or_url: Union[bytes, str]):  # todo: 垫图
...
async def submit_task(request: KolorsRequest, cookie: str):
    headers = {
        'Cookie': cookie,
...
if __name__ == '__main__':
    ...
    # print(arun(submit_task(request, cookie)))
    ...
    # pprint(arun(create_image(request)))
