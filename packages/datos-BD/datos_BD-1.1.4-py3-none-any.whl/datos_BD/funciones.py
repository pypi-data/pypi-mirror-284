from encript_data import encrypt,decrypt,k
...
srv = servidores()
# print(decrypt(s[0],k).decode("utf-8"))
# print(decrypt(s[1],k).decode("utf-8"))

for s in srv:
    print(decrypt(s,k).decode("utf-8"))

bds = bases_d_datos(srv[1])

print(decrypt(srv[1],k).decode("utf-8"))

for bd in bds:
  print(decrypt(bd,k).decode("utf-8"))