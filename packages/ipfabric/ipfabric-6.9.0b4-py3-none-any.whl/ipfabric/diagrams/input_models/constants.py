...
DEFAULT_NETWORK = json.loads(
    importlib.resources.read_text("ipfabric.diagrams.input_models.factory_defaults", "networkSettings.json")
)
DEFAULT_PATHLOOKUP = json.loads(
    importlib.resources.read_text("ipfabric.diagrams.input_models.factory_defaults", "pathLookupSettings.json")
)
