import logging
from tg.plugin_models import TextFilter
from tg.plugins import TgMessage, TgPlugin
from tg.utils import match


class TgFilter(TgPlugin):
    id_ = "filter"
    ...
    def text_safe(self, tm: TgMessage) -> bool:
    ...
    def users_safe(self, tm: TgMessage) -> bool:
    ...
    def files_safe(self, tm: TgMessage) -> bool:
