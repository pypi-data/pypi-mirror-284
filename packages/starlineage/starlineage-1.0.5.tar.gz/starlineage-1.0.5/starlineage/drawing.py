...
from starlineage import DEFAULT_DIALECT, DEFAULT_HOST, DEFAULT_PORT, STATIC_FOLDER
...
from starlineage.utils.helpers import extract_sql_from_args
...
def draw_lineage_graph(**kwargs) -> None:
    ...
    with make_server(host, port, app) as httpd:
        print(f" * StarLineage Running on http://{host}:{port}{path}")
        httpd.serve_forever()
