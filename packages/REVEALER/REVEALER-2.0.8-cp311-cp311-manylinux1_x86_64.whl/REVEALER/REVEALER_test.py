...
from example_notebook.DepMapToCCLE import run
...
def run_test(args):
    ...
    #         output_directory = os.path.join(script_dir, "..", "example_notebook", "sample_input")
    ...
    produce_mutation_file(
        maf_input_file=os.path.join(script_dir, "..", "example_notebook", "sample_input", "OmicsSomaticMutations.csv"),
        gct_output_file_prefix='CCLE',
        out_folder=os.path.join(script_dir, "..", "example_notebook", "sample_input"),
        file_separator=',',
    ...
    run(
        os.path.join(script_dir, "..", "example_notebook", "sample_input", "NameConvert.csv"),
        os.path.join(script_dir, "..", "example_notebook", "sample_input", "CCLE_class.gct"),
        os.path.join(script_dir, "..", "example_notebook", "sample_input", "CCLE_class_rename.gct")
    )

    # Input too large, please contact jim095@ucsd.edu for original file
    runREVEALER(
        target_file=os.path.join(script_dir, "..", "example_notebook", "sample_input", "CCLE_complete_sigs.gct"),
        feature_files=[os.path.join(script_dir, "..", "example_notebook", "sample_input", "CCLE_class_rename.gct")],
        gmt_file=os.path.join(script_dir, "..", "example_notebook", "sample_input", "CCLE_class.gmt"),
        seed_name=['NFE2L2_Mut_All'],
        out_folder=os.path.join(script_dir, "..", "example_notebook", "sample_output", "NRF2"),
        prefix='CCLE_NRF2',
        target_name='NFE2L2.V2',
        if_pval=False,
        if_bootstrap=False,
        if_intermediate=True,
        gene_locus=os.path.join(script_dir, "..", "example_notebook", "sample_input", "allgeneLocus.txt"),
        tissue_file=os.path.join(script_dir, "..", "example_notebook", "sample_input", "TissueType_CCLE.gct"),
        max_iteration = 10
    )

    # Path to the generated file and ground truth file
    generated_file = os.path.join(script_dir, "..", "example_notebook", "sample_input", "NRF2", "CCLE_NRF2_Result.txt")
    ground_truth_file = os.path.join(script_dir, "..", "example_notebook", "sample_output", "CCLE_NRF2_groudtruth.txt")
