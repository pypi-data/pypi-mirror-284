...
CORVA_STREAMX_BOX_SOURCES_COLDBORE_VALVE = 'corva.streamx.box.sources.coldbore_valve'
...
CORVA_STREAMX_CONSUMERS_COLDBORE_VALVE = 'corva.streamx.consumers.coldbore_valve'
...
CORVA_STREAMX_CONSUMERS_HANDLE_APP_STREAM_EVENTS = 'corva.streamx.consumers.handle_app_stream_events'

CORVA_STREAMX_CONSUMERS_RESEND_DATA_TO_PLATFORM = 'corva.streamx.consumers.resend_data_to_platform'

CORVA_STREAMX_CONSUMERS_RESEND_DATA_TO_PLATFORM_V2 = 'corva.streamx.consumers.resend_data_to_platform.v2'
...
CORVA_STREAMX_DATA_SOURCE_WITSML_WELL_UID = 'corva.streamx.data.source.witsml.well.uid'
"""
StreamX DataSource WITSML Well UID
"""

CORVA_STREAMX_DATA_SOURCE_WITSML_WELLBORE_UID = 'corva.streamx.data.source.witsml.wellbore.uid'
"""
StreamX DataSource WITSML Wellbore UID
"""

CORVA_STREAMX_DATA_SOURCE_WITSML_LOG_UID = 'corva.streamx.data.source.witsml.log.uid'
"""
StreamX DataSource WITSML Log UID
"""

CORVA_STREAMX_DATA_SOURCE_WITSML_LOG_UIDS = 'corva.streamx.data.source.witsml.log.uids'
"""
StreamX DataSource WITSML Log UIDs Array / List
"""

CORVA_STREAMX_DATA_SOURCE_COLDBORE_JOB_ID = 'corva.streamx.data.source.coldbore.job.id'
"""
StreamX DataSource Coldbore Job ID
"""

CORVA_STREAMX_DATA_SOURCE_COLDBORE_VALVE_DATASET = 'corva.streamx.data.source.coldbore.valve.dataset'
"""
