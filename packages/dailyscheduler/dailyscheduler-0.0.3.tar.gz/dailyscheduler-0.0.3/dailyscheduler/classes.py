...
class WorkingDay():
    ...
    def get_available_slots_for_task(self, task: Task):
        """
        Get all available slots for a given task
        """

        # calculate the number of slots required for the task (60 sec * 5 min = 300 sec)
        n_slots_required = task.duration.seconds // 300
    ...
    def get_task_from_hour(self, hour: datetime.time) -> Optional[int]:
        """
