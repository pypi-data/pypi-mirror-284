...
class Markdown_Parser(Type_Safe):
    ...
    def content_to_html(self, content):
        _, markdown = frontmatter.parse(content)                        # todo: replace frontmatter with our own implementation since we really only use this dependency to extract the metadata from the top of the markdown
