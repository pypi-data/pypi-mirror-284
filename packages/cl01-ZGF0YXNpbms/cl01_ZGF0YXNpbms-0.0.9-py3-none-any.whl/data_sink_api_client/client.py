...
class DatasinkAPIClient:
    ...
    def create_model(self, embedding_model: models.EmbeddingModel) -> Union[models.HTTPValidationError, dict, models.EmbeddingModel]:
        """Create Model"""
        return self._request(
            'POST',
            '/models',
    ...
    def create_embedding(self, embedding_request: models.EmbeddingRequest) -> Union[models.ModelNotFoundResponse, models.EmbeddingResponse, models.HTTPValidationError, dict]:
        """Create Embedding"""
        return self._request(
            'POST',
            '/embed',
    ...
    def create_collection(self, collection_info: Union['CollectionInfo', 'QdrantCollectionInfo']) -> Union[dict, models.HTTPValidationError, models.UnsupportedCollectionTypeResponse, models.QdrantCollectionInfo]:
        """Create Collection"""
        return self._request(
            'POST',
            '/collections',
    ...
    def update_collection(self, collection_id, partial_collection_info: models.PartialCollectionInfo) -> Union[models.HTTPValidationError, dict, models.CollectionNotFoundResponse]:
        """Update Collection"""
        return self._request(
            'PATCH',
    ...
    def delete_collection(self, collection_id) -> Union[models.HTTPValidationError, dict, models.CollectionNotFoundResponse]:
        """Delete Collection"""
        return self._request(
            'DELETE',
            f'/collections/{collection_id}',
    ...
    def get_collection(self, collection_id) -> Union[models.HTTPValidationError, dict, models.CollectionNotFoundResponse]:
        """Get Collection"""
        return self._request(
            'GET',
            f'/collections/{collection_id}',
    ...
    def get_collection_entities_list(self, collection_id, limit, offset) -> Union[models.CollectionEntityListResponse, models.HTTPValidationError, models.CollectionNotFoundResponse]:
    ...
    def create_collection_entity(self, collection_id, collection_entity: models.CollectionEntity) -> Union[models.CollectionEntityResponse, models.CollectionEntityAlreadyExistsResponse, models.HTTPValidationError, dict, models.CollectionNotFoundResponse]:
