...
class AsyncDatasinkAPIClient:
    ...
    async def create_model(self, embedding_model: models.EmbeddingModel) -> Union[models.HTTPValidationError, dict, models.EmbeddingModel]:
        """Create Model"""
        return await self._request(
            'POST',
            '/models',
    ...
    async def create_embedding(self, embedding_request: models.EmbeddingRequest) -> Union[models.ModelNotFoundResponse, models.EmbeddingResponse, models.HTTPValidationError, dict]:
        """Create Embedding"""
        return await self._request(
            'POST',
            '/embed',
    ...
    async def create_collection(self, collection_info: Union['CollectionInfo', 'QdrantCollectionInfo']) -> Union[dict, models.HTTPValidationError, models.UnsupportedCollectionTypeResponse, models.QdrantCollectionInfo]:
        """Create Collection"""
        return await self._request(
            'POST',
            '/collections',
    ...
    async def update_collection(self, collection_id, partial_collection_info: models.PartialCollectionInfo) -> Union[models.HTTPValidationError, dict, models.CollectionNotFoundResponse]:
        """Update Collection"""
        return await self._request(
            'PATCH',
    ...
    async def delete_collection(self, collection_id) -> Union[models.HTTPValidationError, dict, models.CollectionNotFoundResponse]:
        """Delete Collection"""
        return await self._request(
            'DELETE',
            f'/collections/{collection_id}',
    ...
    async def get_collection(self, collection_id) -> Union[models.HTTPValidationError, dict, models.CollectionNotFoundResponse]:
        """Get Collection"""
        return await self._request(
            'GET',
            f'/collections/{collection_id}',
    ...
    async def get_collection_entities_list(self, collection_id, limit, offset) -> Union[models.CollectionEntityListResponse, models.HTTPValidationError, models.CollectionNotFoundResponse]:
    ...
    async def create_collection_entity(self, collection_id, collection_entity: models.CollectionEntity) -> Union[models.CollectionEntityResponse, models.CollectionEntityAlreadyExistsResponse, models.HTTPValidationError, dict, models.CollectionNotFoundResponse]:
