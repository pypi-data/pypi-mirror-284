...
class CreateUserRequestBody(BaseModel):
    ...
    * Algorithm: SHA1
    ...
    def serialize_model(self, handler):
        optional_fields = ["external_id", "first_name", "last_name", "email_address", "phone_number", "web3_wallet", "username", "password", "password_digest", "password_hasher", "skip_password_checks", "skip_password_requirement", "totp_secret", "backup_codes", "public_metadata", "private_metadata", "unsafe_metadata", "created_at"]
        nullable_fields = ["external_id", "first_name", "last_name", "username", "password"]
        null_default_fields = []
