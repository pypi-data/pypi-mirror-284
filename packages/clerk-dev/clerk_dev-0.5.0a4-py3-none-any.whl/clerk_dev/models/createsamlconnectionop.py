...
class CreateSAMLConnectionRequestBody(BaseModel):
    ...
    def serialize_model(self, handler):
        optional_fields = ["idp_entity_id", "idp_sso_url", "idp_certificate", "idp_metadata_url", "idp_metadata", "attribute_mapping"]
        nullable_fields = ["idp_entity_id", "idp_sso_url", "idp_certificate", "idp_metadata_url", "idp_metadata", "attribute_mapping"]
        null_default_fields = []
