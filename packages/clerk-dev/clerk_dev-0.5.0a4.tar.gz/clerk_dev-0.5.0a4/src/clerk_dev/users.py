...
class Users(BaseSDK):
    ...
    def set_profile_image(
        ...
        request = models.SetUserProfileImageRequest(
            ...
            request_body=models.SetUserProfileImageRequestBody(
                file=utils.unmarshal(file, models.File) if not isinstance(file, BaseModel) and file is not None else file,
            ),
        )
    ...
    def get_organization_memberships(
        ...
        if utils.match_response(http_res, "200", "application/json"):
            res.result = utils.unmarshal_json(http_res.text, Optional[models.OrganizationMemberships])
        elif utils.match_response(http_res, "403", "application/json"):
            data = utils.unmarshal_json(http_res.text, models.ClerkErrorsData)
            raise models.ClerkErrors(data=data)
