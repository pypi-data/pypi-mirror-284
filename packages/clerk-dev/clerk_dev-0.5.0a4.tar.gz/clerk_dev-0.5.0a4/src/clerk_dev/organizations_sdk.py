...
class OrganizationsSDK(BaseSDK):
    ...
    def upload_logo(
        ...
        file: Union[models.UploadOrganizationLogoFile, models.UploadOrganizationLogoFileTypedDict],
        server_url: Optional[str] = None,
        timeout_config: Optional[int] = None,
        ...
        request = models.UploadOrganizationLogoRequest(
            ...
            request_body=models.UploadOrganizationLogoRequestBody(
                ...
                file=utils.unmarshal(file, models.UploadOrganizationLogoFile) if not isinstance(file, BaseModel) else file,
            ),
        )
