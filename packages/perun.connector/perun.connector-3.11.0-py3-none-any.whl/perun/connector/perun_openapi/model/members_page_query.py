...
def lazy_import():
    from perun.connector.perun_openapi.model.member_group_status import (
        MemberGroupStatus,
    )
    from perun.connector.perun_openapi.model.members_order_column import (
        MembersOrderColumn,
    )
...
class MembersPageQuery(ModelNormal):
    ...
    def _from_openapi_data(
        cls, page_size, offset, order, sort_column, *args, **kwargs
    ):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(
        self, page_size, offset, order, sort_column, *args, **kwargs
    ):  # noqa: E501
        """MembersPageQuery - a model defined in OpenAPI
