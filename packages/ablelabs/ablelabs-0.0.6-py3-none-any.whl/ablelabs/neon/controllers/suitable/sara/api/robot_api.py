...
from ablelabs.neon.controllers.suitable.sara.robot_router import RobotRouter
...
from ablelabs.neon.common.structs import Speed, FlowRate
...
from ablelabs.neon.common.suitable.struct import location
...
async def main():
    ...
    #     volume=100,
    #     iteration=2,
    #     location=location(location_type=LocationType.DECK, location_number=, offset=(0, 0, 5)),
    #     pipette_cone=1,
    #     flow_rate=FlowRate.from_ul(100),
    #     blow_out_flow_rate=FlowRate.from_ul(10),
    #     delay=0.1,
    # )
    # await robot_api.motion.blow_out(
    #     flow_rate=FlowRate.from_ul(50),
    # )
    ...
    #     pipette_cone=1,
    #     flow_rate=FlowRate.from_ul(50),
    #     blow_out_flow_rate=FlowRate.from_ul(70),
    # )
    await robot_api.motion.delay(sec=1)
    await robot_api.motion.rise_tip(
        pipette_number=[1, 2, 3, 4, 5, 6, 7, 8],
        height_offset=10,
    ...
    #     volume=200,
    #     location=location(location_type=LocationType.DECK, location_number=, offset=(0, 0, 10)),
    #     pipette_cone=1,
    #     flow_rate=FlowRate.from_ul(100),
    # )
    # await robot_api.motion.blow_out(
