...
class COCOAnnotationBuilder(AnnotationBuilder):
    ...
    def __get_attributes_from_coco_annotation(
        ...
        if "attributes" in coco_annotation:
            ...
            rotation = attributes["rotation"] if "rotation" in attributes else 0.0
        else:
            difficult = False
            occluded = False
            background = False
        ...
        return difficult, occluded, background, content, rotation
    ...
    def __get_coco_annotations(
        ...
        for _coco_annotation in self.coco_annotations:
            ...
            difficult, occluded, background, content, rotation = (
