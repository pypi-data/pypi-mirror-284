...
def get_default_hcps() -> dict:
    return {
        "max": requests.get(
            "https://api.espoogolf.fi/api/1.0/golf/player/?memberno=32819&clubid=55"
        ).json()["rows"][0]["handicapActive"],
        "jesse": requests.get(
            "https://api.espoogolf.fi/api/1.0/golf/player/?memberno=2339&clubid=33"
        ).json()["rows"][0]["handicapActive"],
        "panu": requests.get(
            "https://api.espoogolf.fi/api/1.0/golf/player/?memberno=4752&clubid=12"
        ).json()["rows"][0]["handicapActive"],
        "tele": requests.get(
            "https://api.espoogolf.fi/api/1.0/golf/player/?memberno=33665&clubid=55"
        ).json()["rows"][0]["handicapActive"],
    }
