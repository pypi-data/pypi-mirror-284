...
from stockdatautils.ingest.utils import get_current_date_utc, convert_keys_to_snake_case, convert_values
...
def add_utc_timestamp_to_beginning(json_data):
    """
    ...
    new_ordered_data = OrderedDict({"src_date": current_utc_datetime})
