...
class Data_validation():
    ...
    def test_partition_date_exists(self, destination_table, partition_field, partition_value):
    ...
    def test_data(self, destination_table, test_name, column_ids_list=None,
                  ...
                  set_of_values=None, partition_field='partition_date', exit_on_failure=False, partition_value= 'current_date'):
        ## duplication QA ##
        ...
        elif test_name == 'expect_partition_date_exists':
            sql = self.test_partition_date_exists(destination_table=destination_table,
                                           partition_field=partition_field, partition_value=partition_value)
