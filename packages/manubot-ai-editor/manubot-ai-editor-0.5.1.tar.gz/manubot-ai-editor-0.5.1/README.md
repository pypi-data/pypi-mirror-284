...
If you wish to customize the prompts on a per-file basis, see [docs/custom-prompts.md](https://github.com/manubot/manubot-ai-editor/blob/main/docs/custom-prompts.md) for more information.
