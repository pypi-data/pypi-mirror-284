...
from evo_framework.core.evo_core_api.entity.EHeader import EHeader
...
#<        
            ...
            eHeader = IuApiRequest.newEHeader(id=eActionInput.id, data=dataERequest)
            
            #print(eHeader)
            dataHeader = eHeader.toBytes()
