...
class CApiFlow:
    ...
    # ---------------------------------------------------------------------------------------------------------------------------------------
    async def __doSetEApiConfig(self) -> EAction:
        try:
            ...
            IuLog.doDebug(__name__, f"cyborgai eRequest:{eActionInput}")
            ...
            if response.status_code == 200:
                ...
                eActionOutput = IuApiRequest.toEActionInput( data=dataEResponse, publicKey=pkServer)

                self.eApiConfig.cyborgaiToken = eActionOutput.output.decode()
