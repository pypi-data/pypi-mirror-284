...
class EditorAPI(APIEndpoint):  # noqa PLC0115
    ...
    def export_audit(
        ...
        **kwargs,
        ...
        return self._api.tokens._fetch(token, **kwargs)  # noqa W0212

    def template_details(
        self, object_type: Literal["scan", "policy"], template_uuid: str
    ) -> dict:
        """
    ...
    def details(self, object_type: Literal["scan", "policy"], object_id: int) -> dict:
        """
    ...
    def template_list(self, object_type: Literal["scan", "policy"]) -> list[dict]:
        """
    ...
    def plugin_description(
        ...
        """
        return self._get(
            f"policy/{policy_id}/" f"families/{family_id}/" f"plugins/{plugin_id}"
        )["plugindescription"]
