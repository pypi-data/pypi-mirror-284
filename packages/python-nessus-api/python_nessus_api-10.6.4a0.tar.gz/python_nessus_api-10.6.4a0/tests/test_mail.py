...
def test_mail_details(nessus):
    responses.add(responses.GET, "https://localhost:8834/settings/network/mail", json=MAIL)
...
def test_mail_edit(nessus):
    responses.add(responses.GET, "https://localhost:8834/settings/network/mail", json=MAIL)
    responses.add(responses.PUT, "https://localhost:8834/settings/network/mail")
    nessus.mail.edit(
        smtp_user="new_user",
