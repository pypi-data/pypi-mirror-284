...
def test_kmeans_fit_parallel():
    rs_gen = np.random.RandomState(0)
    data1 = rs_gen.normal(loc=1, size=(2000, 3))
    data2 = rs_gen.normal(loc=-1, size=(2000, 3))
